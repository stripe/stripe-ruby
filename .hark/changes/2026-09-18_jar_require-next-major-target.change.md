...
pr_url: https://github.com/stripe/stripe-ruby/pull/1972
semver_level: patch
---
...
Either way, be specific and remember to focus on user-facing impact (which may only be a small subset of the work you did).
