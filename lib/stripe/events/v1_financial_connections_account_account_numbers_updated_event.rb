...
module Stripe
  module Events
    ...
    class V1FinancialConnectionsAccountAccountNumbersUpdatedEvent < Stripe::V2::Core::Event
    ...
    # Occurs when a Financial Connections account's account numbers are updated.
    class V1FinancialConnectionsAccountAccountNumbersUpdatedEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v1.financial_connections.account.account_numbers_updated"
      end
