...
module Stripe
  module Events
    ...
    class V1FinancialConnectionsAccountDeactivatedEvent < Stripe::V2::Event
    ...
    # Occurs when a Financial Connections account's status is updated from `active` to `inactive`.
    class V1FinancialConnectionsAccountDeactivatedEventNotification < Stripe::V2::EventNotification
      def self.lookup_type
        "v1.financial_connections.account.deactivated"
      end
