...
module Stripe
  module Events
    ...
    class V1FinancialConnectionsAccountRefreshedBalanceEvent < Stripe::V2::Event
    ...
    # Occurs when an Account's `balance_refresh` status transitions from `pending` to either `succeeded` or `failed`.
    class V1FinancialConnectionsAccountRefreshedBalanceEventNotification < Stripe::V2::EventNotification
      def self.lookup_type
        "v1.financial_connections.account.refreshed_balance"
      end
