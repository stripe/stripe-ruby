...
module Stripe
  module Events
    ...
    class V1FinancialConnectionsAccountUpcomingAccountNumberExpiryEvent < Stripe::V2::Core::Event
    ...
    # Occurs when an Account's tokenized account number is about to expire.
    class V1FinancialConnectionsAccountUpcomingAccountNumberExpiryEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v1.financial_connections.account.upcoming_account_number_expiry"
      end
