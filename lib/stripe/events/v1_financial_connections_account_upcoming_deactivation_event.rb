...
module Stripe
  module Events
    ...
    class V1FinancialConnectionsAccountUpcomingDeactivationEvent < Stripe::V2::Core::Event
    ...
    # Occurs when a Financial Connections account is about to become `inactive`.
    class V1FinancialConnectionsAccountUpcomingDeactivationEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v1.financial_connections.account.upcoming_deactivation"
      end
