...
module Stripe
  module Events
    ...
    class V1IdentityVerificationSessionCanceledEvent < Stripe::V2::Event
    ...
    # Occurs whenever a VerificationSession is canceled.
    class V1IdentityVerificationSessionCanceledEventNotification < Stripe::V2::EventNotification
      def self.lookup_type
        "v1.identity.verification_session.canceled"
      end
