...
module Stripe
  module Events
    ...
    class V1IdentityVerificationSessionCreatedEvent < Stripe::V2::Event
    ...
    # Occurs whenever a VerificationSession is created.
    class V1IdentityVerificationSessionCreatedEventNotification < Stripe::V2::EventNotification
      def self.lookup_type
        "v1.identity.verification_session.created"
      end
