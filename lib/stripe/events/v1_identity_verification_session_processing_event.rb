...
module Stripe
  module Events
    ...
    class V1IdentityVerificationSessionProcessingEvent < Stripe::V2::Event
    ...
    # Occurs whenever a VerificationSession transitions to processing.
    class V1IdentityVerificationSessionProcessingEventNotification < Stripe::V2::EventNotification
      def self.lookup_type
        "v1.identity.verification_session.processing"
      end
