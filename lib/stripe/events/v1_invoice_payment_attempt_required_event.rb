...
module Stripe
  module Events
    ...
    class V1InvoicePaymentAttemptRequiredEvent < Stripe::V2::Core::Event
    ...
    # Occurs when an invoice requires a payment using a payment method that cannot be processed by Stripe.
    class V1InvoicePaymentAttemptRequiredEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v1.invoice.payment_attempt_required"
      end
