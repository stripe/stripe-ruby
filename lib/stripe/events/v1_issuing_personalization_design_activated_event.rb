...
module Stripe
  module Events
    ...
    class V1IssuingPersonalizationDesignActivatedEvent < Stripe::V2::Core::Event
    ...
    # Occurs whenever a personalization design is activated following the activation of the physical bundle that belongs to it.
    class V1IssuingPersonalizationDesignActivatedEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v1.issuing_personalization_design.activated"
      end
