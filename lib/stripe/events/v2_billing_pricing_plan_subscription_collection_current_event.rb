...
module Stripe
  module Events
    ...
    class V2BillingPricingPlanSubscriptionCollectionCurrentEvent < Stripe::V2::Core::Event
    ...
    # Occurs when a PricingPlanSubscription's collection is current.
    class V2BillingPricingPlanSubscriptionCollectionCurrentEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v2.billing.pricing_plan_subscription.collection_current"
      end
