...
module Stripe
  module Events
    ...
    class V2BillingRateCardCreatedEvent < Stripe::V2::Core::Event
      ...
      def self.inner_class_types
        @inner_class_types = { data: V2BillingRateCardCreatedEventData }
      end
    ...
    # Occurs when a RateCard is created.
    class V2BillingRateCardCreatedEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v2.billing.rate_card.created"
      end
