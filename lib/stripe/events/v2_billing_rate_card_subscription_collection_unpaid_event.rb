...
module Stripe
  module Events
    ...
    class V2BillingRateCardSubscriptionCollectionUnpaidEvent < Stripe::V2::Core::Event
    ...
    # Occurs when a RateCardSubscription's collection is unpaid.
    class V2BillingRateCardSubscriptionCollectionUnpaidEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v2.billing.rate_card_subscription.collection_unpaid"
      end
