...
module Stripe
  module Events
    ...
    class V2CoreHealthIssuingAuthorizationRequestErrorsResolvedEvent < Stripe::V2::Core::Event
      ...
      def self.inner_class_types
        @inner_class_types = { data: V2CoreHealthIssuingAuthorizationRequestErrorsResolvedEventData }
      end
      attr_reader :data
    end

    # Occurs when an issuing authorization request errors alert is resolved.
    class V2CoreHealthIssuingAuthorizationRequestErrorsResolvedEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v2.core.health.issuing_authorization_request_errors.resolved"
      end
    end
