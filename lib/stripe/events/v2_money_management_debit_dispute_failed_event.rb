...
module Stripe
  module Events
    ...
    class V2MoneyManagementDebitDisputeFailedEvent < Stripe::V2::Core::Event
    ...
    # Occurs when a DebitDispute fails.
    class V2MoneyManagementDebitDisputeFailedEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v2.money_management.debit_dispute.failed"
      end
