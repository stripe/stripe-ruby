...
module Stripe
  module Events
    # Occurs when a DebitDispute succeeds.
    class V2MoneyManagementDebitDisputeSucceededEvent < Stripe::V2::Core::Event
    ...
    # Occurs when a DebitDispute succeeds.
    class V2MoneyManagementDebitDisputeSucceededEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v2.money_management.debit_dispute.succeeded"
      end
