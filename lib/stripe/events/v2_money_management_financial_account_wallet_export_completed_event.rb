...
module Stripe
  module Events
    ...
    class V2MoneyManagementFinancialAccountWalletExportCompletedEvent < Stripe::V2::Core::Event
    ...
    # Occurs when FinancialAccount wallet credentials are first exported.
    class V2MoneyManagementFinancialAccountWalletExportCompletedEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v2.money_management.financial_account.wallet_export.completed"
      end
