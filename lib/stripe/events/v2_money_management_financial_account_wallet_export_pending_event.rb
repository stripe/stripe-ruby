...
module Stripe
  module Events
    ...
    class V2MoneyManagementFinancialAccountWalletExportPendingEvent < Stripe::V2::Core::Event
    ...
    # Occurs when a FinancialAccount wallet export starts being prepared.
    class V2MoneyManagementFinancialAccountWalletExportPendingEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v2.money_management.financial_account.wallet_export.pending"
      end
