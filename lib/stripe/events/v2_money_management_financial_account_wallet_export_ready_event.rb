...
module Stripe
  module Events
    ...
    class V2MoneyManagementFinancialAccountWalletExportReadyEvent < Stripe::V2::Core::Event
    ...
    # Occurs when a FinancialAccount wallet export is ready for credentials retrieval.
    class V2MoneyManagementFinancialAccountWalletExportReadyEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v2.money_management.financial_account.wallet_export.ready"
      end
