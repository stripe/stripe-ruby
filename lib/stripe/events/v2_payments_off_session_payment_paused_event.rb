...
module Stripe
  module Events
    ...
    class V2PaymentsOffSessionPaymentPausedEvent < Stripe::V2::Core::Event
    ...
    # Sent immediately following a user's call to the Off-Session Payments pause endpoint.
    class V2PaymentsOffSessionPaymentPausedEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v2.payments.off_session_payment.paused"
      end
