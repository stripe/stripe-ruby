...
module Stripe
  module Events
    ...
    class V2SignalsAccountSignalFraudulentWebsiteReadyEvent < Stripe::V2::Core::Event
    ...
    # Occurs when a fraudulent website signal is ready for an account.
    class V2SignalsAccountSignalFraudulentWebsiteReadyEventNotification < Stripe::V2::Core::EventNotification
      def self.lookup_type
        "v2.signals.account_signal.fraudulent_website_ready"
      end
