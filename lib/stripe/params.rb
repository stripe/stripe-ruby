  ...
  module V2
    ...
    module Provisioning
      ...
      module PaymentProfile
        autoload :UpdateLimitUpdateParams, "stripe/params/v2/provisioning/payment_profile/update_limit_update_params"
      end
    end
...
module Stripe
  ...
  PARAM_FILES = %w[
    ...
    stripe/params/v2/provisioning/payment_profile/update_limit_update_params
