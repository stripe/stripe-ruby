...
module Stripe
  class BillingService < StripeService
    attr_reader :alerts, :analytics, :credit_balance_summary, :credit_balance_transactions, :credit_grants, :feedback_options, :meters, :meter_events, :meter_event_adjustments
    ...
    def initialize(requestor)
      ...
      @feedback_options = Stripe::Billing::FeedbackOptionService.new(@requestor)
