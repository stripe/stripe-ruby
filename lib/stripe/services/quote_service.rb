...
module Stripe
  class QuoteService < StripeService
    ...
    # Finalizes the quote.
    def finalize_quote(id, params = {}, opts = {})
      request(
        method: :post,
    ...
    def list_preview_invoice_lines(quote_id, id, params = {}, opts = {})
      request(
        method: :get,
    ...
    def pdf(id, params = {}, opts = {}, &read_body_chunk_block)
      ...
      request_stream(
        method: :get,
        path: format("/v1/quotes/%<id>s/pdf", { id: CGI.escape(id) }),
        params: params,
        opts: opts,
        base_address: :files,
