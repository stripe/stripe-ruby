...
module Stripe
  class RadarService < StripeService
    attr_reader :account_evaluations, :billing_evaluations, :customer_evaluations, :early_fraud_warnings, :issuing_authorization_evaluations, :payment_evaluations, :value_lists, :value_list_items
