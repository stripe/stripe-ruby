...
module Stripe
  class V1Services < StripeService
    ...
    def initialize(requestor)
      ...
      @fr_meal_vouchers_onboardings = Stripe::FrMealVouchersOnboardingService.new(@requestor)
