...
module Stripe
  class V1Services < StripeService
    ...
    attr_reader :account_links, :account_notices, :account_sessions, :apple_pay_domains, :application_fees, :apps, :balance, :balance_settings, :balance_transactions, :balance_transfers, :billing, :billing_portal, :capital, :charges, :checkout, :climate, :confirmation_tokens, :country_specs, :coupons, :credit_notes, :crypto, :customers, :customer_sessions, :delegated_checkout, :disputes, :entitlements, :ephemeral_keys, :events, :exchange_rates, :external_accounts, :files, :file_links, :financial_connections, :forwarding, :fx_quotes, :gift_cards, :gift_card_operations, :identity, :invoices, :invoice_items, :invoice_payments, :invoice_rendering_templates, :issuing, :mandates, :margins, :orchestration, :orders, :payment_attempt_records, :payment_intents, :payment_links, :payment_locations, :payment_location_capabilities, :payment_methods, :payment_method_configurations, :payment_method_domains, :payment_plans, :payment_records, :payouts, :plans, :prices, :privacy, :products, :product_catalog, :promotion_codes, :quotes, :radar, :refunds, :reporting, :reserve, :reviews, :setup_attempts, :setup_intents, :shared_payment, :shipping_rates, :sigma, :sources, :subscriptions, :subscription_items, :subscription_schedules, :tax, :tax_codes, :tax_funds, :tax_ids, :tax_rates, :terminal, :test_helpers, :three_d_secure, :tokens, :topups, :transfers, :treasury, :webhook_endpoints
    ...
    def initialize(requestor)
      ...
      @balance_transfers = Stripe::BalanceTransferService.new(@requestor)
      ...
      @crypto = Stripe::CryptoService.new(@requestor)
      ...
      @gift_cards = Stripe::GiftCardService.new(@requestor)
      @gift_card_operations = Stripe::GiftCardOperationService.new(@requestor)
      ...
      @orchestration = Stripe::OrchestrationService.new(@requestor)
      ...
      @payment_location_capabilities = Stripe::PaymentLocationCapabilityService.new(@requestor)
      ...
      @payment_plans = Stripe::PaymentPlanService.new(@requestor)
      ...
      @reserve = Stripe::ReserveService.new(@requestor)
      ...
      @shared_payment = Stripe::SharedPaymentService.new(@requestor)
      ...
      @tax_funds = Stripe::TaxFundService.new(@requestor)
