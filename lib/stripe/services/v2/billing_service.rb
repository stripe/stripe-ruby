...
module Stripe
  module V2
    class BillingService < StripeService
      attr_reader :bill_settings, :cadences, :collection_settings, :custom_pricing_units, :intents, :license_fees, :licensed_items, :meter_event_adjustments, :meter_event_session, :meter_event_stream, :meter_events, :metered_items, :pricing_plan_subscriptions, :pricing_plans, :profiles, :rate_card_subscriptions, :rate_cards, :service_actions
