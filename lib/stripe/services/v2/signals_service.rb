...
module Stripe
  module V2
    class SignalsService < StripeService
      attr_reader :account_activities, :account_evaluations, :account_signals, :payment_retry_evaluations, :payment_retry_signals

      def initialize(requestor)
        super
        @account_activities = Stripe::V2::Signals::AccountActivityService.new(@requestor)
