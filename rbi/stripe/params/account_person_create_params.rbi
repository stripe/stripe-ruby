...
module Stripe
  class AccountPersonCreateParams < ::Stripe::RequestParams
    class AdditionalTosAcceptances < ::Stripe::RequestParams
      ...
      sig { returns(T.nilable(AccountPersonCreateParams::AdditionalTosAcceptances::Account)) }
      def account; end
      sig {
        params(_account: T.nilable(AccountPersonCreateParams::AdditionalTosAcceptances::Account)).returns(T.nilable(AccountPersonCreateParams::AdditionalTosAcceptances::Account))
       }
      def account=(_account); end
      sig {
        params(account: T.nilable(AccountPersonCreateParams::AdditionalTosAcceptances::Account)).void
       }
    ...
    class Documents < ::Stripe::RequestParams
      ...
      sig { returns(T.nilable(AccountPersonCreateParams::Documents::CompanyAuthorization)) }
      def company_authorization; end
      sig {
        params(_company_authorization: T.nilable(AccountPersonCreateParams::Documents::CompanyAuthorization)).returns(T.nilable(AccountPersonCreateParams::Documents::CompanyAuthorization))
       }
      def company_authorization=(_company_authorization); end
      # One or more documents showing the person's passport page with photo and personal data.
      sig { returns(T.nilable(AccountPersonCreateParams::Documents::Passport)) }
      def passport; end
      sig {
        params(_passport: T.nilable(AccountPersonCreateParams::Documents::Passport)).returns(T.nilable(AccountPersonCreateParams::Documents::Passport))
       }
      def passport=(_passport); end
      # One or more documents showing the person's visa required for living in the country where they are residing.
      sig { returns(T.nilable(AccountPersonCreateParams::Documents::Visa)) }
      def visa; end
      sig {
        params(_visa: T.nilable(AccountPersonCreateParams::Documents::Visa)).returns(T.nilable(AccountPersonCreateParams::Documents::Visa))
       }
      def visa=(_visa); end
      sig {
        params(company_authorization: T.nilable(AccountPersonCreateParams::Documents::CompanyAuthorization), passport: T.nilable(AccountPersonCreateParams::Documents::Passport), visa: T.nilable(AccountPersonCreateParams::Documents::Visa)).void
       }
    ...
    class UsCfpbData < ::Stripe::RequestParams
      ...
      sig { returns(T.nilable(AccountPersonCreateParams::UsCfpbData::EthnicityDetails)) }
      def ethnicity_details; end
      sig {
        params(_ethnicity_details: T.nilable(AccountPersonCreateParams::UsCfpbData::EthnicityDetails)).returns(T.nilable(AccountPersonCreateParams::UsCfpbData::EthnicityDetails))
       }
      def ethnicity_details=(_ethnicity_details); end
      # The persons race details
      sig { returns(T.nilable(AccountPersonCreateParams::UsCfpbData::RaceDetails)) }
      def race_details; end
      sig {
        params(_race_details: T.nilable(AccountPersonCreateParams::UsCfpbData::RaceDetails)).returns(T.nilable(AccountPersonCreateParams::UsCfpbData::RaceDetails))
       }
      ...
      sig {
        params(ethnicity_details: T.nilable(AccountPersonCreateParams::UsCfpbData::EthnicityDetails), race_details: T.nilable(AccountPersonCreateParams::UsCfpbData::RaceDetails), self_identified_gender: T.nilable(String)).void
       }
    ...
    class Verification < ::Stripe::RequestParams
      ...
      sig { returns(T.nilable(AccountPersonCreateParams::Verification::AdditionalDocument)) }
      def additional_document; end
      sig {
        params(_additional_document: T.nilable(AccountPersonCreateParams::Verification::AdditionalDocument)).returns(T.nilable(AccountPersonCreateParams::Verification::AdditionalDocument))
       }
      def additional_document=(_additional_document); end
      # An identifying document, either a passport or local ID card.
      sig { returns(T.nilable(AccountPersonCreateParams::Verification::Document)) }
      def document; end
      sig {
        params(_document: T.nilable(AccountPersonCreateParams::Verification::Document)).returns(T.nilable(AccountPersonCreateParams::Verification::Document))
       }
      def document=(_document); end
      sig {
        params(additional_document: T.nilable(AccountPersonCreateParams::Verification::AdditionalDocument), document: T.nilable(AccountPersonCreateParams::Verification::Document)).void
       }
      def initialize(additional_document: nil, document: nil); end
    end
    # Details on the legal guardian's or authorizer's acceptance of the required Stripe agreements.
    sig { returns(T.nilable(AccountPersonCreateParams::AdditionalTosAcceptances)) }
    def additional_tos_acceptances; end
    sig {
      params(_additional_tos_acceptances: T.nilable(AccountPersonCreateParams::AdditionalTosAcceptances)).returns(T.nilable(AccountPersonCreateParams::AdditionalTosAcceptances))
     }
    def additional_tos_acceptances=(_additional_tos_acceptances); end
    # The person's address.
    sig { returns(T.nilable(AccountPersonCreateParams::Address)) }
    def address; end
    sig {
      params(_address: T.nilable(AccountPersonCreateParams::Address)).returns(T.nilable(AccountPersonCreateParams::Address))
     }
    def address=(_address); end
    # The Kana variation of the person's address (Japan only).
    sig { returns(T.nilable(AccountPersonCreateParams::AddressKana)) }
    def address_kana; end
    sig {
      params(_address_kana: T.nilable(AccountPersonCreateParams::AddressKana)).returns(T.nilable(AccountPersonCreateParams::AddressKana))
     }
    def address_kana=(_address_kana); end
    # The Kanji variation of the person's address (Japan only).
    sig { returns(T.nilable(AccountPersonCreateParams::AddressKanji)) }
    def address_kanji; end
    sig {
      params(_address_kanji: T.nilable(AccountPersonCreateParams::AddressKanji)).returns(T.nilable(AccountPersonCreateParams::AddressKanji))
     }
    def address_kanji=(_address_kanji); end
    # The person's date of birth.
    sig { returns(T.nilable(T.any(String, AccountPersonCreateParams::Dob))) }
    def dob; end
    sig {
      params(_dob: T.nilable(T.any(String, AccountPersonCreateParams::Dob))).returns(T.nilable(T.any(String, AccountPersonCreateParams::Dob)))
     }
    def dob=(_dob); end
    # Documents that may be submitted to satisfy various informational requests.
    sig { returns(T.nilable(AccountPersonCreateParams::Documents)) }
    def documents; end
    sig {
      params(_documents: T.nilable(AccountPersonCreateParams::Documents)).returns(T.nilable(AccountPersonCreateParams::Documents))
     }
    ...
    sig { returns(T.nilable(AccountPersonCreateParams::RegisteredAddress)) }
    def registered_address; end
    sig {
      params(_registered_address: T.nilable(AccountPersonCreateParams::RegisteredAddress)).returns(T.nilable(AccountPersonCreateParams::RegisteredAddress))
     }
    def registered_address=(_registered_address); end
    # The relationship that this person has with the account's legal entity.
    sig { returns(T.nilable(AccountPersonCreateParams::Relationship)) }
    ...
    sig { returns(T.nilable(AccountPersonCreateParams::UsCfpbData)) }
    def us_cfpb_data; end
    sig {
      params(_us_cfpb_data: T.nilable(AccountPersonCreateParams::UsCfpbData)).returns(T.nilable(AccountPersonCreateParams::UsCfpbData))
     }
    def us_cfpb_data=(_us_cfpb_data); end
    # The person's verification status.
    sig { returns(T.nilable(AccountPersonCreateParams::Verification)) }
