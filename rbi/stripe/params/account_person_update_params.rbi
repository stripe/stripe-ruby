...
module Stripe
  class AccountPersonUpdateParams < ::Stripe::RequestParams
    ...
    sig {
      params(additional_tos_acceptances: T.nilable(::Stripe::AccountPersonUpdateParams::AdditionalTosAcceptances), address: T.nilable(::Stripe::AccountPersonUpdateParams::Address), address_kana: T.nilable(::Stripe::AccountPersonUpdateParams::AddressKana), address_kanji: T.nilable(::Stripe::AccountPersonUpdateParams::AddressKanji), dob: T.nilable(T.any(String, ::Stripe::AccountPersonUpdateParams::Dob)), documents: T.nilable(::Stripe::AccountPersonUpdateParams::Documents), email: T.nilable(String), expand: T.nilable(T::Array[String]), first_name: T.nilable(String), first_name_kana: T.nilable(String), first_name_kanji: T.nilable(String), full_name_aliases: T.nilable(T.any(String, T::Array[String])), gender: T.nilable(String), id_number: T.nilable(String), id_number_secondary: T.nilable(String), last_name: T.nilable(String), last_name_kana: T.nilable(String), last_name_kanji: T.nilable(String), maiden_name: T.nilable(String), metadata: T.nilable(T.any(String, T::Hash[String, String])), nationality: T.nilable(String), person_token: T.nilable(String), phone: T.nilable(String), political_exposure: T.nilable(String), registered_address: T.nilable(::Stripe::AccountPersonUpdateParams::RegisteredAddress), relationship: T.nilable(::Stripe::AccountPersonUpdateParams::Relationship), ssn_last_4: T.nilable(String), us_cfpb_data: T.nilable(::Stripe::AccountPersonUpdateParams::UsCfpbData), verification: T.nilable(::Stripe::AccountPersonUpdateParams::Verification)).void
     }
    def initialize(
