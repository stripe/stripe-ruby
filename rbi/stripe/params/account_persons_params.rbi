...
module Stripe
  class AccountPersonsParams < ::Stripe::RequestParams
    ...
    sig { returns(T.nilable(AccountPersonsParams::Relationship)) }
    def relationship; end
    sig {
      params(_relationship: T.nilable(AccountPersonsParams::Relationship)).returns(T.nilable(AccountPersonsParams::Relationship))
     }
    ...
    sig {
      params(ending_before: T.nilable(String), expand: T.nilable(T::Array[String]), limit: T.nilable(Integer), relationship: T.nilable(AccountPersonsParams::Relationship), starting_after: T.nilable(String)).void
     }
    def initialize(
      ending_before: nil,
      expand: nil,
