...
module Stripe
  class AccountUpdateParams < ::Stripe::RequestParams
    ...
    class Settings < ::Stripe::RequestParams
      ...
      def treasury=(_treasury); end
      sig {
        params(bacs_debit_payments: T.nilable(::Stripe::AccountUpdateParams::Settings::BacsDebitPayments), branding: T.nilable(::Stripe::AccountUpdateParams::Settings::Branding), card_issuing: T.nilable(::Stripe::AccountUpdateParams::Settings::CardIssuing), card_payments: T.nilable(::Stripe::AccountUpdateParams::Settings::CardPayments), invoices: T.nilable(::Stripe::AccountUpdateParams::Settings::Invoices), payments: T.nilable(::Stripe::AccountUpdateParams::Settings::Payments), payouts: T.nilable(::Stripe::AccountUpdateParams::Settings::Payouts), treasury: T.nilable(::Stripe::AccountUpdateParams::Settings::Treasury)).void
       }
      def initialize(
        bacs_debit_payments: nil,
        branding: nil,
    ...
    def tos_acceptance=(_tos_acceptance); end
    sig {
      params(account_token: T.nilable(String), business_profile: T.nilable(::Stripe::AccountUpdateParams::BusinessProfile), business_type: T.nilable(String), capabilities: T.nilable(::Stripe::AccountUpdateParams::Capabilities), company: T.nilable(::Stripe::AccountUpdateParams::Company), default_currency: T.nilable(String), documents: T.nilable(::Stripe::AccountUpdateParams::Documents), email: T.nilable(String), expand: T.nilable(T::Array[String]), external_account: T.nilable(T.any(String, T.any(String, ::Stripe::AccountUpdateParams::BankAccount, ::Stripe::AccountUpdateParams::Card, ::Stripe::AccountUpdateParams::CardToken))), groups: T.nilable(::Stripe::AccountUpdateParams::Groups), individual: T.nilable(::Stripe::AccountUpdateParams::Individual), metadata: T.nilable(T.any(String, T::Hash[String, String])), settings: T.nilable(::Stripe::AccountUpdateParams::Settings), tos_acceptance: T.nilable(::Stripe::AccountUpdateParams::TosAcceptance)).void
     }
    def initialize(
      account_token: nil,
