    ...
    module Analytics
      class MeterUsageRetrieveParams < ::Stripe::RequestParams
        class Meter < ::Stripe::RequestParams
          ...
          sig {
            params(dimension_filters: T.nilable(T::Hash[String, T::Array[String]]), dimension_group_by_keys: T.nilable(T::Array[String]), meter: String, tenant_filters: T.nilable(T::Hash[String, T::Array[String]])).void
           }
          def initialize(
