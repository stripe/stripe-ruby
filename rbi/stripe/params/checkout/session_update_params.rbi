      ...
      class LineItem < ::Stripe::RequestParams
        ...
        class PriceData < ::Stripe::RequestParams
          class ProductData < ::Stripe::RequestParams
            ...
            sig {
              returns(T.nilable(Checkout::SessionUpdateParams::LineItem::PriceData::ProductData::TaxDetails))
             }
            def tax_details; end
            sig {
              params(_tax_details: T.nilable(Checkout::SessionUpdateParams::LineItem::PriceData::ProductData::TaxDetails)).returns(T.nilable(Checkout::SessionUpdateParams::LineItem::PriceData::ProductData::TaxDetails))
             }
            def tax_details=(_tax_details); end
            sig {
              params(description: T.nilable(String), images: T.nilable(T::Array[String]), metadata: T.nilable(T::Hash[String, String]), name: String, tax_code: T.nilable(String), unit_label: T.nilable(String), tax_details: T.nilable(Checkout::SessionUpdateParams::LineItem::PriceData::ProductData::TaxDetails)).void
             }
            def initialize(
              description: nil,
              images: nil,
