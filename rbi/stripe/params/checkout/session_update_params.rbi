      ...
      class LineItem < ::Stripe::RequestParams
        ...
        class PriceData < ::Stripe::RequestParams
          class ProductData < ::Stripe::RequestParams
            ...
            sig {
              params(description: T.nilable(String), images: T.nilable(T::Array[String]), metadata: T.nilable(T::Hash[String, String]), name: String, tax_code: T.nilable(String), tax_details: T.nilable(Checkout::SessionUpdateParams::LineItem::PriceData::ProductData::TaxDetails), unit_label: T.nilable(String)).void
             }
            def initialize(
              description: nil,
              images: nil,
