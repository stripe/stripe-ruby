...
module Stripe
  class CreditNotePreviewParams < ::Stripe::RequestParams
    class Line < ::Stripe::RequestParams
      ...
      sig { returns(T.nilable(T.any(String, T::Array[CreditNotePreviewParams::Line::TaxAmount]))) }
      def tax_amounts; end
      sig {
        params(_tax_amounts: T.nilable(T.any(String, T::Array[CreditNotePreviewParams::Line::TaxAmount]))).returns(T.nilable(T.any(String, T::Array[CreditNotePreviewParams::Line::TaxAmount])))
       }
    ...
    class Refund < ::Stripe::RequestParams
      ...
      sig { returns(T.nilable(CreditNotePreviewParams::Refund::PaymentRecordRefund)) }
      def payment_record_refund; end
      sig {
        params(_payment_record_refund: T.nilable(CreditNotePreviewParams::Refund::PaymentRecordRefund)).returns(T.nilable(CreditNotePreviewParams::Refund::PaymentRecordRefund))
       }
      ...
      def type=(_type); end
      sig {
        params(amount_refunded: T.nilable(Integer), payment_record_refund: T.nilable(CreditNotePreviewParams::Refund::PaymentRecordRefund), refund: T.nilable(String), type: T.nilable(String)).void
       }
    ...
    sig { returns(T.nilable(T::Array[CreditNotePreviewParams::Line])) }
    def lines; end
    sig {
      params(_lines: T.nilable(T::Array[CreditNotePreviewParams::Line])).returns(T.nilable(T::Array[CreditNotePreviewParams::Line]))
     }
    ...
    sig { returns(T.nilable(T::Array[CreditNotePreviewParams::Refund])) }
    def refunds; end
    sig {
      params(_refunds: T.nilable(T::Array[CreditNotePreviewParams::Refund])).returns(T.nilable(T::Array[CreditNotePreviewParams::Refund]))
     }
    def refunds=(_refunds); end
    # When shipping_cost contains the shipping_rate from the invoice, the shipping_cost is included in the credit note. One of `amount`, `lines`, or `shipping_cost` must be provided.
    sig { returns(T.nilable(CreditNotePreviewParams::ShippingCost)) }
    def shipping_cost; end
    sig {
      params(_shipping_cost: T.nilable(CreditNotePreviewParams::ShippingCost)).returns(T.nilable(CreditNotePreviewParams::ShippingCost))
     }
    def shipping_cost=(_shipping_cost); end
    sig {
      params(amount: T.nilable(Integer), credit_amount: T.nilable(Integer), effective_at: T.nilable(Integer), email_type: T.nilable(String), expand: T.nilable(T::Array[String]), invoice: String, lines: T.nilable(T::Array[CreditNotePreviewParams::Line]), memo: T.nilable(String), metadata: T.nilable(T::Hash[String, String]), out_of_band_amount: T.nilable(Integer), reason: T.nilable(String), refund_amount: T.nilable(Integer), refunds: T.nilable(T::Array[CreditNotePreviewParams::Refund]), shipping_cost: T.nilable(CreditNotePreviewParams::ShippingCost)).void
     }
    def initialize(
      amount: nil,
      credit_amount: nil,
