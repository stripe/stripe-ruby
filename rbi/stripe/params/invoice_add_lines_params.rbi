...
module Stripe
  class InvoiceAddLinesParams < ::Stripe::RequestParams
    class Line < ::Stripe::RequestParams
      class Discount < ::Stripe::RequestParams
        class DiscountEnd < ::Stripe::RequestParams
          ...
          sig { returns(T.nilable(InvoiceAddLinesParams::Line::Discount::DiscountEnd::Duration)) }
          def duration; end
          sig {
            params(_duration: T.nilable(InvoiceAddLinesParams::Line::Discount::DiscountEnd::Duration)).returns(T.nilable(InvoiceAddLinesParams::Line::Discount::DiscountEnd::Duration))
           }
          ...
          def type=(_type); end
          sig {
            params(duration: T.nilable(InvoiceAddLinesParams::Line::Discount::DiscountEnd::Duration), timestamp: T.nilable(Integer), type: String).void
           }
        ...
        sig { returns(T.nilable(InvoiceAddLinesParams::Line::Discount::DiscountEnd)) }
        def discount_end; end
        sig {
          params(_discount_end: T.nilable(InvoiceAddLinesParams::Line::Discount::DiscountEnd)).returns(T.nilable(InvoiceAddLinesParams::Line::Discount::DiscountEnd))
         }
        ...
        sig {
          params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(InvoiceAddLinesParams::Line::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
         }
      ...
      class PriceData < ::Stripe::RequestParams
        ...
        sig { returns(T.nilable(InvoiceAddLinesParams::Line::PriceData::ProductData)) }
        def product_data; end
        sig {
          params(_product_data: T.nilable(InvoiceAddLinesParams::Line::PriceData::ProductData)).returns(T.nilable(InvoiceAddLinesParams::Line::PriceData::ProductData))
         }
        ...
        sig {
          params(currency: String, product: T.nilable(String), product_data: T.nilable(InvoiceAddLinesParams::Line::PriceData::ProductData), tax_behavior: T.nilable(String), unit_amount: T.nilable(Integer), unit_amount_decimal: T.nilable(String)).void
         }
        def initialize(
          currency: nil,
          product: nil,
      ...
      class TaxAmount < ::Stripe::RequestParams
        ...
        sig { returns(InvoiceAddLinesParams::Line::TaxAmount::TaxRateData) }
        def tax_rate_data; end
        sig {
          params(_tax_rate_data: InvoiceAddLinesParams::Line::TaxAmount::TaxRateData).returns(InvoiceAddLinesParams::Line::TaxAmount::TaxRateData)
         }
        ...
        sig {
          params(amount: Integer, tax_rate_data: InvoiceAddLinesParams::Line::TaxAmount::TaxRateData, taxability_reason: T.nilable(String), taxable_amount: Integer).void
         }
        def initialize(
          amount: nil,
          tax_rate_data: nil,
      ...
      sig { returns(T.nilable(T.any(String, T::Array[InvoiceAddLinesParams::Line::Discount]))) }
      def discounts; end
      sig {
        params(_discounts: T.nilable(T.any(String, T::Array[InvoiceAddLinesParams::Line::Discount]))).returns(T.nilable(T.any(String, T::Array[InvoiceAddLinesParams::Line::Discount])))
       }
      ...
      sig { returns(T.nilable(InvoiceAddLinesParams::Line::Period)) }
      def period; end
      sig {
        params(_period: T.nilable(InvoiceAddLinesParams::Line::Period)).returns(T.nilable(InvoiceAddLinesParams::Line::Period))
       }
      def period=(_period); end
      # Data used to generate a new [Price](https://docs.stripe.com/api/prices) object inline.
      sig { returns(T.nilable(InvoiceAddLinesParams::Line::PriceData)) }
      def price_data; end
      sig {
        params(_price_data: T.nilable(InvoiceAddLinesParams::Line::PriceData)).returns(T.nilable(InvoiceAddLinesParams::Line::PriceData))
       }
      def price_data=(_price_data); end
      # The pricing information for the invoice item.
      sig { returns(T.nilable(InvoiceAddLinesParams::Line::Pricing)) }
      def pricing; end
      sig {
        params(_pricing: T.nilable(InvoiceAddLinesParams::Line::Pricing)).returns(T.nilable(InvoiceAddLinesParams::Line::Pricing))
       }
      ...
      sig { returns(T.nilable(T.any(String, T::Array[InvoiceAddLinesParams::Line::TaxAmount]))) }
      def tax_amounts; end
      sig {
        params(_tax_amounts: T.nilable(T.any(String, T::Array[InvoiceAddLinesParams::Line::TaxAmount]))).returns(T.nilable(T.any(String, T::Array[InvoiceAddLinesParams::Line::TaxAmount])))
       }
      ...
      sig {
        params(amount: T.nilable(Integer), description: T.nilable(String), discountable: T.nilable(T::Boolean), discounts: T.nilable(T.any(String, T::Array[InvoiceAddLinesParams::Line::Discount])), invoice_item: T.nilable(String), margins: T.nilable(T.any(String, T::Array[String])), metadata: T.nilable(T.any(String, T::Hash[String, String])), period: T.nilable(InvoiceAddLinesParams::Line::Period), price_data: T.nilable(InvoiceAddLinesParams::Line::PriceData), pricing: T.nilable(InvoiceAddLinesParams::Line::Pricing), quantity: T.nilable(Integer), tax_amounts: T.nilable(T.any(String, T::Array[InvoiceAddLinesParams::Line::TaxAmount])), tax_rates: T.nilable(T.any(String, T::Array[String]))).void
       }
      def initialize(
        amount: nil,
        description: nil,
    ...
    sig { returns(T::Array[InvoiceAddLinesParams::Line]) }
    def lines; end
    sig {
      params(_lines: T::Array[InvoiceAddLinesParams::Line]).returns(T::Array[InvoiceAddLinesParams::Line])
     }
    def lines=(_lines); end
    sig {
      params(expand: T.nilable(T::Array[String]), invoice_metadata: T.nilable(T.any(String, T::Hash[String, String])), lines: T::Array[InvoiceAddLinesParams::Line]).void
     }
