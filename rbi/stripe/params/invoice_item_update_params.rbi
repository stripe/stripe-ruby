  ...
  class InvoiceItemUpdateParams < Stripe::RequestParams
    class Discount < Stripe::RequestParams
      class DiscountEnd < Stripe::RequestParams
        ...
        sig { returns(T.nilable(InvoiceItemUpdateParams::Discount::DiscountEnd::Duration)) }
        def duration; end
        sig {
          params(_duration: T.nilable(InvoiceItemUpdateParams::Discount::DiscountEnd::Duration)).returns(T.nilable(InvoiceItemUpdateParams::Discount::DiscountEnd::Duration))
         }
        ...
        def type=(_type); end
        sig {
          params(duration: T.nilable(InvoiceItemUpdateParams::Discount::DiscountEnd::Duration), timestamp: T.nilable(Integer), type: String).void
         }
      ...
      sig { returns(T.nilable(InvoiceItemUpdateParams::Discount::DiscountEnd)) }
      def discount_end; end
      sig {
        params(_discount_end: T.nilable(InvoiceItemUpdateParams::Discount::DiscountEnd)).returns(T.nilable(InvoiceItemUpdateParams::Discount::DiscountEnd))
       }
      ...
      sig {
        params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(InvoiceItemUpdateParams::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
       }
    ...
    def unit_amount_decimal=(_unit_amount_decimal); end
    sig {
      params(amount: T.nilable(Integer), description: T.nilable(String), discountable: T.nilable(T::Boolean), discounts: T.nilable(T.any(String, T::Array[InvoiceItemUpdateParams::Discount])), expand: T.nilable(T::Array[String]), margins: T.nilable(T.any(String, T::Array[String])), metadata: T.nilable(T.any(String, T::Hash[String, String])), period: T.nilable(InvoiceItemUpdateParams::Period), price_data: T.nilable(InvoiceItemUpdateParams::PriceData), pricing: T.nilable(InvoiceItemUpdateParams::Pricing), quantity: T.nilable(Integer), tax_behavior: T.nilable(String), tax_code: T.nilable(String), tax_rates: T.nilable(T.any(String, T::Array[String])), unit_amount_decimal: T.nilable(String)).void
     }
    def initialize(
      amount: nil,
      description: nil,
