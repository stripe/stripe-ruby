...
module Stripe
  class InvoiceUpdateLinesParams < ::Stripe::RequestParams
    class Line < ::Stripe::RequestParams
      ...
      sig {
        params(amount: T.nilable(Integer), description: T.nilable(String), discountable: T.nilable(T::Boolean), discounts: T.nilable(T.any(String, T::Array[InvoiceUpdateLinesParams::Line::Discount])), id: String, metadata: T.nilable(T.any(String, T::Hash[String, String])), period: T.nilable(InvoiceUpdateLinesParams::Line::Period), price_data: T.nilable(InvoiceUpdateLinesParams::Line::PriceData), pricing: T.nilable(InvoiceUpdateLinesParams::Line::Pricing), quantity: T.nilable(Integer), tax_amounts: T.nilable(T.any(String, T::Array[InvoiceUpdateLinesParams::Line::TaxAmount])), tax_rates: T.nilable(T.any(String, T::Array[String]))).void
       }
      def initialize(
        amount: nil,
        description: nil,
