...
module Stripe
  module Issuing
    class AuthorizationCaptureParams < ::Stripe::RequestParams
      ...
      sig {
        params(capture_amount: T.nilable(Integer), close_authorization: T.nilable(T::Boolean), expand: T.nilable(T::Array[String]), purchase_details: T.nilable(::Stripe::Issuing::AuthorizationCaptureParams::PurchaseDetails)).void
       }
      def initialize(
        capture_amount: nil,
