  ...
  module Issuing
    class AuthorizationCreateParams < ::Stripe::RequestParams
      ...
      class RiskAssessment < ::Stripe::RequestParams
        ...
        sig {
          params(card_testing_risk: T.nilable(Issuing::AuthorizationCreateParams::RiskAssessment::CardTestingRisk), merchant_dispute_risk: T.nilable(Issuing::AuthorizationCreateParams::RiskAssessment::MerchantDisputeRisk)).void
         }
