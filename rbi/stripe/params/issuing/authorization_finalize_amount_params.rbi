    ...
    class AuthorizationFinalizeAmountParams < ::Stripe::RequestParams
      class Fleet < ::Stripe::RequestParams
        ...
        class ReportedBreakdown < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::Fuel))
           }
          def fuel; end
          sig {
            params(_fuel: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::Fuel)).returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::Fuel))
           }
          def fuel=(_fuel); end
          # Breakdown of non-fuel portion of the purchase.
          sig {
            returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::NonFuel))
           }
          def non_fuel; end
          sig {
            params(_non_fuel: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::NonFuel)).returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::NonFuel))
           }
          def non_fuel=(_non_fuel); end
          # Information about tax included in this transaction.
          sig {
            returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::Tax))
           }
          def tax; end
          sig {
            params(_tax: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::Tax)).returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::Tax))
           }
          def tax=(_tax); end
          sig {
            params(fuel: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::Fuel), non_fuel: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::NonFuel), tax: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown::Tax)).void
           }
          def initialize(fuel: nil, non_fuel: nil, tax: nil); end
        end
        # Answers to prompts presented to the cardholder at the point of sale. Prompted fields vary depending on the configuration of your physical fleet cards. Typical points of sale support only numeric entry.
        sig {
          returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::CardholderPromptData))
         }
        def cardholder_prompt_data; end
        sig {
          params(_cardholder_prompt_data: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::CardholderPromptData)).returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::CardholderPromptData))
         }
        ...
        sig {
          returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown))
         }
        def reported_breakdown; end
        sig {
          params(_reported_breakdown: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown)).returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown))
         }
        ...
        sig {
          params(cardholder_prompt_data: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::CardholderPromptData), purchase_type: T.nilable(String), reported_breakdown: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet::ReportedBreakdown), service_type: T.nilable(String)).void
         }
        def initialize(
      ...
      sig { returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet)) }
      def fleet; end
      sig {
        params(_fleet: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet)).returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet))
       }
      def fleet=(_fleet); end
      # Information about fuel that was purchased with this transaction.
      sig { returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fuel)) }
      def fuel; end
      sig {
        params(_fuel: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fuel)).returns(T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fuel))
       }
      def fuel=(_fuel); end
      sig {
        params(expand: T.nilable(T::Array[String]), final_amount: Integer, fleet: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fleet), fuel: T.nilable(Issuing::AuthorizationFinalizeAmountParams::Fuel)).void
       }
