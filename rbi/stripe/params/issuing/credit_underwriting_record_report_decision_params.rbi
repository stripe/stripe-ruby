  ...
  module Issuing
    class CreditUnderwritingRecordReportDecisionParams < ::Stripe::RequestParams
      class Decision < ::Stripe::RequestParams
        ...
        sig {
          returns(T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::Decision::ApplicationRejected))
         }
        def application_rejected; end
        sig {
          params(_application_rejected: T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::Decision::ApplicationRejected)).returns(T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::Decision::ApplicationRejected))
         }
        ...
        sig {
          returns(T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::Decision::CreditLimitApproved))
         }
        def credit_limit_approved; end
        sig {
          params(_credit_limit_approved: T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::Decision::CreditLimitApproved)).returns(T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::Decision::CreditLimitApproved))
         }
        ...
        def type=(_type); end
        sig {
          params(application_rejected: T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::Decision::ApplicationRejected), credit_limit_approved: T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::Decision::CreditLimitApproved), type: String).void
         }
      ...
      sig { returns(Issuing::CreditUnderwritingRecordReportDecisionParams::Decision) }
      def decision; end
      sig {
        params(_decision: Issuing::CreditUnderwritingRecordReportDecisionParams::Decision).returns(Issuing::CreditUnderwritingRecordReportDecisionParams::Decision)
       }
      ...
      sig {
        returns(T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::UnderwritingException))
       }
      def underwriting_exception; end
      sig {
        params(_underwriting_exception: T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::UnderwritingException)).returns(T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::UnderwritingException))
       }
      def underwriting_exception=(_underwriting_exception); end
      sig {
        params(decided_at: Integer, decision: Issuing::CreditUnderwritingRecordReportDecisionParams::Decision, expand: T.nilable(T::Array[String]), metadata: T.nilable(T::Hash[String, String]), regulatory_reporting_file: T.nilable(String), underwriting_exception: T.nilable(Issuing::CreditUnderwritingRecordReportDecisionParams::UnderwritingException)).void
       }
      def initialize(
        decided_at: nil,
        decision: nil,
