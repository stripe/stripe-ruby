...
module Stripe
  class PaymentAttemptRecordReportFailedParams < ::Stripe::RequestParams
    ...
    sig {
      params(expand: T.nilable(T::Array[String]), failed_at: T.nilable(Integer), failure_code: T.nilable(String), metadata: T.nilable(T.any(String, T::Hash[String, String])), processor_details: T.nilable(::Stripe::PaymentAttemptRecordReportFailedParams::ProcessorDetails)).void
     }
    def initialize(
      expand: nil,
      failed_at: nil,
