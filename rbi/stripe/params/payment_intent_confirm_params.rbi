  ...
  class PaymentIntentConfirmParams < ::Stripe::RequestParams
    ...
    class PaymentMethodOptions < ::Stripe::RequestParams
      ...
      class UsBankAccount < ::Stripe::RequestParams
        ...
        sig {
          params(financial_connections: T.nilable(PaymentIntentConfirmParams::PaymentMethodOptions::UsBankAccount::FinancialConnections), mandate_options: T.nilable(PaymentIntentConfirmParams::PaymentMethodOptions::UsBankAccount::MandateOptions), networks: T.nilable(PaymentIntentConfirmParams::PaymentMethodOptions::UsBankAccount::Networks), setup_future_usage: T.nilable(T.any(String, String)), target_date: T.nilable(String), verification_method: T.nilable(String), preferred_settlement_speed: T.nilable(String)).void
         }
        def initialize(
