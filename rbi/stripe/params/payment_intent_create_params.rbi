  ...
  class PaymentIntentCreateParams < ::Stripe::RequestParams
    ...
    class Hooks < ::Stripe::RequestParams
      class Inputs < ::Stripe::RequestParams
        ...
        sig { returns(T.nilable(PaymentIntentCreateParams::Hooks::Inputs::Tax)) }
        def tax; end
        sig {
          params(_tax: T.nilable(PaymentIntentCreateParams::Hooks::Inputs::Tax)).returns(T.nilable(PaymentIntentCreateParams::Hooks::Inputs::Tax))
         }
        def tax=(_tax); end
        sig { params(tax: T.nilable(PaymentIntentCreateParams::Hooks::Inputs::Tax)).void }
        def initialize(tax: nil); end
      end
      # Arguments passed in automations
      sig { returns(T.nilable(PaymentIntentCreateParams::Hooks::Inputs)) }
      def inputs; end
      sig {
        params(_inputs: T.nilable(PaymentIntentCreateParams::Hooks::Inputs)).returns(T.nilable(PaymentIntentCreateParams::Hooks::Inputs))
       }
      def inputs=(_inputs); end
      sig { params(inputs: T.nilable(PaymentIntentCreateParams::Hooks::Inputs)).void }
    ...
    class PaymentDetails < ::Stripe::RequestParams
      ...
      class CarRental < ::Stripe::RequestParams
        ...
        class Delivery < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Delivery::Recipient))
           }
          def recipient; end
          sig {
            params(_recipient: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Delivery::Recipient)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Delivery::Recipient))
           }
          def recipient=(_recipient); end
          sig {
            params(mode: T.nilable(String), recipient: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Delivery::Recipient)).void
           }
        ...
        sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Affiliate)) }
        def affiliate; end
        sig {
          params(_affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Affiliate)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Affiliate))
         }
        ...
        sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Delivery)) }
        def delivery; end
        sig {
          params(_delivery: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Delivery)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Delivery))
         }
        def delivery=(_delivery); end
        # The details of the distance traveled during the rental period.
        sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Distance)) }
        def distance; end
        sig {
          params(_distance: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Distance)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Distance))
         }
        def distance=(_distance); end
        # The details of the passengers in the travel reservation
        sig {
          returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRental::Driver]))
         }
        def drivers; end
        sig {
          params(_drivers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRental::Driver])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRental::Driver]))
         }
        ...
        # Car pick-up address.
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::PickupAddress))
         }
        def pickup_address; end
        sig {
          params(_pickup_address: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::PickupAddress)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::PickupAddress))
         }
        ...
        # Car return address.
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::ReturnAddress))
         }
        def return_address; end
        sig {
          params(_return_address: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::ReturnAddress)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::ReturnAddress))
         }
        ...
        sig {
          params(affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Affiliate), booking_number: String, car_class_code: T.nilable(String), car_make: T.nilable(String), car_model: T.nilable(String), company: T.nilable(String), customer_service_phone_number: T.nilable(String), days_rented: Integer, delivery: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Delivery), distance: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::Distance), drivers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRental::Driver]), extra_charges: T.nilable(T::Array[String]), no_show: T.nilable(T::Boolean), pickup_address: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::PickupAddress), pickup_at: Integer, pickup_location_name: T.nilable(String), rate_amount: T.nilable(Integer), rate_interval: T.nilable(String), renter_name: T.nilable(String), return_address: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental::ReturnAddress), return_at: Integer, return_location_name: T.nilable(String), tax_exempt: T.nilable(T::Boolean), vehicle_identification_number: T.nilable(String)).void
         }
        def initialize(
          affiliate: nil,
          booking_number: nil,
      ...
      class CarRentalDatum < ::Stripe::RequestParams
        ...
        class Driver < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Driver::DateOfBirth))
           }
          def date_of_birth; end
          sig {
            params(_date_of_birth: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Driver::DateOfBirth)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Driver::DateOfBirth))
           }
          ...
          def name=(_name); end
          sig {
            params(date_of_birth: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Driver::DateOfBirth), driver_identification_number: T.nilable(String), driver_tax_number: T.nilable(String), name: String).void
           }
          def initialize(
            date_of_birth: nil,
        ...
        class DropOff < ::Stripe::RequestParams
          ...
          sig {
            returns(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::DropOff::Address)
           }
          def address; end
          sig {
            params(_address: PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::DropOff::Address).returns(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::DropOff::Address)
           }
          ...
          def time=(_time); end
          sig {
            params(address: PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::DropOff::Address, location_name: T.nilable(String), time: Integer).void
           }
        ...
        class Pickup < ::Stripe::RequestParams
          ...
          # Address of the rental location.
          sig {
            returns(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Pickup::Address)
           }
          def address; end
          sig {
            params(_address: PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Pickup::Address).returns(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Pickup::Address)
           }
          def address=(_address); end
          # Location name.
          sig { returns(T.nilable(String)) }
          ...
          def time=(_time); end
          sig {
            params(address: PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Pickup::Address, location_name: T.nilable(String), time: Integer).void
           }
          def initialize(address: nil, location_name: nil, time: nil); end
        end
        class Total < ::Stripe::RequestParams
          ...
          class Tax < ::Stripe::RequestParams
            ...
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Tax::Tax]))
             }
            def taxes; end
            sig {
              params(_taxes: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Tax::Tax])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Tax::Tax]))
             }
            def taxes=(_taxes); end
            sig {
              params(tax_exempt_indicator: T.nilable(T::Boolean), taxes: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Tax::Tax])).void
             }
          ...
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Discounts))
           }
          def discounts; end
          sig {
            params(_discounts: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Discounts)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Discounts))
           }
          def discounts=(_discounts); end
          # Additional charges for the rental.
          sig {
            returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::ExtraCharge]))
           }
          def extra_charges; end
          sig {
            params(_extra_charges: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::ExtraCharge])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::ExtraCharge]))
           }
          def extra_charges=(_extra_charges); end
          ...
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Tax))
           }
          def tax; end
          sig {
            params(_tax: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Tax)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Tax))
           }
          def tax=(_tax); end
          sig {
            params(amount: Integer, currency: T.nilable(String), discounts: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Discounts), extra_charges: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::ExtraCharge]), rate_per_unit: T.nilable(Integer), rate_unit: T.nilable(String), tax: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total::Tax)).void
           }
          def initialize(
            amount: nil,
            currency: nil,
        ...
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Affiliate))
         }
        def affiliate; end
        sig {
          params(_affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Affiliate)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Affiliate))
         }
        def affiliate=(_affiliate); end
        ...
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Distance))
         }
        def distance; end
        sig {
          params(_distance: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Distance)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Distance))
         }
        def distance=(_distance); end
        # List of drivers for the rental.
        sig {
          returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Driver]))
         }
        def drivers; end
        sig {
          params(_drivers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Driver])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Driver]))
         }
        def drivers=(_drivers); end
        # Drop-off location details.
        sig { returns(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::DropOff) }
        def drop_off; end
        sig {
          params(_drop_off: PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::DropOff).returns(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::DropOff)
         }
        def drop_off=(_drop_off); end
        # Insurance details for the rental.
        sig {
          returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Insurance]))
         }
        def insurances; end
        sig {
          params(_insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Insurance])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Insurance]))
         }
        ...
        sig { returns(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Pickup) }
        def pickup; end
        sig {
          params(_pickup: PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Pickup).returns(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Pickup)
         }
        ...
        sig { returns(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total) }
        def total; end
        sig {
          params(_total: PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total).returns(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total)
         }
        def total=(_total); end
        # Vehicle details for the rental.
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Vehicle))
         }
        def vehicle; end
        sig {
          params(_vehicle: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Vehicle)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Vehicle))
         }
        def vehicle=(_vehicle); end
        sig {
          params(affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Affiliate), booking_number: T.nilable(String), carrier_name: T.nilable(String), customer_service_phone_number: T.nilable(String), days_rented: T.nilable(Integer), distance: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Distance), drivers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Driver]), drop_off: PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::DropOff, insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Insurance]), no_show_indicator: T.nilable(T::Boolean), pickup: PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Pickup, renter_name: T.nilable(String), total: PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Total, vehicle: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRentalDatum::Vehicle)).void
         }
        def initialize(
          affiliate: nil,
          booking_number: nil,
      ...
      class EventDetails < ::Stripe::RequestParams
        ...
        class Delivery < ::Stripe::RequestParams
          ...
          # Details of the recipient.
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Delivery::Recipient))
           }
          def recipient; end
          sig {
            params(_recipient: T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Delivery::Recipient)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Delivery::Recipient))
           }
          def recipient=(_recipient); end
          sig {
            params(mode: T.nilable(String), recipient: T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Delivery::Recipient)).void
           }
          def initialize(mode: nil, recipient: nil); end
        end
        ...
        sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Address)) }
        def address; end
        sig {
          params(_address: T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Address))
         }
        def address=(_address); end
        # Affiliate details for this purchase.
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Affiliate))
         }
        def affiliate; end
        sig {
          params(_affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Affiliate)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Affiliate))
         }
        def affiliate=(_affiliate); end
        ...
        # Delivery details for this purchase.
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Delivery))
         }
        def delivery; end
        sig {
          params(_delivery: T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Delivery)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Delivery))
         }
        def delivery=(_delivery); end
        ...
        sig {
          params(access_controlled_venue: T.nilable(T::Boolean), address: T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Address), affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Affiliate), company: T.nilable(String), delivery: T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails::Delivery), ends_at: T.nilable(Integer), genre: T.nilable(String), name: String, starts_at: T.nilable(Integer)).void
         }
        def initialize(
      ...
      class Flight < ::Stripe::RequestParams
        ...
        class Delivery < ::Stripe::RequestParams
          ...
          # Details of the recipient.
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Delivery::Recipient))
           }
          def recipient; end
          sig {
            params(_recipient: T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Delivery::Recipient)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Delivery::Recipient))
           }
          def recipient=(_recipient); end
          sig {
            params(mode: T.nilable(String), recipient: T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Delivery::Recipient)).void
           }
          def initialize(mode: nil, recipient: nil); end
        end
        ...
        # Affiliate details for this purchase.
        sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Affiliate)) }
        def affiliate; end
        sig {
          params(_affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Affiliate)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Affiliate))
         }
        def affiliate=(_affiliate); end
        ...
        def carrier=(_carrier); end
        # Delivery details for this purchase.
        sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Delivery)) }
        def delivery; end
        sig {
          params(_delivery: T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Delivery)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Delivery))
         }
        def delivery=(_delivery); end
        ...
        # The details of the passengers in the travel reservation.
        sig {
          returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::Flight::Passenger]))
         }
        def passengers; end
        sig {
          params(_passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::Flight::Passenger])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::Flight::Passenger]))
         }
        def passengers=(_passengers); end
        # The individual flight segments associated with the trip.
        sig { returns(T::Array[PaymentIntentCreateParams::PaymentDetails::Flight::Segment]) }
        def segments; end
        sig {
          params(_segments: T::Array[PaymentIntentCreateParams::PaymentDetails::Flight::Segment]).returns(T::Array[PaymentIntentCreateParams::PaymentDetails::Flight::Segment])
         }
        ...
        sig {
          params(affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Affiliate), agency_number: T.nilable(String), carrier: T.nilable(String), delivery: T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight::Delivery), passenger_name: T.nilable(String), passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::Flight::Passenger]), segments: T::Array[PaymentIntentCreateParams::PaymentDetails::Flight::Segment], ticket_number: T.nilable(String)).void
         }
        def initialize(
          affiliate: nil,
          agency_number: nil,
      ...
      class FlightDatum < ::Stripe::RequestParams
        ...
        class Segment < ::Stripe::RequestParams
          ...
          def amount=(_amount); end
          # Arrival details.
          sig { returns(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Segment::Arrival) }
          def arrival; end
          sig {
            params(_arrival: PaymentIntentCreateParams::PaymentDetails::FlightDatum::Segment::Arrival).returns(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Segment::Arrival)
           }
          ...
          # Departure details.
          sig {
            returns(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Segment::Departure)
           }
          def departure; end
          sig {
            params(_departure: PaymentIntentCreateParams::PaymentDetails::FlightDatum::Segment::Departure).returns(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Segment::Departure)
           }
        ...
        class Total < ::Stripe::RequestParams
          ...
          class Tax < ::Stripe::RequestParams
            ...
            # Array of tax details.
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Tax::Tax]))
             }
            def taxes; end
            sig {
              params(_taxes: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Tax::Tax])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Tax::Tax]))
             }
            def taxes=(_taxes); end
            sig {
              params(taxes: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Tax::Tax])).void
             }
          ...
          # Discount details.
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Discounts))
           }
          def discounts; end
          sig {
            params(_discounts: T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Discounts)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Discounts))
           }
          def discounts=(_discounts); end
          # Additional charges.
          sig {
            returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::ExtraCharge]))
           }
          def extra_charges; end
          sig {
            params(_extra_charges: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::ExtraCharge])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::ExtraCharge]))
           }
          def extra_charges=(_extra_charges); end
          # Tax breakdown.
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Tax))
           }
          def tax; end
          sig {
            params(_tax: T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Tax)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Tax))
           }
          def tax=(_tax); end
          sig {
            params(amount: Integer, credit_reason: T.nilable(String), currency: T.nilable(String), discounts: T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Discounts), extra_charges: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::ExtraCharge]), tax: T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total::Tax)).void
           }
          def initialize(
            amount: nil,
            credit_reason: nil,
        ...
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Affiliate))
         }
        def affiliate; end
        sig {
          params(_affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Affiliate)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Affiliate))
         }
        def affiliate=(_affiliate); end
        ...
        # List of insurances.
        sig {
          returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Insurance]))
         }
        def insurances; end
        sig {
          params(_insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Insurance])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Insurance]))
         }
        def insurances=(_insurances); end
        # List of passengers.
        sig {
          returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Passenger]))
         }
        def passengers; end
        sig {
          params(_passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Passenger])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Passenger]))
         }
        def passengers=(_passengers); end
        # List of flight segments.
        sig { returns(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Segment]) }
        def segments; end
        sig {
          params(_segments: T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Segment]).returns(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Segment])
         }
        def segments=(_segments); end
        ...
        sig { returns(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total) }
        def total; end
        sig {
          params(_total: PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total).returns(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total)
         }
        def total=(_total); end
        ...
        sig {
          params(affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::FlightDatum::Affiliate), booking_number: T.nilable(String), computerized_reservation_system: T.nilable(String), endorsements_and_restrictions: T.nilable(String), insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Insurance]), passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Passenger]), segments: T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum::Segment], ticket_electronically_issued_indicator: T.nilable(T::Boolean), total: PaymentIntentCreateParams::PaymentDetails::FlightDatum::Total, transaction_type: T.nilable(String)).void
         }
        def initialize(
          affiliate: nil,
          booking_number: nil,
      ...
      class Lodging < ::Stripe::RequestParams
        ...
        class Delivery < ::Stripe::RequestParams
          ...
          # Details of the recipient.
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Delivery::Recipient))
           }
          def recipient; end
          sig {
            params(_recipient: T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Delivery::Recipient)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Delivery::Recipient))
           }
          def recipient=(_recipient); end
          sig {
            params(mode: T.nilable(String), recipient: T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Delivery::Recipient)).void
           }
          def initialize(mode: nil, recipient: nil); end
        end
        class Passenger < ::Stripe::RequestParams
        ...
        sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Address)) }
        def address; end
        sig {
          params(_address: T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Address))
         }
        def address=(_address); end
        ...
        # Affiliate details for this purchase.
        sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Affiliate)) }
        def affiliate; end
        sig {
          params(_affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Affiliate)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Affiliate))
         }
        def affiliate=(_affiliate); end
        ...
        # Delivery details for this purchase.
        sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Delivery)) }
        def delivery; end
        sig {
          params(_delivery: T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Delivery)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Delivery))
         }
        def delivery=(_delivery); end
        # List of additional charges being billed.
        sig { returns(T.nilable(T::Array[String])) }
        ...
        # The details of the passengers in the travel reservation
        sig {
          returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::Lodging::Passenger]))
         }
        def passengers; end
        sig {
          params(_passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::Lodging::Passenger])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::Lodging::Passenger]))
         }
        def passengers=(_passengers); end
        ...
        def total_tax_amount=(_total_tax_amount); end
        sig {
          params(address: T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Address), adults: T.nilable(Integer), affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Affiliate), booking_number: T.nilable(String), category: T.nilable(String), checkin_at: Integer, checkout_at: Integer, customer_service_phone_number: T.nilable(String), daily_room_rate_amount: T.nilable(Integer), delivery: T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging::Delivery), extra_charges: T.nilable(T::Array[String]), fire_safety_act_compliance: T.nilable(T::Boolean), name: T.nilable(String), no_show: T.nilable(T::Boolean), number_of_rooms: T.nilable(Integer), passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::Lodging::Passenger]), property_phone_number: T.nilable(String), room_class: T.nilable(String), room_nights: T.nilable(Integer), total_room_tax_amount: T.nilable(Integer), total_tax_amount: T.nilable(Integer)).void
         }
        def initialize(
          address: nil,
          adults: nil,
      ...
      class LodgingDatum < ::Stripe::RequestParams
        ...
        class Host < ::Stripe::RequestParams
          ...
          # Address of the host.
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Host::Address))
           }
          def address; end
          sig {
            params(_address: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Host::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Host::Address))
           }
          def address=(_address); end
          ...
          sig {
            params(address: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Host::Address), country_of_domicile: T.nilable(String), host_reference: T.nilable(String), host_type: T.nilable(String), name: T.nilable(String), number_of_reservations: T.nilable(Integer), property_phone_number: T.nilable(String), registered_at: T.nilable(Integer)).void
           }
          def initialize(
            address: nil,
        ...
        class Total < ::Stripe::RequestParams
          ...
          class Tax < ::Stripe::RequestParams
            ...
            # Tax details.
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Tax::Tax]))
             }
            def taxes; end
            sig {
              params(_taxes: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Tax::Tax])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Tax::Tax]))
             }
            def taxes=(_taxes); end
            sig {
              params(tax_exempt_indicator: T.nilable(T::Boolean), taxes: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Tax::Tax])).void
             }
            def initialize(tax_exempt_indicator: nil, taxes: nil); end
          end
          ...
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Discounts))
           }
          def discounts; end
          sig {
            params(_discounts: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Discounts)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Discounts))
           }
          def discounts=(_discounts); end
          # Additional charges for the lodging.
          sig {
            returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::ExtraCharge]))
           }
          def extra_charges; end
          sig {
            params(_extra_charges: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::ExtraCharge])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::ExtraCharge]))
           }
          def extra_charges=(_extra_charges); end
          ...
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Tax))
           }
          def tax; end
          sig {
            params(_tax: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Tax)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Tax))
           }
          def tax=(_tax); end
          sig {
            params(amount: Integer, cash_advances: T.nilable(Integer), currency: T.nilable(String), discounts: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Discounts), extra_charges: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::ExtraCharge]), prepaid_amount: T.nilable(Integer), tax: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total::Tax)).void
           }
          def initialize(
            amount: nil,
            cash_advances: nil,
        ...
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Accommodation))
         }
        def accommodation; end
        sig {
          params(_accommodation: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Accommodation)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Accommodation))
         }
        def accommodation=(_accommodation); end
        # Affiliate details if applicable.
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Affiliate))
         }
        def affiliate; end
        sig {
          params(_affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Affiliate)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Affiliate))
         }
        def affiliate=(_affiliate); end
        ...
        sig {
          returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Guest]))
         }
        def guests; end
        sig {
          params(_guests: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Guest])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Guest]))
         }
        def guests=(_guests); end
        # Host details for the lodging.
        sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Host)) }
        def host; end
        sig {
          params(_host: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Host)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Host))
         }
        def host=(_host); end
        # List of insurances for the lodging.
        sig {
          returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Insurance]))
         }
        def insurances; end
        sig {
          params(_insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Insurance])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Insurance]))
         }
        def insurances=(_insurances); end
        ...
        sig { returns(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total) }
        def total; end
        sig {
          params(_total: PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total).returns(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total)
         }
        def total=(_total); end
        sig {
          params(accommodation: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Accommodation), affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Affiliate), booking_number: T.nilable(String), checkin_at: Integer, checkout_at: Integer, customer_service_phone_number: T.nilable(String), fire_safety_act_compliance_indicator: T.nilable(T::Boolean), guests: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Guest]), host: T.nilable(PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Host), insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Insurance]), no_show_indicator: T.nilable(T::Boolean), renter_id_number: T.nilable(String), renter_name: T.nilable(String), total: PaymentIntentCreateParams::PaymentDetails::LodgingDatum::Total).void
         }
        def initialize(
          accommodation: nil,
          affiliate: nil,
      ...
      class Subscription < ::Stripe::RequestParams
        ...
        # Affiliate details for this purchase.
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Subscription::Affiliate))
         }
        def affiliate; end
        sig {
          params(_affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::Subscription::Affiliate)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Subscription::Affiliate))
         }
        def affiliate=(_affiliate); end
        ...
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Subscription::BillingInterval))
         }
        def billing_interval; end
        sig {
          params(_billing_interval: T.nilable(PaymentIntentCreateParams::PaymentDetails::Subscription::BillingInterval)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Subscription::BillingInterval))
         }
        ...
        def starts_at=(_starts_at); end
        sig {
          params(affiliate: T.nilable(PaymentIntentCreateParams::PaymentDetails::Subscription::Affiliate), auto_renewal: T.nilable(T::Boolean), billing_interval: T.nilable(PaymentIntentCreateParams::PaymentDetails::Subscription::BillingInterval), ends_at: T.nilable(Integer), name: String, starts_at: T.nilable(Integer)).void
         }
        def initialize(
          affiliate: nil,
          auto_renewal: nil,
      ...
      sig {
        returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum])))
       }
      def car_rental_data; end
      sig {
        params(_car_rental_data: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum]))).returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum])))
       }
      ...
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails)) }
      def event_details; end
      sig {
        params(_event_details: T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails))
       }
      def event_details=(_event_details); end
      # Flight reservation details for this PaymentIntent
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight)) }
      def flight; end
      sig {
        params(_flight: T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight)).returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight))
       }
      def flight=(_flight); end
      # Flight data for this PaymentIntent.
      sig {
        returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum])))
       }
      def flight_data; end
      sig {
        params(_flight_data: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum]))).returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum])))
       }
      def flight_data=(_flight_data); end
      # Lodging reservation details for this PaymentIntent
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging)) }
      def lodging; end
      sig {
      ...
      sig {
        returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum])))
       }
      def lodging_data; end
      sig {
        params(_lodging_data: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum]))).returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum])))
       }
      ...
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentDetails::Subscription)) }
      ...
      sig {
        params(benefit: T.nilable(PaymentIntentCreateParams::PaymentDetails::Benefit), car_rental: T.nilable(PaymentIntentCreateParams::PaymentDetails::CarRental), car_rental_data: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::CarRentalDatum])), customer_reference: T.nilable(String), event_details: T.nilable(PaymentIntentCreateParams::PaymentDetails::EventDetails), flight: T.nilable(PaymentIntentCreateParams::PaymentDetails::Flight), flight_data: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::FlightDatum])), lodging: T.nilable(PaymentIntentCreateParams::PaymentDetails::Lodging), lodging_data: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentDetails::LodgingDatum])), order_reference: T.nilable(String), subscription: T.nilable(PaymentIntentCreateParams::PaymentDetails::Subscription)).void
       }
      def initialize(
        benefit: nil,
        car_rental: nil,
    ...
    class PaymentMethodData < ::Stripe::RequestParams
      ...
      class Rechnung < ::Stripe::RequestParams
        ...
        # Customer's date of birth
        sig { returns(PaymentIntentCreateParams::PaymentMethodData::Rechnung::Dob) }
        def dob; end
        sig {
          params(_dob: PaymentIntentCreateParams::PaymentMethodData::Rechnung::Dob).returns(PaymentIntentCreateParams::PaymentMethodData::Rechnung::Dob)
         }
        def dob=(_dob); end
        sig { params(dob: PaymentIntentCreateParams::PaymentMethodData::Rechnung::Dob).void }
        def initialize(dob: nil); end
      end
      ...
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Gopay)) }
      def gopay; end
      sig {
        params(_gopay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Gopay)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Gopay))
       }
      ...
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::IdBankTransfer)) }
      def id_bank_transfer; end
      sig {
        params(_id_bank_transfer: T.nilable(PaymentIntentCreateParams::PaymentMethodData::IdBankTransfer)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::IdBankTransfer))
       }
      ...
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Paypay)) }
      def paypay; end
      sig {
        params(_paypay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Paypay)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Paypay))
       }
      def paypay=(_paypay); end
      # If this is a `payto` PaymentMethod, this hash contains details about the PayTo payment method.
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Payto)) }
      def payto; end
      sig {
        params(_payto: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Payto)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Payto))
       }
      ...
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Qris)) }
      def qris; end
      sig {
        params(_qris: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Qris)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Qris))
       }
      def qris=(_qris); end
      ...
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Rechnung)) }
      def rechnung; end
      sig {
        params(_rechnung: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Rechnung)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Rechnung))
       }
      ...
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Shopeepay)) }
      def shopeepay; end
      sig {
        params(_shopeepay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Shopeepay)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::Shopeepay))
       }
      ...
      sig { returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::StripeBalance)) }
      def stripe_balance; end
      sig {
        params(_stripe_balance: T.nilable(PaymentIntentCreateParams::PaymentMethodData::StripeBalance)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodData::StripeBalance))
       }
      ...
      def zip=(_zip); end
      sig {
        params(acss_debit: T.nilable(PaymentIntentCreateParams::PaymentMethodData::AcssDebit), affirm: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Affirm), afterpay_clearpay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::AfterpayClearpay), alipay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Alipay), allow_redisplay: T.nilable(String), alma: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Alma), amazon_pay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::AmazonPay), au_becs_debit: T.nilable(PaymentIntentCreateParams::PaymentMethodData::AuBecsDebit), bacs_debit: T.nilable(PaymentIntentCreateParams::PaymentMethodData::BacsDebit), bancontact: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Bancontact), billie: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Billie), billing_details: T.nilable(PaymentIntentCreateParams::PaymentMethodData::BillingDetails), blik: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Blik), boleto: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Boleto), cashapp: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Cashapp), crypto: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Crypto), customer_balance: T.nilable(PaymentIntentCreateParams::PaymentMethodData::CustomerBalance), eps: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Eps), fpx: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Fpx), giropay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Giropay), gopay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Gopay), grabpay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Grabpay), id_bank_transfer: T.nilable(PaymentIntentCreateParams::PaymentMethodData::IdBankTransfer), ideal: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Ideal), interac_present: T.nilable(PaymentIntentCreateParams::PaymentMethodData::InteracPresent), kakao_pay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::KakaoPay), klarna: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Klarna), konbini: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Konbini), kr_card: T.nilable(PaymentIntentCreateParams::PaymentMethodData::KrCard), link: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Link), mb_way: T.nilable(PaymentIntentCreateParams::PaymentMethodData::MbWay), metadata: T.nilable(T::Hash[String, String]), mobilepay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Mobilepay), multibanco: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Multibanco), naver_pay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::NaverPay), nz_bank_account: T.nilable(PaymentIntentCreateParams::PaymentMethodData::NzBankAccount), oxxo: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Oxxo), p24: T.nilable(PaymentIntentCreateParams::PaymentMethodData::P24), pay_by_bank: T.nilable(PaymentIntentCreateParams::PaymentMethodData::PayByBank), payco: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Payco), paynow: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Paynow), paypal: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Paypal), paypay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Paypay), payto: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Payto), pix: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Pix), promptpay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Promptpay), qris: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Qris), radar_options: T.nilable(PaymentIntentCreateParams::PaymentMethodData::RadarOptions), rechnung: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Rechnung), revolut_pay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::RevolutPay), samsung_pay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::SamsungPay), satispay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Satispay), sepa_debit: T.nilable(PaymentIntentCreateParams::PaymentMethodData::SepaDebit), shopeepay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Shopeepay), sofort: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Sofort), stripe_balance: T.nilable(PaymentIntentCreateParams::PaymentMethodData::StripeBalance), swish: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Swish), twint: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Twint), type: String, us_bank_account: T.nilable(PaymentIntentCreateParams::PaymentMethodData::UsBankAccount), wechat_pay: T.nilable(PaymentIntentCreateParams::PaymentMethodData::WechatPay), zip: T.nilable(PaymentIntentCreateParams::PaymentMethodData::Zip)).void
       }
      def initialize(
        acss_debit: nil,
        affirm: nil,
    ...
    class PaymentMethodOptions < ::Stripe::RequestParams
      ...
      class Card < ::Stripe::RequestParams
        ...
        class StatementDetails < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Card::StatementDetails::Address))
           }
          def address; end
          sig {
            params(_address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Card::StatementDetails::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Card::StatementDetails::Address))
           }
          def address=(_address); end
          ...
          def phone=(_phone); end
          sig {
            params(address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Card::StatementDetails::Address), phone: T.nilable(String)).void
           }
        ...
        sig {
          returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Card::StatementDetails)))
         }
        def statement_details; end
        sig {
          params(_statement_details: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Card::StatementDetails))).returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Card::StatementDetails)))
         }
        ...
        sig {
          params(capture_method: T.nilable(String), cvc_token: T.nilable(String), installments: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Card::Installments), mandate_options: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Card::MandateOptions), moto: T.nilable(T::Boolean), network: T.nilable(String), request_decremental_authorization: T.nilable(String), request_extended_authorization: T.nilable(String), request_incremental_authorization: T.nilable(String), request_multicapture: T.nilable(String), request_overcapture: T.nilable(String), request_partial_authorization: T.nilable(String), request_three_d_secure: T.nilable(String), require_cvc_recollection: T.nilable(T::Boolean), setup_future_usage: T.nilable(T.any(String, String)), statement_descriptor_suffix_kana: T.nilable(String), statement_descriptor_suffix_kanji: T.nilable(String), statement_details: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Card::StatementDetails)), three_d_secure: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Card::ThreeDSecure)).void
         }
        def initialize(
          capture_method: nil,
          cvc_token: nil,
      ...
      class CardPresent < ::Stripe::RequestParams
        ...
        sig {
          params(capture_method: T.nilable(String), request_extended_authorization: T.nilable(T::Boolean), request_incremental_authorization_support: T.nilable(T::Boolean), routing: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::CardPresent::Routing)).void
         }
        def initialize(
          capture_method: nil,
          request_extended_authorization: nil,
      ...
      class Klarna < ::Stripe::RequestParams
        ...
        class SupplementaryPurchaseData < ::Stripe::RequestParams
          class BusReservationDetail < ::Stripe::RequestParams
            class Arrival < ::Stripe::RequestParams
              ...
              sig {
                returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Arrival::Address))
               }
              def address; end
              sig {
                params(_address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Arrival::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Arrival::Address))
               }
              def address=(_address); end
              ...
              sig {
                params(address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Arrival::Address), arrival_location: T.nilable(String)).void
               }
            ...
            class Departure < ::Stripe::RequestParams
              ...
              sig {
                returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Departure::Address))
               }
              def address; end
              sig {
                params(_address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Departure::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Departure::Address))
               }
              def address=(_address); end
              ...
              sig {
                params(address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Departure::Address), departs_at: T.nilable(Integer), departure_location: T.nilable(String)).void
               }
            ...
            # Arrival details.
            sig {
              returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Arrival))
             }
            def arrival; end
            sig {
              params(_arrival: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Arrival)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Arrival))
             }
            def arrival=(_arrival); end
            ...
            # Departure details.
            sig {
              returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Departure))
             }
            def departure; end
            sig {
              params(_departure: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Departure)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Departure))
             }
            def departure=(_departure); end
            # List of insurances for this reservation.
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Insurance]))
             }
            def insurances; end
            sig {
              params(_insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Insurance])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Insurance]))
             }
            def insurances=(_insurances); end
            # List of passengers that this reservation applies to.
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Passenger]))
             }
            def passengers; end
            sig {
              params(_passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Passenger])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Passenger]))
             }
            def passengers=(_passengers); end
            # Price in cents.
            sig { returns(T.nilable(Integer)) }
            ...
            sig {
              params(affiliate_name: T.nilable(String), arrival: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Arrival), carrier_name: T.nilable(String), currency: T.nilable(String), departure: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Departure), insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Insurance]), passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail::Passenger]), price: T.nilable(Integer), ticket_class: T.nilable(String)).void
             }
            def initialize(
              affiliate_name: nil,
              arrival: nil,
          ...
          class EventReservationDetail < ::Stripe::RequestParams
            ...
            sig {
              returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail::Address))
             }
            def address; end
            sig {
              params(_address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail::Address))
             }
            def address=(_address); end
            # Name of associated or partner company for the service.
            sig { returns(T.nilable(String)) }
            ...
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail::Insurance]))
             }
            def insurances; end
            sig {
              params(_insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail::Insurance])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail::Insurance]))
             }
            def insurances=(_insurances); end
            ...
            sig {
              params(access_controlled_venue: T.nilable(T::Boolean), address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail::Address), affiliate_name: T.nilable(String), ends_at: T.nilable(Integer), event_company_name: T.nilable(String), event_name: T.nilable(String), event_type: T.nilable(String), insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail::Insurance]), starts_at: T.nilable(Integer), venue_name: T.nilable(String)).void
             }
            def initialize(
              access_controlled_venue: nil,
              address: nil,
          ...
          class FerryReservationDetail < ::Stripe::RequestParams
            class Arrival < ::Stripe::RequestParams
              ...
              # Address of the arrival location.
              sig {
                returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Arrival::Address))
               }
              def address; end
              sig {
                params(_address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Arrival::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Arrival::Address))
               }
              def address=(_address); end
              # Identifier name or reference for the arrival location.
              sig { returns(T.nilable(String)) }
              ...
              def arrival_location=(_arrival_location); end
              sig {
                params(address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Arrival::Address), arrival_location: T.nilable(String)).void
               }
              def initialize(address: nil, arrival_location: nil); end
            end
            class Departure < ::Stripe::RequestParams
              ...
              # Address of the departure location.
              sig {
                returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Departure::Address))
               }
              def address; end
              sig {
                params(_address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Departure::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Departure::Address))
               }
              def address=(_address); end
              # Timestamp of departure.
              sig { returns(T.nilable(Integer)) }
              ...
              def departure_location=(_departure_location); end
              sig {
                params(address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Departure::Address), departs_at: T.nilable(Integer), departure_location: T.nilable(String)).void
               }
              def initialize(address: nil, departs_at: nil, departure_location: nil); end
            end
            class Insurance < ::Stripe::RequestParams
            ...
            # Arrival details.
            sig {
              returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Arrival))
             }
            def arrival; end
            sig {
              params(_arrival: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Arrival)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Arrival))
             }
            def arrival=(_arrival); end
            # Name of transportation company.
            sig { returns(T.nilable(String)) }
            ...
            # Departure details.
            sig {
              returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Departure))
             }
            def departure; end
            sig {
              params(_departure: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Departure)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Departure))
             }
            def departure=(_departure); end
            # List of insurances for this reservation.
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Insurance]))
             }
            def insurances; end
            sig {
              params(_insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Insurance])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Insurance]))
             }
            def insurances=(_insurances); end
            # List of passengers that this reservation applies to.
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Passenger]))
             }
            def passengers; end
            sig {
              params(_passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Passenger])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Passenger]))
             }
            def passengers=(_passengers); end
            # Price in cents.
            sig { returns(T.nilable(Integer)) }
            ...
            def ticket_class=(_ticket_class); end
            sig {
              params(affiliate_name: T.nilable(String), arrival: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Arrival), carrier_name: T.nilable(String), currency: T.nilable(String), departure: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Departure), insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Insurance]), passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail::Passenger]), price: T.nilable(Integer), ticket_class: T.nilable(String)).void
             }
            def initialize(
              affiliate_name: nil,
              arrival: nil,
          ...
          class MarketplaceSeller < ::Stripe::RequestParams
            ...
            sig {
              returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::MarketplaceSeller::MarketplaceSellerAddress))
             }
            def marketplace_seller_address; end
            sig {
              params(_marketplace_seller_address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::MarketplaceSeller::MarketplaceSellerAddress)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::MarketplaceSeller::MarketplaceSellerAddress))
             }
          ...
          class RoundTripReservationDetail < ::Stripe::RequestParams
            class Arrival < ::Stripe::RequestParams
              ...
              # Address of the arrival location.
              sig {
                returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Arrival::Address))
               }
              def address; end
              sig {
                params(_address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Arrival::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Arrival::Address))
               }
              def address=(_address); end
              # Identifier name or reference for the arrival location.
              sig { returns(T.nilable(String)) }
              ...
              def arrival_location=(_arrival_location); end
              sig {
                params(address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Arrival::Address), arrival_location: T.nilable(String)).void
               }
              def initialize(address: nil, arrival_location: nil); end
            end
            class Departure < ::Stripe::RequestParams
              ...
              # Address of the departure location.
              sig {
                returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Departure::Address))
               }
              def address; end
              sig {
                params(_address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Departure::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Departure::Address))
               }
              def address=(_address); end
              # Timestamp of departure.
              sig { returns(T.nilable(Integer)) }
              ...
              def departure_location=(_departure_location); end
              sig {
                params(address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Departure::Address), departs_at: T.nilable(Integer), departure_location: T.nilable(String)).void
               }
              def initialize(address: nil, departs_at: nil, departure_location: nil); end
            end
            class Insurance < ::Stripe::RequestParams
            ...
            # Arrival details.
            sig {
              returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Arrival))
             }
            def arrival; end
            sig {
              params(_arrival: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Arrival)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Arrival))
             }
            def arrival=(_arrival); end
            # Name of transportation company.
            sig { returns(T.nilable(String)) }
            ...
            # Departure details.
            sig {
              returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Departure))
             }
            def departure; end
            sig {
              params(_departure: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Departure)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Departure))
             }
            def departure=(_departure); end
            # List of insurances for this reservation.
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Insurance]))
             }
            def insurances; end
            sig {
              params(_insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Insurance])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Insurance]))
             }
            def insurances=(_insurances); end
            # List of passengers that this reservation applies to.
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Passenger]))
             }
            def passengers; end
            sig {
              params(_passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Passenger])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Passenger]))
             }
            def passengers=(_passengers); end
            # Price in cents.
            sig { returns(T.nilable(Integer)) }
            ...
            def ticket_class=(_ticket_class); end
            sig {
              params(affiliate_name: T.nilable(String), arrival: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Arrival), carrier_name: T.nilable(String), currency: T.nilable(String), departure: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Departure), insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Insurance]), passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail::Passenger]), price: T.nilable(Integer), ticket_class: T.nilable(String)).void
             }
            def initialize(
              affiliate_name: nil,
              arrival: nil,
          ...
          class TrainReservationDetail < ::Stripe::RequestParams
            class Arrival < ::Stripe::RequestParams
              ...
              # Address of the arrival location.
              sig {
                returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Arrival::Address))
               }
              def address; end
              sig {
                params(_address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Arrival::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Arrival::Address))
               }
              def address=(_address); end
              # Identifier name or reference for the arrival location.
              sig { returns(T.nilable(String)) }
              ...
              def arrival_location=(_arrival_location); end
              sig {
                params(address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Arrival::Address), arrival_location: T.nilable(String)).void
               }
              def initialize(address: nil, arrival_location: nil); end
            end
            class Departure < ::Stripe::RequestParams
              ...
              # Address of the departure location.
              sig {
                returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Departure::Address))
               }
              def address; end
              sig {
                params(_address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Departure::Address)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Departure::Address))
               }
              def address=(_address); end
              # Timestamp of departure.
              sig { returns(T.nilable(Integer)) }
              ...
              def departure_location=(_departure_location); end
              sig {
                params(address: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Departure::Address), departs_at: T.nilable(Integer), departure_location: T.nilable(String)).void
               }
              def initialize(address: nil, departs_at: nil, departure_location: nil); end
            end
            class Insurance < ::Stripe::RequestParams
            ...
            # Arrival details.
            sig {
              returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Arrival))
             }
            def arrival; end
            sig {
              params(_arrival: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Arrival)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Arrival))
             }
            def arrival=(_arrival); end
            # Name of transportation company.
            sig { returns(T.nilable(String)) }
            ...
            # Departure details.
            sig {
              returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Departure))
             }
            def departure; end
            sig {
              params(_departure: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Departure)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Departure))
             }
            def departure=(_departure); end
            # List of insurances for this reservation.
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Insurance]))
             }
            def insurances; end
            sig {
              params(_insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Insurance])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Insurance]))
             }
            def insurances=(_insurances); end
            # List of passengers that this reservation applies to.
            sig {
              returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Passenger]))
             }
            def passengers; end
            sig {
              params(_passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Passenger])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Passenger]))
             }
            def passengers=(_passengers); end
            # Price in cents.
            sig { returns(T.nilable(Integer)) }
            ...
            def ticket_class=(_ticket_class); end
            sig {
              params(affiliate_name: T.nilable(String), arrival: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Arrival), carrier_name: T.nilable(String), currency: T.nilable(String), departure: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Departure), insurances: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Insurance]), passengers: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail::Passenger]), price: T.nilable(Integer), ticket_class: T.nilable(String)).void
             }
            def initialize(
              affiliate_name: nil,
              arrival: nil,
          ...
          sig {
            returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail])))
           }
          def bus_reservation_details; end
          sig {
            params(_bus_reservation_details: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail]))).returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail])))
           }
          def bus_reservation_details=(_bus_reservation_details); end
          # Supplementary event reservation details.
          sig {
            returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail])))
           }
          def event_reservation_details; end
          sig {
            params(_event_reservation_details: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail]))).returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail])))
           }
          def event_reservation_details=(_event_reservation_details); end
          # Supplementary ferry reservation details.
          sig {
            returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail])))
           }
          def ferry_reservation_details; end
          sig {
            params(_ferry_reservation_details: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail]))).returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail])))
           }
          def ferry_reservation_details=(_ferry_reservation_details); end
          # Supplementary insurance details.
          sig {
            returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::Insurance])))
           }
          def insurances; end
          sig {
            params(_insurances: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::Insurance]))).returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::Insurance])))
           }
          def insurances=(_insurances); end
          # Supplementary marketplace seller details.
          sig {
            returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::MarketplaceSeller])))
           }
          def marketplace_sellers; end
          sig {
            params(_marketplace_sellers: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::MarketplaceSeller]))).returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::MarketplaceSeller])))
           }
          def marketplace_sellers=(_marketplace_sellers); end
          # Supplementary round trip reservation details.
          sig {
            returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail])))
           }
          def round_trip_reservation_details; end
          sig {
            params(_round_trip_reservation_details: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail]))).returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail])))
           }
          def round_trip_reservation_details=(_round_trip_reservation_details); end
          # Supplementary train reservation details.
          sig {
            returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail])))
           }
          def train_reservation_details; end
          sig {
            params(_train_reservation_details: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail]))).returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail])))
           }
          def train_reservation_details=(_train_reservation_details); end
          # Voucher details, such as a gift card or discount code.
          sig {
            returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::Voucher])))
           }
          def vouchers; end
          sig {
            params(_vouchers: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::Voucher]))).returns(T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::Voucher])))
           }
          def vouchers=(_vouchers); end
          sig {
            params(bus_reservation_details: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::BusReservationDetail])), event_reservation_details: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::EventReservationDetail])), ferry_reservation_details: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::FerryReservationDetail])), insurances: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::Insurance])), marketplace_sellers: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::MarketplaceSeller])), round_trip_reservation_details: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::RoundTripReservationDetail])), train_reservation_details: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::TrainReservationDetail])), vouchers: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData::Voucher]))).void
           }
          def initialize(
        ...
        sig {
          returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData)))
         }
        def supplementary_purchase_data; end
        sig {
          params(_supplementary_purchase_data: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData))).returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData)))
         }
        def supplementary_purchase_data=(_supplementary_purchase_data); end
        sig {
          params(capture_method: T.nilable(String), on_demand: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Klarna::OnDemand), preferred_locale: T.nilable(String), setup_future_usage: T.nilable(String), subscriptions: T.nilable(T.any(String, T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Klarna::Subscription])), supplementary_purchase_data: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Klarna::SupplementaryPurchaseData))).void
         }
        def initialize(
          capture_method: nil,
          on_demand: nil,
      ...
      class Paypal < ::Stripe::RequestParams
        class LineItem < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Paypal::LineItem::Tax))
           }
          def tax; end
          sig {
            params(_tax: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Paypal::LineItem::Tax)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Paypal::LineItem::Tax))
           }
          def tax=(_tax); end
          ...
          sig {
            params(category: T.nilable(String), description: T.nilable(String), name: String, quantity: Integer, sku: T.nilable(String), sold_by: T.nilable(String), tax: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Paypal::LineItem::Tax), unit_amount: Integer).void
           }
          def initialize(
            category: nil,
            description: nil,
        ...
        sig {
          returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Paypal::LineItem]))
         }
        def line_items; end
        sig {
          params(_line_items: T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Paypal::LineItem])).returns(T.nilable(T::Array[PaymentIntentCreateParams::PaymentMethodOptions::Paypal::LineItem]))
         }
        def line_items=(_line_items); end
      ...
      class Payto < ::Stripe::RequestParams
        ...
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Payto::MandateOptions))
         }
        def mandate_options; end
        sig {
          params(_mandate_options: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Payto::MandateOptions)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Payto::MandateOptions))
         }
        def mandate_options=(_mandate_options); end
        # Indicates that you intend to make future payments with this PaymentIntent's payment method.
        #
        ...
        def setup_future_usage=(_setup_future_usage); end
        sig {
          params(mandate_options: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Payto::MandateOptions), setup_future_usage: T.nilable(T.any(String, String))).void
         }
      ...
      class Pix < ::Stripe::RequestParams
        ...
        sig {
          returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Pix::MandateOptions))
         }
        def mandate_options; end
        sig {
          params(_mandate_options: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Pix::MandateOptions)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Pix::MandateOptions))
         }
        def mandate_options=(_mandate_options); end
        # Indicates that you intend to make future payments with this PaymentIntent's payment method.
        #
        ...
        def setup_future_usage=(_setup_future_usage); end
        sig {
          params(amount_includes_iof: T.nilable(String), expires_after_seconds: T.nilable(Integer), expires_at: T.nilable(Integer), mandate_options: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::Pix::MandateOptions), setup_future_usage: T.nilable(String)).void
         }
        def initialize(
          amount_includes_iof: nil,
      ...
      class UsBankAccount < ::Stripe::RequestParams
        class FinancialConnections < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::UsBankAccount::FinancialConnections::ManualEntry))
           }
          def manual_entry; end
          sig {
            params(_manual_entry: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::UsBankAccount::FinancialConnections::ManualEntry)).returns(T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::UsBankAccount::FinancialConnections::ManualEntry))
           }
          ...
          sig {
            params(filters: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::UsBankAccount::FinancialConnections::Filters), manual_entry: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::UsBankAccount::FinancialConnections::ManualEntry), permissions: T.nilable(T::Array[String]), prefetch: T.nilable(T::Array[String]), return_url: T.nilable(String)).void
           }
          def initialize(
            filters: nil,
            manual_entry: nil,
        ...
        sig {
          params(financial_connections: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::UsBankAccount::FinancialConnections), mandate_options: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::UsBankAccount::MandateOptions), networks: T.nilable(PaymentIntentCreateParams::PaymentMethodOptions::UsBankAccount::Networks), setup_future_usage: T.nilable(T.any(String, String)), target_date: T.nilable(String), verification_method: T.nilable(String), preferred_settlement_speed: T.nilable(String)).void
         }
        def initialize(
      ...
      sig {
        returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Gopay)))
       }
      def gopay; end
      sig {
        params(_gopay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Gopay))).returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Gopay)))
       }
      def gopay=(_gopay); end
      ...
      sig {
        returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::IdBankTransfer)))
       }
      def id_bank_transfer; end
      sig {
        params(_id_bank_transfer: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::IdBankTransfer))).returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::IdBankTransfer)))
       }
      def id_bank_transfer=(_id_bank_transfer); end
      ...
      sig {
        returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Paypay)))
       }
      def paypay; end
      sig {
        params(_paypay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Paypay))).returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Paypay)))
       }
      def paypay=(_paypay); end
      # If this is a `payto` PaymentMethod, this sub-hash contains details about the PayTo payment method options.
      sig {
        returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Payto)))
       }
      def payto; end
      sig {
        params(_payto: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Payto))).returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Payto)))
       }
      def payto=(_payto); end
      ...
      sig {
        returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Qris)))
       }
      def qris; end
      sig {
        params(_qris: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Qris))).returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Qris)))
       }
      def qris=(_qris); end
      # If this is a `rechnung` PaymentMethod, this sub-hash contains details about the Rechnung payment method options.
      sig {
        returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Rechnung)))
       }
      def rechnung; end
      sig {
        params(_rechnung: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Rechnung))).returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Rechnung)))
       }
      def rechnung=(_rechnung); end
      ...
      sig {
        returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Shopeepay)))
       }
      def shopeepay; end
      sig {
        params(_shopeepay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Shopeepay))).returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Shopeepay)))
       }
      def shopeepay=(_shopeepay); end
      ...
      sig {
        returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::StripeBalance)))
       }
      def stripe_balance; end
      sig {
        params(_stripe_balance: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::StripeBalance))).returns(T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::StripeBalance)))
       }
      def stripe_balance=(_stripe_balance); end
      ...
      def zip=(_zip); end
      sig {
        params(acss_debit: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::AcssDebit)), affirm: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Affirm)), afterpay_clearpay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::AfterpayClearpay)), alipay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Alipay)), alma: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Alma)), amazon_pay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::AmazonPay)), au_becs_debit: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::AuBecsDebit)), bacs_debit: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::BacsDebit)), bancontact: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Bancontact)), billie: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Billie)), blik: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Blik)), boleto: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Boleto)), card: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Card)), card_present: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::CardPresent)), cashapp: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Cashapp)), crypto: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Crypto)), customer_balance: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::CustomerBalance)), eps: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Eps)), fpx: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Fpx)), giropay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Giropay)), gopay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Gopay)), grabpay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Grabpay)), id_bank_transfer: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::IdBankTransfer)), ideal: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Ideal)), interac_present: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::InteracPresent)), kakao_pay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::KakaoPay)), klarna: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Klarna)), konbini: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Konbini)), kr_card: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::KrCard)), link: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Link)), mb_way: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::MbWay)), mobilepay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Mobilepay)), multibanco: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Multibanco)), naver_pay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::NaverPay)), nz_bank_account: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::NzBankAccount)), oxxo: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Oxxo)), p24: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::P24)), pay_by_bank: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::PayByBank)), payco: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Payco)), paynow: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Paynow)), paypal: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Paypal)), paypay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Paypay)), payto: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Payto)), pix: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Pix)), promptpay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Promptpay)), qris: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Qris)), rechnung: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Rechnung)), revolut_pay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::RevolutPay)), samsung_pay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::SamsungPay)), satispay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Satispay)), sepa_debit: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::SepaDebit)), shopeepay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Shopeepay)), sofort: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Sofort)), stripe_balance: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::StripeBalance)), swish: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Swish)), twint: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Twint)), us_bank_account: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::UsBankAccount)), wechat_pay: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::WechatPay)), zip: T.nilable(T.any(String, PaymentIntentCreateParams::PaymentMethodOptions::Zip))).void
       }
      def initialize(
        acss_debit: nil,
        affirm: nil,
    ...
    sig { returns(T.nilable(PaymentIntentCreateParams::Hooks)) }
    def hooks; end
    sig {
      params(_hooks: T.nilable(PaymentIntentCreateParams::Hooks)).returns(T.nilable(PaymentIntentCreateParams::Hooks))
     }
