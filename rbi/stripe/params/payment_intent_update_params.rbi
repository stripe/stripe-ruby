  ...
  class PaymentIntentUpdateParams < ::Stripe::RequestParams
    ...
    class PaymentDetails < ::Stripe::RequestParams
      ...
      class MoneyServices < ::Stripe::RequestParams
        ...
        def transaction_type=(_transaction_type); end
        sig {
          params(account_funding: T.nilable(T.any(String, ::Stripe::PaymentIntentUpdateParams::PaymentDetails::MoneyServices::AccountFunding)), transaction_type: T.nilable(T.any(String, String))).void
         }
