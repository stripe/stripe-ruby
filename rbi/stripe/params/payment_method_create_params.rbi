...
module Stripe
  class PaymentMethodCreateParams < Stripe::RequestParams
    ...
    class Rechnung < Stripe::RequestParams
      ...
      # Customer's date of birth
      sig { returns(PaymentMethodCreateParams::Rechnung::Dob) }
      def dob; end
      sig {
        params(_dob: PaymentMethodCreateParams::Rechnung::Dob).returns(PaymentMethodCreateParams::Rechnung::Dob)
       }
      def dob=(_dob); end
      sig { params(dob: PaymentMethodCreateParams::Rechnung::Dob).void }
      def initialize(dob: nil); end
    end
    ...
    sig { returns(T.nilable(PaymentMethodCreateParams::Gopay)) }
    def gopay; end
    sig {
      params(_gopay: T.nilable(PaymentMethodCreateParams::Gopay)).returns(T.nilable(PaymentMethodCreateParams::Gopay))
     }
    ...
    sig { returns(T.nilable(PaymentMethodCreateParams::IdBankTransfer)) }
    def id_bank_transfer; end
    sig {
      params(_id_bank_transfer: T.nilable(PaymentMethodCreateParams::IdBankTransfer)).returns(T.nilable(PaymentMethodCreateParams::IdBankTransfer))
     }
    ...
    sig { returns(T.nilable(PaymentMethodCreateParams::Paypay)) }
    def paypay; end
    sig {
      params(_paypay: T.nilable(PaymentMethodCreateParams::Paypay)).returns(T.nilable(PaymentMethodCreateParams::Paypay))
     }
    ...
    sig { returns(T.nilable(PaymentMethodCreateParams::Qris)) }
    def qris; end
    sig {
    ...
    sig { returns(T.nilable(PaymentMethodCreateParams::Rechnung)) }
    def rechnung; end
    sig {
      params(_rechnung: T.nilable(PaymentMethodCreateParams::Rechnung)).returns(T.nilable(PaymentMethodCreateParams::Rechnung))
     }
    ...
    sig { returns(T.nilable(PaymentMethodCreateParams::Shopeepay)) }
    def shopeepay; end
    sig {
      params(_shopeepay: T.nilable(PaymentMethodCreateParams::Shopeepay)).returns(T.nilable(PaymentMethodCreateParams::Shopeepay))
     }
    ...
    sig { returns(T.nilable(PaymentMethodCreateParams::StripeBalance)) }
    def stripe_balance; end
    sig {
      params(_stripe_balance: T.nilable(PaymentMethodCreateParams::StripeBalance)).returns(T.nilable(PaymentMethodCreateParams::StripeBalance))
     }
