...
module Stripe
  class PaymentRecordReportPaymentParams < ::Stripe::RequestParams
    ...
    class Failed < ::Stripe::RequestParams
      ...
      sig {
        params(failed_at: Integer, failure_code: T.nilable(String), processor_details: T.nilable(::Stripe::PaymentRecordReportPaymentParams::Failed::ProcessorDetails)).void
       }
