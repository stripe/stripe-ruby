  ...
  class QuoteCreateParams < ::Stripe::RequestParams
    ...
    class Discount < ::Stripe::RequestParams
      class DiscountEnd < ::Stripe::RequestParams
        ...
        sig { returns(T.nilable(QuoteCreateParams::Discount::DiscountEnd::Duration)) }
        def duration; end
        sig {
          params(_duration: T.nilable(QuoteCreateParams::Discount::DiscountEnd::Duration)).returns(T.nilable(QuoteCreateParams::Discount::DiscountEnd::Duration))
         }
        ...
        def type=(_type); end
        sig {
          params(duration: T.nilable(QuoteCreateParams::Discount::DiscountEnd::Duration), timestamp: T.nilable(Integer), type: String).void
         }
      ...
      sig { returns(T.nilable(QuoteCreateParams::Discount::DiscountEnd)) }
      def discount_end; end
      sig {
        params(_discount_end: T.nilable(QuoteCreateParams::Discount::DiscountEnd)).returns(T.nilable(QuoteCreateParams::Discount::DiscountEnd))
       }
      ...
      sig {
        params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(QuoteCreateParams::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
       }
    ...
    class Line < ::Stripe::RequestParams
      class Action < ::Stripe::RequestParams
        class AddDiscount < ::Stripe::RequestParams
          ...
          class Settings < ::Stripe::RequestParams
            class ServicePeriodAnchorConfig < ::Stripe::RequestParams
              ...
              sig {
                returns(T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings::ServicePeriodAnchorConfig::Custom))
               }
              def custom; end
              sig {
                params(_custom: T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings::ServicePeriodAnchorConfig::Custom)).returns(T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings::ServicePeriodAnchorConfig::Custom))
               }
              ...
              def type=(_type); end
              sig {
                params(custom: T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings::ServicePeriodAnchorConfig::Custom), type: T.nilable(String)).void
               }
              def initialize(custom: nil, type: nil); end
            end
            # Configures service period cycle anchoring.
            sig {
              returns(T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings::ServicePeriodAnchorConfig))
             }
            def service_period_anchor_config; end
            sig {
              params(_service_period_anchor_config: T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings::ServicePeriodAnchorConfig)).returns(T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings::ServicePeriodAnchorConfig))
             }
            ...
            sig {
              params(service_period_anchor_config: T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings::ServicePeriodAnchorConfig), start_date: T.nilable(String)).void
             }
          ...
          def discount=(_discount); end
          # Details to determine how long the discount should be applied for.
          sig { returns(T.nilable(QuoteCreateParams::Line::Action::AddDiscount::DiscountEnd)) }
          def discount_end; end
          sig {
            params(_discount_end: T.nilable(QuoteCreateParams::Line::Action::AddDiscount::DiscountEnd)).returns(T.nilable(QuoteCreateParams::Line::Action::AddDiscount::DiscountEnd))
           }
          def discount_end=(_discount_end); end
          ...
          sig { returns(T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings)) }
          def settings; end
          sig {
            params(_settings: T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings)).returns(T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings))
           }
          def settings=(_settings); end
          sig {
            params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(QuoteCreateParams::Line::Action::AddDiscount::DiscountEnd), index: T.nilable(Integer), promotion_code: T.nilable(String), settings: T.nilable(QuoteCreateParams::Line::Action::AddDiscount::Settings)).void
           }
          def initialize(
            coupon: nil,
            discount: nil,
        ...
        class AddItem < ::Stripe::RequestParams
          class Discount < ::Stripe::RequestParams
            class DiscountEnd < ::Stripe::RequestParams
              ...
              # Time span for the redeemed discount.
              sig {
                returns(T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::DiscountEnd::Duration))
               }
              def duration; end
              sig {
                params(_duration: T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::DiscountEnd::Duration)).returns(T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::DiscountEnd::Duration))
               }
              def duration=(_duration); end
              # A precise Unix timestamp for the discount to end. Must be in the future.
              sig { returns(T.nilable(Integer)) }
              ...
              def type=(_type); end
              sig {
                params(duration: T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::DiscountEnd::Duration), timestamp: T.nilable(Integer), type: String).void
               }
              def initialize(duration: nil, timestamp: nil, type: nil); end
            end
            class Settings < ::Stripe::RequestParams
              class ServicePeriodAnchorConfig < ::Stripe::RequestParams
                ...
                # Anchor the service period to a custom date. Type must be `custom` to specify.
                sig {
                  returns(T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings::ServicePeriodAnchorConfig::Custom))
                 }
                def custom; end
                sig {
                  params(_custom: T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings::ServicePeriodAnchorConfig::Custom)).returns(T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings::ServicePeriodAnchorConfig::Custom))
                 }
                def custom=(_custom); end
                # The type of service period anchor config. Defaults to `inherit` if omitted.
                sig { returns(T.nilable(String)) }
                ...
                def type=(_type); end
                sig {
                  params(custom: T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings::ServicePeriodAnchorConfig::Custom), type: T.nilable(String)).void
                 }
                def initialize(custom: nil, type: nil); end
              end
              # Configures service period cycle anchoring.
              sig {
                returns(T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings::ServicePeriodAnchorConfig))
               }
              def service_period_anchor_config; end
              sig {
                params(_service_period_anchor_config: T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings::ServicePeriodAnchorConfig)).returns(T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings::ServicePeriodAnchorConfig))
               }
              def service_period_anchor_config=(_service_period_anchor_config); end
              # The start date of the discount's service period when applying a coupon or promotion code with a service period duration. Defaults to `line_start` if omitted.
              sig { returns(T.nilable(String)) }
              ...
              def start_date=(_start_date); end
              sig {
                params(service_period_anchor_config: T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings::ServicePeriodAnchorConfig), start_date: T.nilable(String)).void
               }
              def initialize(service_period_anchor_config: nil, start_date: nil); end
            end
            # ID of the coupon to create a new discount for.
            ...
            # Details to determine how long the discount should be applied for.
            sig {
              returns(T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::DiscountEnd))
             }
            def discount_end; end
            sig {
              params(_discount_end: T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::DiscountEnd)).returns(T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::DiscountEnd))
             }
            def discount_end=(_discount_end); end
            # ID of the promotion code to create a new discount for.
            sig { returns(T.nilable(String)) }
            ...
            def promotion_code=(_promotion_code); end
            # Settings for discount application including service period anchoring.
            sig { returns(T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings)) }
            def settings; end
            sig {
              params(_settings: T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings)).returns(T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings))
             }
            def settings=(_settings); end
            sig {
              params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::DiscountEnd), promotion_code: T.nilable(String), settings: T.nilable(QuoteCreateParams::Line::Action::AddItem::Discount::Settings)).void
             }
            def initialize(
              coupon: nil,
              discount: nil,
          ...
          sig { returns(T.nilable(T::Array[QuoteCreateParams::Line::Action::AddItem::Discount])) }
          def discounts; end
          sig {
            params(_discounts: T.nilable(T::Array[QuoteCreateParams::Line::Action::AddItem::Discount])).returns(T.nilable(T::Array[QuoteCreateParams::Line::Action::AddItem::Discount]))
           }
          ...
          sig { returns(T.nilable(QuoteCreateParams::Line::Action::AddItem::Trial)) }
          def trial; end
          sig {
        ...
        class SetDiscount < ::Stripe::RequestParams
          class Settings < ::Stripe::RequestParams
            class ServicePeriodAnchorConfig < ::Stripe::RequestParams
              ...
              # Anchor the service period to a custom date. Type must be `custom` to specify.
              sig {
                returns(T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings::ServicePeriodAnchorConfig::Custom))
               }
              def custom; end
              sig {
                params(_custom: T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings::ServicePeriodAnchorConfig::Custom)).returns(T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings::ServicePeriodAnchorConfig::Custom))
               }
              def custom=(_custom); end
              # The type of service period anchor config. Defaults to `inherit` if omitted.
              sig { returns(T.nilable(String)) }
              ...
              def type=(_type); end
              sig {
                params(custom: T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings::ServicePeriodAnchorConfig::Custom), type: T.nilable(String)).void
               }
              def initialize(custom: nil, type: nil); end
            end
            # Configures service period cycle anchoring.
            sig {
              returns(T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings::ServicePeriodAnchorConfig))
             }
            def service_period_anchor_config; end
            sig {
              params(_service_period_anchor_config: T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings::ServicePeriodAnchorConfig)).returns(T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings::ServicePeriodAnchorConfig))
             }
            def service_period_anchor_config=(_service_period_anchor_config); end
            # The start date of the discount's service period when applying a coupon or promotion code with a service period duration. Defaults to `line_start` if omitted.
            sig { returns(T.nilable(String)) }
            ...
            def start_date=(_start_date); end
            sig {
              params(service_period_anchor_config: T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings::ServicePeriodAnchorConfig), start_date: T.nilable(String)).void
             }
            def initialize(service_period_anchor_config: nil, start_date: nil); end
          end
          ...
          def promotion_code=(_promotion_code); end
          # Settings for discount application including service period anchoring.
          sig { returns(T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings)) }
          def settings; end
          sig {
            params(_settings: T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings)).returns(T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings))
           }
          def settings=(_settings); end
          sig {
            params(coupon: T.nilable(String), discount: T.nilable(String), promotion_code: T.nilable(String), settings: T.nilable(QuoteCreateParams::Line::Action::SetDiscount::Settings)).void
           }
        ...
        class SetItem < ::Stripe::RequestParams
          class Discount < ::Stripe::RequestParams
            class DiscountEnd < ::Stripe::RequestParams
              ...
              # Time span for the redeemed discount.
              sig {
                returns(T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::DiscountEnd::Duration))
               }
              def duration; end
              sig {
                params(_duration: T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::DiscountEnd::Duration)).returns(T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::DiscountEnd::Duration))
               }
              def duration=(_duration); end
              # A precise Unix timestamp for the discount to end. Must be in the future.
              sig { returns(T.nilable(Integer)) }
              ...
              def type=(_type); end
              sig {
                params(duration: T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::DiscountEnd::Duration), timestamp: T.nilable(Integer), type: String).void
               }
              def initialize(duration: nil, timestamp: nil, type: nil); end
            end
            class Settings < ::Stripe::RequestParams
              class ServicePeriodAnchorConfig < ::Stripe::RequestParams
                ...
                # Anchor the service period to a custom date. Type must be `custom` to specify.
                sig {
                  returns(T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings::ServicePeriodAnchorConfig::Custom))
                 }
                def custom; end
                sig {
                  params(_custom: T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings::ServicePeriodAnchorConfig::Custom)).returns(T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings::ServicePeriodAnchorConfig::Custom))
                 }
                def custom=(_custom); end
                # The type of service period anchor config. Defaults to `inherit` if omitted.
                sig { returns(T.nilable(String)) }
                ...
                def type=(_type); end
                sig {
                  params(custom: T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings::ServicePeriodAnchorConfig::Custom), type: T.nilable(String)).void
                 }
                def initialize(custom: nil, type: nil); end
              end
              # Configures service period cycle anchoring.
              sig {
                returns(T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings::ServicePeriodAnchorConfig))
               }
              def service_period_anchor_config; end
              sig {
                params(_service_period_anchor_config: T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings::ServicePeriodAnchorConfig)).returns(T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings::ServicePeriodAnchorConfig))
               }
              def service_period_anchor_config=(_service_period_anchor_config); end
              # The start date of the discount's service period when applying a coupon or promotion code with a service period duration. Defaults to `line_start` if omitted.
              sig { returns(T.nilable(String)) }
              ...
              def start_date=(_start_date); end
              sig {
                params(service_period_anchor_config: T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings::ServicePeriodAnchorConfig), start_date: T.nilable(String)).void
               }
              def initialize(service_period_anchor_config: nil, start_date: nil); end
            end
            # ID of the coupon to create a new discount for.
            ...
            # Details to determine how long the discount should be applied for.
            sig {
              returns(T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::DiscountEnd))
             }
            def discount_end; end
            sig {
              params(_discount_end: T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::DiscountEnd)).returns(T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::DiscountEnd))
             }
            def discount_end=(_discount_end); end
            # ID of the promotion code to create a new discount for.
            sig { returns(T.nilable(String)) }
            ...
            def promotion_code=(_promotion_code); end
            # Settings for discount application including service period anchoring.
            sig { returns(T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings)) }
            def settings; end
            sig {
              params(_settings: T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings)).returns(T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings))
             }
            def settings=(_settings); end
            sig {
              params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::DiscountEnd), promotion_code: T.nilable(String), settings: T.nilable(QuoteCreateParams::Line::Action::SetItem::Discount::Settings)).void
             }
            def initialize(
              coupon: nil,
              discount: nil,
          ...
          sig { returns(T.nilable(T::Array[QuoteCreateParams::Line::Action::SetItem::Discount])) }
          def discounts; end
          sig {
            params(_discounts: T.nilable(T::Array[QuoteCreateParams::Line::Action::SetItem::Discount])).returns(T.nilable(T::Array[QuoteCreateParams::Line::Action::SetItem::Discount]))
           }
          def discounts=(_discounts); end
          ...
          sig { returns(T.nilable(QuoteCreateParams::Line::Action::SetItem::Trial)) }
          def trial; end
          sig {
        ...
        sig { returns(T.nilable(QuoteCreateParams::Line::Action::AddDiscount)) }
        def add_discount; end
        sig {
          params(_add_discount: T.nilable(QuoteCreateParams::Line::Action::AddDiscount)).returns(T.nilable(QuoteCreateParams::Line::Action::AddDiscount))
         }
        def add_discount=(_add_discount); end
        # Details for the `add_item` type.
        sig { returns(T.nilable(QuoteCreateParams::Line::Action::AddItem)) }
        def add_item; end
        sig {
          params(_add_item: T.nilable(QuoteCreateParams::Line::Action::AddItem)).returns(T.nilable(QuoteCreateParams::Line::Action::AddItem))
         }
        ...
        sig { returns(T.nilable(QuoteCreateParams::Line::Action::RemoveDiscount)) }
        def remove_discount; end
        sig {
          params(_remove_discount: T.nilable(QuoteCreateParams::Line::Action::RemoveDiscount)).returns(T.nilable(QuoteCreateParams::Line::Action::RemoveDiscount))
         }
        def remove_discount=(_remove_discount); end
        # Details for the `remove_item` type.
        sig { returns(T.nilable(QuoteCreateParams::Line::Action::RemoveItem)) }
        def remove_item; end
        sig {
          params(_remove_item: T.nilable(QuoteCreateParams::Line::Action::RemoveItem)).returns(T.nilable(QuoteCreateParams::Line::Action::RemoveItem))
         }
        ...
        sig { returns(T.nilable(T::Array[QuoteCreateParams::Line::Action::SetDiscount])) }
        def set_discounts; end
        sig {
          params(_set_discounts: T.nilable(T::Array[QuoteCreateParams::Line::Action::SetDiscount])).returns(T.nilable(T::Array[QuoteCreateParams::Line::Action::SetDiscount]))
         }
        def set_discounts=(_set_discounts); end
        # Details for the `set_items` type.
        sig { returns(T.nilable(T::Array[QuoteCreateParams::Line::Action::SetItem])) }
        def set_items; end
        sig {
          params(_set_items: T.nilable(T::Array[QuoteCreateParams::Line::Action::SetItem])).returns(T.nilable(T::Array[QuoteCreateParams::Line::Action::SetItem]))
         }
        ...
        def type=(_type); end
        sig {
          params(add_discount: T.nilable(QuoteCreateParams::Line::Action::AddDiscount), add_item: T.nilable(QuoteCreateParams::Line::Action::AddItem), add_metadata: T.nilable(T::Hash[String, String]), remove_discount: T.nilable(QuoteCreateParams::Line::Action::RemoveDiscount), remove_item: T.nilable(QuoteCreateParams::Line::Action::RemoveItem), remove_metadata: T.nilable(T::Array[String]), set_discounts: T.nilable(T::Array[QuoteCreateParams::Line::Action::SetDiscount]), set_items: T.nilable(T::Array[QuoteCreateParams::Line::Action::SetItem]), set_metadata: T.nilable(T.any(String, T::Hash[String, String])), type: String).void
         }
        def initialize(
          add_discount: nil,
          add_item: nil,
      ...
      class EndsAt < ::Stripe::RequestParams
        ...
        sig { returns(T.nilable(QuoteCreateParams::Line::EndsAt::DiscountEnd)) }
        def discount_end; end
        sig {
          params(_discount_end: T.nilable(QuoteCreateParams::Line::EndsAt::DiscountEnd)).returns(T.nilable(QuoteCreateParams::Line::EndsAt::DiscountEnd))
         }
        def discount_end=(_discount_end); end
        # Time span for the quote line starting from the `starts_at` date.
        sig { returns(T.nilable(QuoteCreateParams::Line::EndsAt::Duration)) }
        def duration; end
        sig {
          params(_duration: T.nilable(QuoteCreateParams::Line::EndsAt::Duration)).returns(T.nilable(QuoteCreateParams::Line::EndsAt::Duration))
         }
        def duration=(_duration); end
        ...
        def type=(_type); end
        sig {
          params(discount_end: T.nilable(QuoteCreateParams::Line::EndsAt::DiscountEnd), duration: T.nilable(QuoteCreateParams::Line::EndsAt::Duration), timestamp: T.nilable(Integer), type: String).void
         }
      ...
      class SetPauseCollection < ::Stripe::RequestParams
        ...
        sig { returns(T.nilable(QuoteCreateParams::Line::SetPauseCollection::Set)) }
        def set; end
        sig {
          params(_set: T.nilable(QuoteCreateParams::Line::SetPauseCollection::Set)).returns(T.nilable(QuoteCreateParams::Line::SetPauseCollection::Set))
         }
        def set=(_set); end
        ...
        def type=(_type); end
        sig {
          params(set: T.nilable(QuoteCreateParams::Line::SetPauseCollection::Set), type: String).void
         }
      ...
      class StartsAt < ::Stripe::RequestParams
        ...
        # Use the `end` time of a given discount.
        sig { returns(T.nilable(QuoteCreateParams::Line::StartsAt::DiscountEnd)) }
        def discount_end; end
        sig {
          params(_discount_end: T.nilable(QuoteCreateParams::Line::StartsAt::DiscountEnd)).returns(T.nilable(QuoteCreateParams::Line::StartsAt::DiscountEnd))
         }
        def discount_end=(_discount_end); end
        # The timestamp the given line ends at.
        sig { returns(T.nilable(QuoteCreateParams::Line::StartsAt::LineEndsAt)) }
        def line_ends_at; end
        sig {
          params(_line_ends_at: T.nilable(QuoteCreateParams::Line::StartsAt::LineEndsAt)).returns(T.nilable(QuoteCreateParams::Line::StartsAt::LineEndsAt))
         }
        ...
        def type=(_type); end
        sig {
          params(discount_end: T.nilable(QuoteCreateParams::Line::StartsAt::DiscountEnd), line_ends_at: T.nilable(QuoteCreateParams::Line::StartsAt::LineEndsAt), timestamp: T.nilable(Integer), type: String).void
         }
      ...
      class TrialSettings < ::Stripe::RequestParams
        ...
        sig { returns(T.nilable(QuoteCreateParams::Line::TrialSettings::EndBehavior)) }
        def end_behavior; end
        sig {
          params(_end_behavior: T.nilable(QuoteCreateParams::Line::TrialSettings::EndBehavior)).returns(T.nilable(QuoteCreateParams::Line::TrialSettings::EndBehavior))
         }
        def end_behavior=(_end_behavior); end
        sig {
          params(end_behavior: T.nilable(QuoteCreateParams::Line::TrialSettings::EndBehavior)).void
         }
        def initialize(end_behavior: nil); end
      end
      # An array of operations the quote line performs.
      sig { returns(T.nilable(T::Array[QuoteCreateParams::Line::Action])) }
      def actions; end
      sig {
        params(_actions: T.nilable(T::Array[QuoteCreateParams::Line::Action])).returns(T.nilable(T::Array[QuoteCreateParams::Line::Action]))
       }
      def actions=(_actions); end
      # Details to identify the subscription schedule the quote line applies to.
      sig { returns(T.nilable(QuoteCreateParams::Line::AppliesTo)) }
      def applies_to; end
      sig {
        params(_applies_to: T.nilable(QuoteCreateParams::Line::AppliesTo)).returns(T.nilable(QuoteCreateParams::Line::AppliesTo))
       }
      ...
      sig { returns(T.nilable(QuoteCreateParams::Line::CancelSubscriptionSchedule)) }
      ...
      sig { returns(T.nilable(QuoteCreateParams::Line::EndsAt)) }
      def ends_at; end
      sig {
        params(_ends_at: T.nilable(QuoteCreateParams::Line::EndsAt)).returns(T.nilable(QuoteCreateParams::Line::EndsAt))
       }
      ...
      sig { returns(T.nilable(QuoteCreateParams::Line::SetPauseCollection)) }
      def set_pause_collection; end
      sig {
        params(_set_pause_collection: T.nilable(QuoteCreateParams::Line::SetPauseCollection)).returns(T.nilable(QuoteCreateParams::Line::SetPauseCollection))
       }
      ...
      sig { returns(T.nilable(QuoteCreateParams::Line::StartsAt)) }
      def starts_at; end
      sig {
        params(_starts_at: T.nilable(QuoteCreateParams::Line::StartsAt)).returns(T.nilable(QuoteCreateParams::Line::StartsAt))
       }
      def starts_at=(_starts_at); end
      # Settings related to subscription trials.
      sig { returns(T.nilable(QuoteCreateParams::Line::TrialSettings)) }
      ...
      sig {
        params(actions: T.nilable(T::Array[QuoteCreateParams::Line::Action]), applies_to: T.nilable(QuoteCreateParams::Line::AppliesTo), billing_cycle_anchor: T.nilable(String), cancel_subscription_schedule: T.nilable(QuoteCreateParams::Line::CancelSubscriptionSchedule), effective_at: T.nilable(String), ends_at: T.nilable(QuoteCreateParams::Line::EndsAt), proration_behavior: T.nilable(String), set_pause_collection: T.nilable(QuoteCreateParams::Line::SetPauseCollection), set_schedule_end: T.nilable(String), starts_at: T.nilable(QuoteCreateParams::Line::StartsAt), trial_settings: T.nilable(QuoteCreateParams::Line::TrialSettings)).void
       }
      def initialize(
        actions: nil,
        applies_to: nil,
    ...
    class LineItem < ::Stripe::RequestParams
      class Discount < ::Stripe::RequestParams
        class DiscountEnd < ::Stripe::RequestParams
          ...
          # Time span for the redeemed discount.
          sig { returns(T.nilable(QuoteCreateParams::LineItem::Discount::DiscountEnd::Duration)) }
          def duration; end
          sig {
            params(_duration: T.nilable(QuoteCreateParams::LineItem::Discount::DiscountEnd::Duration)).returns(T.nilable(QuoteCreateParams::LineItem::Discount::DiscountEnd::Duration))
           }
          def duration=(_duration); end
          # A precise Unix timestamp for the discount to end. Must be in the future.
          sig { returns(T.nilable(Integer)) }
          ...
          def type=(_type); end
          sig {
            params(duration: T.nilable(QuoteCreateParams::LineItem::Discount::DiscountEnd::Duration), timestamp: T.nilable(Integer), type: String).void
           }
          def initialize(duration: nil, timestamp: nil, type: nil); end
        end
        # ID of the coupon to create a new discount for.
        ...
        def discount=(_discount); end
        # Details to determine how long the discount should be applied for.
        sig { returns(T.nilable(QuoteCreateParams::LineItem::Discount::DiscountEnd)) }
        def discount_end; end
        sig {
          params(_discount_end: T.nilable(QuoteCreateParams::LineItem::Discount::DiscountEnd)).returns(T.nilable(QuoteCreateParams::LineItem::Discount::DiscountEnd))
         }
        def discount_end=(_discount_end); end
        # ID of the promotion code to create a new discount for.
        sig { returns(T.nilable(String)) }
        ...
        def promotion_code=(_promotion_code); end
        sig {
          params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(QuoteCreateParams::LineItem::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
         }
        def initialize(coupon: nil, discount: nil, discount_end: nil, promotion_code: nil); end
      end
    ...
    class SubscriptionData < ::Stripe::RequestParams
      class BillOnAcceptance < ::Stripe::RequestParams
        class BillFrom < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillFrom::LineStartsAt))
           }
          def line_starts_at; end
          sig {
            params(_line_starts_at: T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillFrom::LineStartsAt)).returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillFrom::LineStartsAt))
           }
          ...
          def type=(_type); end
          sig {
            params(line_starts_at: T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillFrom::LineStartsAt), timestamp: T.nilable(Integer), type: String).void
           }
        ...
        class BillUntil < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil::Duration))
           }
          def duration; end
          sig {
            params(_duration: T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil::Duration)).returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil::Duration))
           }
          def duration=(_duration); end
          # Details of a Quote line item from which to bill until.
          sig {
            returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil::LineEndsAt))
           }
          def line_ends_at; end
          sig {
            params(_line_ends_at: T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil::LineEndsAt)).returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil::LineEndsAt))
           }
          def line_ends_at=(_line_ends_at); end
          # A precise Unix timestamp.
          sig { returns(T.nilable(Integer)) }
          ...
          def type=(_type); end
          sig {
            params(duration: T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil::Duration), line_ends_at: T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil::LineEndsAt), timestamp: T.nilable(Integer), type: String).void
           }
          def initialize(duration: nil, line_ends_at: nil, timestamp: nil, type: nil); end
        end
        # The start of the period to bill from when the Quote is accepted.
        sig { returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillFrom)) }
        def bill_from; end
        sig {
          params(_bill_from: T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillFrom)).returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillFrom))
         }
        def bill_from=(_bill_from); end
        # The end of the period to bill until when the Quote is accepted.
        sig { returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil)) }
        def bill_until; end
        sig {
          params(_bill_until: T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil)).returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil))
         }
        def bill_until=(_bill_until); end
        sig {
          params(bill_from: T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillFrom), bill_until: T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance::BillUntil)).void
         }
      ...
      sig { returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance)) }
      def bill_on_acceptance; end
      sig {
        params(_bill_on_acceptance: T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance)).returns(T.nilable(QuoteCreateParams::SubscriptionData::BillOnAcceptance))
       }
      ...
      def prebilling; end
      sig {
        params(_prebilling: T.nilable(T.any(String, QuoteCreateParams::SubscriptionData::Prebilling))).returns(T.nilable(T.any(String, QuoteCreateParams::SubscriptionData::Prebilling)))
       }
    ...
    class SubscriptionDataOverride < ::Stripe::RequestParams
      ...
      class BillOnAcceptance < ::Stripe::RequestParams
        class BillFrom < ::Stripe::RequestParams
          ...
          # Details of a Quote line to start the bill period from.
          sig {
            returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillFrom::LineStartsAt))
           }
          def line_starts_at; end
          sig {
            params(_line_starts_at: T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillFrom::LineStartsAt)).returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillFrom::LineStartsAt))
           }
          def line_starts_at=(_line_starts_at); end
          # A precise Unix timestamp.
          sig { returns(T.nilable(Integer)) }
          ...
          def type=(_type); end
          sig {
            params(line_starts_at: T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillFrom::LineStartsAt), timestamp: T.nilable(Integer), type: String).void
           }
          def initialize(line_starts_at: nil, timestamp: nil, type: nil); end
        end
        class BillUntil < ::Stripe::RequestParams
          ...
          # Details of the duration over which to bill.
          sig {
            returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil::Duration))
           }
          def duration; end
          sig {
            params(_duration: T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil::Duration)).returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil::Duration))
           }
          def duration=(_duration); end
          # Details of a Quote line item from which to bill until.
          sig {
            returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil::LineEndsAt))
           }
          def line_ends_at; end
          sig {
            params(_line_ends_at: T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil::LineEndsAt)).returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil::LineEndsAt))
           }
          def line_ends_at=(_line_ends_at); end
          # A precise Unix timestamp.
          sig { returns(T.nilable(Integer)) }
          ...
          def type=(_type); end
          sig {
            params(duration: T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil::Duration), line_ends_at: T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil::LineEndsAt), timestamp: T.nilable(Integer), type: String).void
           }
          def initialize(duration: nil, line_ends_at: nil, timestamp: nil, type: nil); end
        end
        # The start of the period to bill from when the Quote is accepted.
        sig {
          returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillFrom))
         }
        def bill_from; end
        sig {
          params(_bill_from: T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillFrom)).returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillFrom))
         }
        def bill_from=(_bill_from); end
        # The end of the period to bill until when the Quote is accepted.
        sig {
          returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil))
         }
        def bill_until; end
        sig {
          params(_bill_until: T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil)).returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil))
         }
        def bill_until=(_bill_until); end
        sig {
          params(bill_from: T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillFrom), bill_until: T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance::BillUntil)).void
         }
        def initialize(bill_from: nil, bill_until: nil); end
      end
      class BillingSchedule < ::Stripe::RequestParams
      ...
      def applies_to; end
      sig {
        params(_applies_to: QuoteCreateParams::SubscriptionDataOverride::AppliesTo).returns(QuoteCreateParams::SubscriptionDataOverride::AppliesTo)
       }
      def applies_to=(_applies_to); end
      # Describes the period to bill for upon accepting the quote.
      sig { returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance)) }
      def bill_on_acceptance; end
      sig {
        params(_bill_on_acceptance: T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance)).returns(T.nilable(QuoteCreateParams::SubscriptionDataOverride::BillOnAcceptance))
       }
      def bill_on_acceptance=(_bill_on_acceptance); end
      # Configures when the subscription schedule generates prorations for phase transitions. Possible values are `prorate_on_next_phase` or `prorate_up_front` with the default being `prorate_on_next_phase`. `prorate_on_next_phase` will apply phase changes and generate prorations at transition time. `prorate_up_front` will bill for all phases within the current billing cycle up front.
      sig { returns(T.nilable(String)) }
    ...
    sig { returns(T.nilable(T::Array[QuoteCreateParams::Line])) }
    def lines; end
    sig {
      params(_lines: T.nilable(T::Array[QuoteCreateParams::Line])).returns(T.nilable(T::Array[QuoteCreateParams::Line]))
     }
    ...
    sig { returns(T.nilable(T::Array[QuoteCreateParams::SubscriptionDataOverride])) }
    def subscription_data_overrides; end
    sig {
      params(_subscription_data_overrides: T.nilable(T::Array[QuoteCreateParams::SubscriptionDataOverride])).returns(T.nilable(T::Array[QuoteCreateParams::SubscriptionDataOverride]))
     }
    ...
    sig {
      params(allow_backdated_lines: T.nilable(T::Boolean), application_fee_amount: T.nilable(T.any(String, Integer)), application_fee_percent: T.nilable(T.any(String, Float)), automatic_tax: T.nilable(QuoteCreateParams::AutomaticTax), collection_method: T.nilable(String), customer: T.nilable(String), customer_account: T.nilable(String), default_tax_rates: T.nilable(T.any(String, T::Array[String])), description: T.nilable(String), discounts: T.nilable(T.any(String, T::Array[QuoteCreateParams::Discount])), expand: T.nilable(T::Array[String]), expires_at: T.nilable(Integer), footer: T.nilable(String), from_quote: T.nilable(QuoteCreateParams::FromQuote), header: T.nilable(String), invoice_settings: T.nilable(QuoteCreateParams::InvoiceSettings), line_items: T.nilable(T::Array[QuoteCreateParams::LineItem]), lines: T.nilable(T::Array[QuoteCreateParams::Line]), metadata: T.nilable(T::Hash[String, String]), on_behalf_of: T.nilable(String), subscription_data: T.nilable(QuoteCreateParams::SubscriptionData), subscription_data_overrides: T.nilable(T::Array[QuoteCreateParams::SubscriptionDataOverride]), test_clock: T.nilable(String), transfer_data: T.nilable(T.any(String, QuoteCreateParams::TransferData))).void
     }
    def initialize(
