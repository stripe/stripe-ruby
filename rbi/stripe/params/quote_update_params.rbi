...
module Stripe
  class QuoteUpdateParams < ::Stripe::RequestParams
    ...
    class Line < ::Stripe::RequestParams
      class Action < ::Stripe::RequestParams
        class AddDiscount < ::Stripe::RequestParams
          ...
          def promotion_code=(_promotion_code); end
          sig {
            params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(QuoteUpdateParams::Line::Action::AddDiscount::DiscountEnd), index: T.nilable(Integer), promotion_code: T.nilable(String)).void
           }
          def initialize(
            coupon: nil,
            discount: nil,
        ...
        class AddItem < ::Stripe::RequestParams
          class Discount < ::Stripe::RequestParams
            ...
            def promotion_code=(_promotion_code); end
            sig {
              params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(QuoteUpdateParams::Line::Action::AddItem::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
             }
            def initialize(coupon: nil, discount: nil, discount_end: nil, promotion_code: nil); end
          end
          ...
          sig {
            params(discounts: T.nilable(T::Array[QuoteUpdateParams::Line::Action::AddItem::Discount]), metadata: T.nilable(T::Hash[String, String]), price: String, quantity: T.nilable(Integer), tax_rates: T.nilable(T::Array[String]), trial: T.nilable(QuoteUpdateParams::Line::Action::AddItem::Trial)).void
           }
          def initialize(
            discounts: nil,
            metadata: nil,
        ...
        class SetItem < ::Stripe::RequestParams
          class Discount < ::Stripe::RequestParams
            ...
            def promotion_code=(_promotion_code); end
            sig {
              params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(QuoteUpdateParams::Line::Action::SetItem::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
             }
            def initialize(coupon: nil, discount: nil, discount_end: nil, promotion_code: nil); end
          end
          class Trial < ::Stripe::RequestParams
          ...
          def trial=(_trial); end
          sig {
            params(discounts: T.nilable(T::Array[QuoteUpdateParams::Line::Action::SetItem::Discount]), metadata: T.nilable(T::Hash[String, String]), price: String, quantity: T.nilable(Integer), tax_rates: T.nilable(T::Array[String]), trial: T.nilable(QuoteUpdateParams::Line::Action::SetItem::Trial)).void
           }
          def initialize(
            discounts: nil,
            metadata: nil,
      ...
      sig {
        params(actions: T.nilable(T::Array[QuoteUpdateParams::Line::Action]), applies_to: T.nilable(QuoteUpdateParams::Line::AppliesTo), billing_cycle_anchor: T.nilable(String), cancel_subscription_schedule: T.nilable(QuoteUpdateParams::Line::CancelSubscriptionSchedule), ends_at: T.nilable(QuoteUpdateParams::Line::EndsAt), id: T.nilable(String), proration_behavior: T.nilable(String), set_pause_collection: T.nilable(QuoteUpdateParams::Line::SetPauseCollection), set_schedule_end: T.nilable(String), starts_at: T.nilable(QuoteUpdateParams::Line::StartsAt), trial_settings: T.nilable(QuoteUpdateParams::Line::TrialSettings)).void
       }
      def initialize(
        actions: nil,
        applies_to: nil,
    ...
    class SubscriptionDataOverride < ::Stripe::RequestParams
      ...
      def proration_behavior=(_proration_behavior); end
      sig {
        params(applies_to: QuoteUpdateParams::SubscriptionDataOverride::AppliesTo, bill_on_acceptance: T.nilable(T.any(String, QuoteUpdateParams::SubscriptionDataOverride::BillOnAcceptance)), billing_behavior: T.nilable(String), customer: T.nilable(String), description: T.nilable(String), end_behavior: T.nilable(String), proration_behavior: T.nilable(String)).void
       }
      def initialize(
        applies_to: nil,
        bill_on_acceptance: nil,
