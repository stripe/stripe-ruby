...
module Stripe
  class QuoteUpdateParams < ::Stripe::RequestParams
    ...
    class InvoiceSettings < ::Stripe::RequestParams
      ...
      sig {
        returns(T.nilable(T.any(String, T::Array[::Stripe::QuoteUpdateParams::InvoiceSettings::CustomField])))
       }
      def custom_fields; end
      sig {
        params(_custom_fields: T.nilable(T.any(String, T::Array[::Stripe::QuoteUpdateParams::InvoiceSettings::CustomField]))).returns(T.nilable(T.any(String, T::Array[::Stripe::QuoteUpdateParams::InvoiceSettings::CustomField])))
       }
      ...
      sig {
        params(custom_fields: T.nilable(T.any(String, T::Array[::Stripe::QuoteUpdateParams::InvoiceSettings::CustomField])), days_until_due: T.nilable(Integer), description: T.nilable(String), footer: T.nilable(String), issuer: T.nilable(::Stripe::QuoteUpdateParams::InvoiceSettings::Issuer)).void
       }
      def initialize(
        custom_fields: nil,
        days_until_due: nil,
    ...
    class Line < ::Stripe::RequestParams
      class Action < ::Stripe::RequestParams
        class AddDiscount < ::Stripe::RequestParams
          ...
          def promotion_code=(_promotion_code); end
          sig {
            params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(::Stripe::QuoteUpdateParams::Line::Action::AddDiscount::DiscountEnd), index: T.nilable(Integer), promotion_code: T.nilable(String)).void
           }
          def initialize(
            coupon: nil,
            discount: nil,
        ...
        class AddItem < ::Stripe::RequestParams
          class Discount < ::Stripe::RequestParams
            ...
            def promotion_code=(_promotion_code); end
            sig {
              params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(::Stripe::QuoteUpdateParams::Line::Action::AddItem::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
             }
            def initialize(coupon: nil, discount: nil, discount_end: nil, promotion_code: nil); end
          end
        ...
        class SetItem < ::Stripe::RequestParams
          class Discount < ::Stripe::RequestParams
            ...
            def promotion_code=(_promotion_code); end
            sig {
              params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(::Stripe::QuoteUpdateParams::Line::Action::SetItem::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
             }
            def initialize(coupon: nil, discount: nil, discount_end: nil, promotion_code: nil); end
          end
          class Trial < ::Stripe::RequestParams
      ...
      sig {
        params(actions: T.nilable(T::Array[::Stripe::QuoteUpdateParams::Line::Action]), applies_to: T.nilable(::Stripe::QuoteUpdateParams::Line::AppliesTo), billing_cycle_anchor: T.nilable(String), cancel_subscription_schedule: T.nilable(::Stripe::QuoteUpdateParams::Line::CancelSubscriptionSchedule), ends_at: T.nilable(::Stripe::QuoteUpdateParams::Line::EndsAt), id: T.nilable(String), proration_behavior: T.nilable(String), set_pause_collection: T.nilable(::Stripe::QuoteUpdateParams::Line::SetPauseCollection), set_schedule_end: T.nilable(String), starts_at: T.nilable(::Stripe::QuoteUpdateParams::Line::StartsAt), trial_settings: T.nilable(::Stripe::QuoteUpdateParams::Line::TrialSettings)).void
       }
      def initialize(
        actions: nil,
        applies_to: nil,
    ...
    class SubscriptionData < ::Stripe::RequestParams
      ...
      sig {
        params(bill_on_acceptance: T.nilable(T.any(String, ::Stripe::QuoteUpdateParams::SubscriptionData::BillOnAcceptance)), billing_behavior: T.nilable(String), billing_cycle_anchor: T.nilable(String), description: T.nilable(String), effective_date: T.nilable(T.any(String, T.any(String, Integer))), end_behavior: T.nilable(String), metadata: T.nilable(T::Hash[String, String]), prebilling: T.nilable(T.any(String, ::Stripe::QuoteUpdateParams::SubscriptionData::Prebilling)), proration_behavior: T.nilable(String), trial_period_days: T.nilable(T.any(String, Integer))).void
       }
      def initialize(
    ...
    class SubscriptionDataOverride < ::Stripe::RequestParams
      ...
      def proration_behavior=(_proration_behavior); end
      sig {
        params(applies_to: ::Stripe::QuoteUpdateParams::SubscriptionDataOverride::AppliesTo, bill_on_acceptance: T.nilable(T.any(String, ::Stripe::QuoteUpdateParams::SubscriptionDataOverride::BillOnAcceptance)), billing_behavior: T.nilable(String), customer: T.nilable(String), description: T.nilable(String), end_behavior: T.nilable(String), proration_behavior: T.nilable(String)).void
       }
      def initialize(
        applies_to: nil,
        bill_on_acceptance: nil,
