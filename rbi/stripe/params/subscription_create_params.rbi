  ...
  class SubscriptionCreateParams < ::Stripe::RequestParams
    class AddInvoiceItem < ::Stripe::RequestParams
      class Discount < ::Stripe::RequestParams
        class DiscountEnd < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(SubscriptionCreateParams::AddInvoiceItem::Discount::DiscountEnd::Duration))
           }
          def duration; end
          sig {
            params(_duration: T.nilable(SubscriptionCreateParams::AddInvoiceItem::Discount::DiscountEnd::Duration)).returns(T.nilable(SubscriptionCreateParams::AddInvoiceItem::Discount::DiscountEnd::Duration))
           }
          ...
          def type=(_type); end
          sig {
            params(duration: T.nilable(SubscriptionCreateParams::AddInvoiceItem::Discount::DiscountEnd::Duration), timestamp: T.nilable(Integer), type: String).void
           }
        ...
        sig { returns(T.nilable(SubscriptionCreateParams::AddInvoiceItem::Discount::DiscountEnd)) }
        def discount_end; end
        sig {
          params(_discount_end: T.nilable(SubscriptionCreateParams::AddInvoiceItem::Discount::DiscountEnd)).returns(T.nilable(SubscriptionCreateParams::AddInvoiceItem::Discount::DiscountEnd))
         }
        ...
        sig {
          params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(SubscriptionCreateParams::AddInvoiceItem::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
         }
    ...
    class BillingSchedule < ::Stripe::RequestParams
      ...
      class BillUntil < ::Stripe::RequestParams
        ...
        sig { returns(T.nilable(SubscriptionCreateParams::BillingSchedule::BillUntil::Duration)) }
        def duration; end
        sig {
          params(_duration: T.nilable(SubscriptionCreateParams::BillingSchedule::BillUntil::Duration)).returns(T.nilable(SubscriptionCreateParams::BillingSchedule::BillUntil::Duration))
         }
        def duration=(_duration); end
        ...
        def type=(_type); end
        sig {
          params(duration: T.nilable(SubscriptionCreateParams::BillingSchedule::BillUntil::Duration), timestamp: T.nilable(Integer), type: String).void
         }
        def initialize(duration: nil, timestamp: nil, type: nil); end
      end
      # Configure billing schedule differently for individual subscription items.
      sig { returns(T.nilable(T::Array[SubscriptionCreateParams::BillingSchedule::AppliesTo])) }
      def applies_to; end
      sig {
        params(_applies_to: T.nilable(T::Array[SubscriptionCreateParams::BillingSchedule::AppliesTo])).returns(T.nilable(T::Array[SubscriptionCreateParams::BillingSchedule::AppliesTo]))
       }
      def applies_to=(_applies_to); end
      # The end date for the billing schedule.
      sig { returns(SubscriptionCreateParams::BillingSchedule::BillUntil) }
      def bill_until; end
      sig {
        params(_bill_until: SubscriptionCreateParams::BillingSchedule::BillUntil).returns(SubscriptionCreateParams::BillingSchedule::BillUntil)
       }
      ...
      def key=(_key); end
      sig {
        params(applies_to: T.nilable(T::Array[SubscriptionCreateParams::BillingSchedule::AppliesTo]), bill_until: SubscriptionCreateParams::BillingSchedule::BillUntil, key: T.nilable(String)).void
       }
    ...
    class Discount < ::Stripe::RequestParams
      class DiscountEnd < ::Stripe::RequestParams
        ...
        # Time span for the redeemed discount.
        sig { returns(T.nilable(SubscriptionCreateParams::Discount::DiscountEnd::Duration)) }
        def duration; end
        sig {
          params(_duration: T.nilable(SubscriptionCreateParams::Discount::DiscountEnd::Duration)).returns(T.nilable(SubscriptionCreateParams::Discount::DiscountEnd::Duration))
         }
        def duration=(_duration); end
        # A precise Unix timestamp for the discount to end. Must be in the future.
        sig { returns(T.nilable(Integer)) }
        ...
        def type=(_type); end
        sig {
          params(duration: T.nilable(SubscriptionCreateParams::Discount::DiscountEnd::Duration), timestamp: T.nilable(Integer), type: String).void
         }
        def initialize(duration: nil, timestamp: nil, type: nil); end
      end
      class Settings < ::Stripe::RequestParams
        class ServicePeriodAnchorConfig < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(SubscriptionCreateParams::Discount::Settings::ServicePeriodAnchorConfig::Custom))
           }
          def custom; end
          sig {
            params(_custom: T.nilable(SubscriptionCreateParams::Discount::Settings::ServicePeriodAnchorConfig::Custom)).returns(T.nilable(SubscriptionCreateParams::Discount::Settings::ServicePeriodAnchorConfig::Custom))
           }
          ...
          def type=(_type); end
          sig {
            params(custom: T.nilable(SubscriptionCreateParams::Discount::Settings::ServicePeriodAnchorConfig::Custom), type: T.nilable(String)).void
           }
          def initialize(custom: nil, type: nil); end
        end
        # Configures service period cycle anchoring.
        sig {
          returns(T.nilable(SubscriptionCreateParams::Discount::Settings::ServicePeriodAnchorConfig))
         }
        def service_period_anchor_config; end
        sig {
          params(_service_period_anchor_config: T.nilable(SubscriptionCreateParams::Discount::Settings::ServicePeriodAnchorConfig)).returns(T.nilable(SubscriptionCreateParams::Discount::Settings::ServicePeriodAnchorConfig))
         }
        ...
        sig {
          params(service_period_anchor_config: T.nilable(SubscriptionCreateParams::Discount::Settings::ServicePeriodAnchorConfig), start_date: T.nilable(String)).void
         }
      ...
      def discount=(_discount); end
      # Details to determine how long the discount should be applied for.
      sig { returns(T.nilable(SubscriptionCreateParams::Discount::DiscountEnd)) }
      def discount_end; end
      sig {
        params(_discount_end: T.nilable(SubscriptionCreateParams::Discount::DiscountEnd)).returns(T.nilable(SubscriptionCreateParams::Discount::DiscountEnd))
       }
      def discount_end=(_discount_end); end
      # ID of the promotion code to create a new discount for.
      sig { returns(T.nilable(String)) }
      ...
      sig { returns(T.nilable(SubscriptionCreateParams::Discount::Settings)) }
      def settings; end
      sig {
        params(_settings: T.nilable(SubscriptionCreateParams::Discount::Settings)).returns(T.nilable(SubscriptionCreateParams::Discount::Settings))
       }
      def settings=(_settings); end
      sig {
        params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(SubscriptionCreateParams::Discount::DiscountEnd), promotion_code: T.nilable(String), settings: T.nilable(SubscriptionCreateParams::Discount::Settings)).void
       }
      def initialize(
        coupon: nil,
        discount: nil,
    ...
    class Item < ::Stripe::RequestParams
      ...
      class Discount < ::Stripe::RequestParams
        class DiscountEnd < ::Stripe::RequestParams
          ...
          # Time span for the redeemed discount.
          sig {
            returns(T.nilable(SubscriptionCreateParams::Item::Discount::DiscountEnd::Duration))
           }
          def duration; end
          sig {
            params(_duration: T.nilable(SubscriptionCreateParams::Item::Discount::DiscountEnd::Duration)).returns(T.nilable(SubscriptionCreateParams::Item::Discount::DiscountEnd::Duration))
           }
          def duration=(_duration); end
          # A precise Unix timestamp for the discount to end. Must be in the future.
          sig { returns(T.nilable(Integer)) }
          ...
          def type=(_type); end
          sig {
            params(duration: T.nilable(SubscriptionCreateParams::Item::Discount::DiscountEnd::Duration), timestamp: T.nilable(Integer), type: String).void
           }
          def initialize(duration: nil, timestamp: nil, type: nil); end
        end
        class Settings < ::Stripe::RequestParams
          class ServicePeriodAnchorConfig < ::Stripe::RequestParams
            ...
            # Anchor the service period to a custom date. Type must be `custom` to specify.
            sig {
              returns(T.nilable(SubscriptionCreateParams::Item::Discount::Settings::ServicePeriodAnchorConfig::Custom))
             }
            def custom; end
            sig {
              params(_custom: T.nilable(SubscriptionCreateParams::Item::Discount::Settings::ServicePeriodAnchorConfig::Custom)).returns(T.nilable(SubscriptionCreateParams::Item::Discount::Settings::ServicePeriodAnchorConfig::Custom))
             }
            def custom=(_custom); end
            # The type of service period anchor config. Defaults to `subscription_service_cycle_anchor` if omitted.
            sig { returns(T.nilable(String)) }
            ...
            def type=(_type); end
            sig {
              params(custom: T.nilable(SubscriptionCreateParams::Item::Discount::Settings::ServicePeriodAnchorConfig::Custom), type: T.nilable(String)).void
             }
            def initialize(custom: nil, type: nil); end
          end
          # Configures service period cycle anchoring.
          sig {
            returns(T.nilable(SubscriptionCreateParams::Item::Discount::Settings::ServicePeriodAnchorConfig))
           }
          def service_period_anchor_config; end
          sig {
            params(_service_period_anchor_config: T.nilable(SubscriptionCreateParams::Item::Discount::Settings::ServicePeriodAnchorConfig)).returns(T.nilable(SubscriptionCreateParams::Item::Discount::Settings::ServicePeriodAnchorConfig))
           }
          def service_period_anchor_config=(_service_period_anchor_config); end
          # The start date of the discount's service period when applying a coupon or promotion code with a service period duration. Defaults to `now` if omitted.
          sig { returns(T.nilable(String)) }
          ...
          def start_date=(_start_date); end
          sig {
            params(service_period_anchor_config: T.nilable(SubscriptionCreateParams::Item::Discount::Settings::ServicePeriodAnchorConfig), start_date: T.nilable(String)).void
           }
          def initialize(service_period_anchor_config: nil, start_date: nil); end
        end
        # ID of the coupon to create a new discount for.
        ...
        def discount=(_discount); end
        # Details to determine how long the discount should be applied for.
        sig { returns(T.nilable(SubscriptionCreateParams::Item::Discount::DiscountEnd)) }
        def discount_end; end
        sig {
          params(_discount_end: T.nilable(SubscriptionCreateParams::Item::Discount::DiscountEnd)).returns(T.nilable(SubscriptionCreateParams::Item::Discount::DiscountEnd))
         }
        def discount_end=(_discount_end); end
        # ID of the promotion code to create a new discount for.
        sig { returns(T.nilable(String)) }
        ...
        def promotion_code=(_promotion_code); end
        # Settings for discount application including service period anchoring.
        sig { returns(T.nilable(SubscriptionCreateParams::Item::Discount::Settings)) }
        def settings; end
        sig {
          params(_settings: T.nilable(SubscriptionCreateParams::Item::Discount::Settings)).returns(T.nilable(SubscriptionCreateParams::Item::Discount::Settings))
         }
        def settings=(_settings); end
        sig {
          params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(SubscriptionCreateParams::Item::Discount::DiscountEnd), promotion_code: T.nilable(String), settings: T.nilable(SubscriptionCreateParams::Item::Discount::Settings)).void
         }
        def initialize(
          coupon: nil,
          discount: nil,
      ...
      sig { returns(T.nilable(SubscriptionCreateParams::Item::Trial)) }
      def trial; end
      sig {
    ...
    class PaymentSettings < ::Stripe::RequestParams
      class PaymentMethodOptions < ::Stripe::RequestParams
        ...
        class Payto < ::Stripe::RequestParams
          ...
          # Additional fields for Mandate creation.
          sig {
            returns(T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Payto::MandateOptions))
           }
          def mandate_options; end
          sig {
            params(_mandate_options: T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Payto::MandateOptions)).returns(T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Payto::MandateOptions))
           }
          def mandate_options=(_mandate_options); end
          sig {
            params(mandate_options: T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Payto::MandateOptions)).void
           }
        ...
        class Pix < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Pix::MandateOptions))
           }
          def mandate_options; end
          sig {
            params(_mandate_options: T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Pix::MandateOptions)).returns(T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Pix::MandateOptions))
           }
          def mandate_options=(_mandate_options); end
          sig {
            params(mandate_options: T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Pix::MandateOptions)).void
           }
          def initialize(mandate_options: nil); end
        end
        ...
        class Upi < ::Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Upi::MandateOptions))
           }
          def mandate_options; end
          sig {
            params(_mandate_options: T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Upi::MandateOptions)).returns(T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Upi::MandateOptions))
           }
          def mandate_options=(_mandate_options); end
          sig {
            params(mandate_options: T.nilable(SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Upi::MandateOptions)).void
           }
          def initialize(mandate_options: nil); end
        end
        ...
        sig {
          returns(T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::IdBankTransfer)))
         }
        def id_bank_transfer; end
        sig {
          params(_id_bank_transfer: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::IdBankTransfer))).returns(T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::IdBankTransfer)))
         }
        ...
        sig {
          returns(T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Payto)))
         }
        def payto; end
        sig {
          params(_payto: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Payto))).returns(T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Payto)))
         }
        ...
        sig {
          returns(T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Pix)))
         }
        def pix; end
        sig {
          params(_pix: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Pix))).returns(T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Pix)))
         }
        def pix=(_pix); end
        ...
        sig {
          returns(T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Upi)))
         }
        def upi; end
        sig {
          params(_upi: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Upi))).returns(T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Upi)))
         }
        def upi=(_upi); end
        ...
        sig {
          params(acss_debit: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::AcssDebit)), bancontact: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Bancontact)), card: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Card)), customer_balance: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::CustomerBalance)), id_bank_transfer: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::IdBankTransfer)), konbini: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Konbini)), payto: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Payto)), pix: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Pix)), sepa_debit: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::SepaDebit)), upi: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::Upi)), us_bank_account: T.nilable(T.any(String, SubscriptionCreateParams::PaymentSettings::PaymentMethodOptions::UsBankAccount))).void
         }
        def initialize(
          acss_debit: nil,
          bancontact: nil,
    ...
    sig { returns(T.nilable(T::Array[SubscriptionCreateParams::BillingSchedule])) }
    def billing_schedules; end
    sig {
      params(_billing_schedules: T.nilable(T::Array[SubscriptionCreateParams::BillingSchedule])).returns(T.nilable(T::Array[SubscriptionCreateParams::BillingSchedule]))
     }
    ...
    sig { returns(T.nilable(SubscriptionCreateParams::Prebilling)) }
    def prebilling; end
    sig {
      params(_prebilling: T.nilable(SubscriptionCreateParams::Prebilling)).returns(T.nilable(SubscriptionCreateParams::Prebilling))
     }
    ...
    sig {
      params(add_invoice_items: T.nilable(T::Array[SubscriptionCreateParams::AddInvoiceItem]), application_fee_percent: T.nilable(T.any(String, Float)), automatic_tax: T.nilable(SubscriptionCreateParams::AutomaticTax), backdate_start_date: T.nilable(Integer), billing_cadence: T.nilable(String), billing_cycle_anchor: T.nilable(Integer), billing_cycle_anchor_config: T.nilable(SubscriptionCreateParams::BillingCycleAnchorConfig), billing_mode: T.nilable(SubscriptionCreateParams::BillingMode), billing_schedules: T.nilable(T::Array[SubscriptionCreateParams::BillingSchedule]), billing_thresholds: T.nilable(T.any(String, SubscriptionCreateParams::BillingThresholds)), cancel_at: T.nilable(T.any(Integer, String)), cancel_at_period_end: T.nilable(T::Boolean), collection_method: T.nilable(String), currency: T.nilable(String), customer: T.nilable(String), customer_account: T.nilable(String), days_until_due: T.nilable(Integer), default_payment_method: T.nilable(String), default_source: T.nilable(String), default_tax_rates: T.nilable(T.any(String, T::Array[String])), description: T.nilable(String), discounts: T.nilable(T.any(String, T::Array[SubscriptionCreateParams::Discount])), expand: T.nilable(T::Array[String]), invoice_settings: T.nilable(SubscriptionCreateParams::InvoiceSettings), items: T.nilable(T::Array[SubscriptionCreateParams::Item]), metadata: T.nilable(T.any(String, T::Hash[String, String])), off_session: T.nilable(T::Boolean), on_behalf_of: T.nilable(String), payment_behavior: T.nilable(String), payment_settings: T.nilable(SubscriptionCreateParams::PaymentSettings), pending_invoice_item_interval: T.nilable(T.any(String, SubscriptionCreateParams::PendingInvoiceItemInterval)), prebilling: T.nilable(SubscriptionCreateParams::Prebilling), proration_behavior: T.nilable(String), transfer_data: T.nilable(SubscriptionCreateParams::TransferData), trial_end: T.nilable(T.any(String, Integer)), trial_from_plan: T.nilable(T::Boolean), trial_period_days: T.nilable(Integer), trial_settings: T.nilable(SubscriptionCreateParams::TrialSettings)).void
     }
    def initialize(
