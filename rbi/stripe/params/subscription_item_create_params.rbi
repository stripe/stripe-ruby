...
module Stripe
  class SubscriptionItemCreateParams < ::Stripe::RequestParams
    ...
    class Discount < ::Stripe::RequestParams
      ...
      sig {
        params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(SubscriptionItemCreateParams::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
       }
    ...
    sig {
      params(billing_thresholds: T.nilable(T.any(String, SubscriptionItemCreateParams::BillingThresholds)), discounts: T.nilable(T.any(String, T::Array[SubscriptionItemCreateParams::Discount])), expand: T.nilable(T::Array[String]), metadata: T.nilable(T::Hash[String, String]), payment_behavior: T.nilable(String), plan: T.nilable(String), price: T.nilable(String), price_data: T.nilable(SubscriptionItemCreateParams::PriceData), proration_behavior: T.nilable(String), proration_date: T.nilable(Integer), quantity: T.nilable(Integer), subscription: String, tax_rates: T.nilable(T.any(String, T::Array[String])), trial: T.nilable(SubscriptionItemCreateParams::Trial), current_trial: T.nilable(SubscriptionItemCreateParams::CurrentTrial)).void
     }
    def initialize(
