...
module Stripe
  class SubscriptionItemUpdateParams < ::Stripe::RequestParams
    ...
    class Discount < ::Stripe::RequestParams
      ...
      sig {
        params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(SubscriptionItemUpdateParams::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
       }
    ...
    sig {
      params(billing_thresholds: T.nilable(T.any(String, SubscriptionItemUpdateParams::BillingThresholds)), discounts: T.nilable(T.any(String, T::Array[SubscriptionItemUpdateParams::Discount])), expand: T.nilable(T::Array[String]), metadata: T.nilable(T.any(String, T::Hash[String, String])), off_session: T.nilable(T::Boolean), payment_behavior: T.nilable(String), plan: T.nilable(String), price: T.nilable(String), price_data: T.nilable(SubscriptionItemUpdateParams::PriceData), proration_behavior: T.nilable(String), proration_date: T.nilable(Integer), quantity: T.nilable(Integer), tax_rates: T.nilable(T.any(String, T::Array[String])), current_trial: T.nilable(SubscriptionItemUpdateParams::CurrentTrial)).void
     }
    def initialize(
