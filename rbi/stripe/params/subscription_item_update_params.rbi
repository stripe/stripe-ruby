...
module Stripe
  class SubscriptionItemUpdateParams < ::Stripe::RequestParams
    ...
    class Discount < ::Stripe::RequestParams
      ...
      sig {
        params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(::Stripe::SubscriptionItemUpdateParams::Discount::DiscountEnd), promotion_code: T.nilable(String)).void
       }
