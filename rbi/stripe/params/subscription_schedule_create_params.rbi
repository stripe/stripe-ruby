...
module Stripe
  class SubscriptionScheduleCreateParams < ::Stripe::RequestParams
    ...
    sig {
      params(billing_behavior: T.nilable(String), billing_mode: T.nilable(::Stripe::SubscriptionScheduleCreateParams::BillingMode), customer: T.nilable(String), customer_account: T.nilable(String), default_settings: T.nilable(::Stripe::SubscriptionScheduleCreateParams::DefaultSettings), end_behavior: T.nilable(String), expand: T.nilable(T::Array[String]), from_subscription: T.nilable(String), metadata: T.nilable(T.any(String, T::Hash[String, String])), phases: T.nilable(T::Array[::Stripe::SubscriptionScheduleCreateParams::Phase]), prebilling: T.nilable(::Stripe::SubscriptionScheduleCreateParams::Prebilling), start_date: T.nilable(T.any(Integer, String))).void
     }
    def initialize(
