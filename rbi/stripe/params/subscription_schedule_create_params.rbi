  ...
  class SubscriptionScheduleCreateParams < ::Stripe::RequestParams
    ...
    class Phase < ::Stripe::RequestParams
      ...
      class Item < ::Stripe::RequestParams
        ...
        def tax_rates=(_tax_rates); end
        sig {
          params(billing_thresholds: T.nilable(T.any(String, ::Stripe::SubscriptionScheduleCreateParams::Phase::Item::BillingThresholds)), discounts: T.nilable(T.any(String, T::Array[::Stripe::SubscriptionScheduleCreateParams::Phase::Item::Discount])), metadata: T.nilable(T::Hash[String, String]), plan: T.nilable(String), price: T.nilable(String), price_data: T.nilable(::Stripe::SubscriptionScheduleCreateParams::Phase::Item::PriceData), quantity: T.nilable(Integer), tax_rates: T.nilable(T.any(String, T::Array[String]))).void
         }
        def initialize(
          billing_thresholds: nil,
          discounts: nil,
      ...
      sig {
        params(add_invoice_items: T.nilable(T::Array[::Stripe::SubscriptionScheduleCreateParams::Phase::AddInvoiceItem]), application_fee_percent: T.nilable(Float), automatic_tax: T.nilable(::Stripe::SubscriptionScheduleCreateParams::Phase::AutomaticTax), billing_cycle_anchor: T.nilable(String), billing_thresholds: T.nilable(T.any(String, ::Stripe::SubscriptionScheduleCreateParams::Phase::BillingThresholds)), collection_method: T.nilable(String), currency: T.nilable(String), default_payment_method: T.nilable(String), default_tax_rates: T.nilable(T.any(String, T::Array[String])), description: T.nilable(String), discounts: T.nilable(T.any(String, T::Array[::Stripe::SubscriptionScheduleCreateParams::Phase::Discount])), duration: T.nilable(::Stripe::SubscriptionScheduleCreateParams::Phase::Duration), end_date: T.nilable(Integer), invoice_settings: T.nilable(::Stripe::SubscriptionScheduleCreateParams::Phase::InvoiceSettings), items: T::Array[::Stripe::SubscriptionScheduleCreateParams::Phase::Item], metadata: T.nilable(T::Hash[String, String]), on_behalf_of: T.nilable(String), proration_behavior: T.nilable(String), transfer_data: T.nilable(::Stripe::SubscriptionScheduleCreateParams::Phase::TransferData), trial: T.nilable(T::Boolean), trial_end: T.nilable(Integer)).void
       }
      def initialize(
    ...
    sig {
      params(billing_mode: T.nilable(::Stripe::SubscriptionScheduleCreateParams::BillingMode), customer: T.nilable(String), customer_account: T.nilable(String), default_settings: T.nilable(::Stripe::SubscriptionScheduleCreateParams::DefaultSettings), end_behavior: T.nilable(String), expand: T.nilable(T::Array[String]), from_subscription: T.nilable(String), metadata: T.nilable(T.any(String, T::Hash[String, String])), pause_schedules: T.nilable(T::Array[::Stripe::SubscriptionScheduleCreateParams::PauseSchedule]), phases: T.nilable(T::Array[::Stripe::SubscriptionScheduleCreateParams::Phase]), start_date: T.nilable(T.any(Integer, String))).void
     }
    def initialize(
      billing_mode: nil,
      customer: nil,
