      ...
      class Discount < ::Stripe::RequestParams
        ...
        class Settings < ::Stripe::RequestParams
          class ServicePeriodAnchorConfig < ::Stripe::RequestParams
            ...
            sig {
              returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings::ServicePeriodAnchorConfig::Custom))
             }
            def custom; end
            sig {
              params(_custom: T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings::ServicePeriodAnchorConfig::Custom)).returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings::ServicePeriodAnchorConfig::Custom))
             }
            ...
            def type=(_type); end
            sig {
              params(custom: T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings::ServicePeriodAnchorConfig::Custom), type: T.nilable(String)).void
             }
            def initialize(custom: nil, type: nil); end
          end
          # Configures service period cycle anchoring.
          sig {
            returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings::ServicePeriodAnchorConfig))
           }
          def service_period_anchor_config; end
          sig {
            params(_service_period_anchor_config: T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings::ServicePeriodAnchorConfig)).returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings::ServicePeriodAnchorConfig))
           }
          ...
          sig {
            params(service_period_anchor_config: T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings::ServicePeriodAnchorConfig), start_date: T.nilable(String)).void
           }
        ...
        sig { returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings)) }
        def settings; end
        sig {
          params(_settings: T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings)).returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings))
         }
        def settings=(_settings); end
        sig {
          params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::DiscountEnd), promotion_code: T.nilable(String), settings: T.nilable(SubscriptionScheduleUpdateParams::Phase::Discount::Settings)).void
         }
        def initialize(
          coupon: nil,
          discount: nil,
        ...
        class Discount < ::Stripe::RequestParams
          ...
          class Settings < ::Stripe::RequestParams
            class ServicePeriodAnchorConfig < ::Stripe::RequestParams
              ...
              # Anchor the service period to a custom date. Type must be `custom` to specify.
              sig {
                returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings::ServicePeriodAnchorConfig::Custom))
               }
              def custom; end
              sig {
                params(_custom: T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings::ServicePeriodAnchorConfig::Custom)).returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings::ServicePeriodAnchorConfig::Custom))
               }
              def custom=(_custom); end
              # The type of service period anchor config. Defaults to `inherit` if omitted.
              sig { returns(T.nilable(String)) }
              ...
              def type=(_type); end
              sig {
                params(custom: T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings::ServicePeriodAnchorConfig::Custom), type: T.nilable(String)).void
               }
              def initialize(custom: nil, type: nil); end
            end
            # Configures service period cycle anchoring.
            sig {
              returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings::ServicePeriodAnchorConfig))
             }
            def service_period_anchor_config; end
            sig {
              params(_service_period_anchor_config: T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings::ServicePeriodAnchorConfig)).returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings::ServicePeriodAnchorConfig))
             }
            def service_period_anchor_config=(_service_period_anchor_config); end
            # The start date of the discount's service period when applying a coupon or promotion code with a service period duration. Defaults to `phase_start` if omitted.
            sig { returns(T.nilable(String)) }
            ...
            def start_date=(_start_date); end
            sig {
              params(service_period_anchor_config: T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings::ServicePeriodAnchorConfig), start_date: T.nilable(String)).void
             }
            def initialize(service_period_anchor_config: nil, start_date: nil); end
          end
          # ID of the coupon to create a new discount for.
          ...
          # Settings for discount application including service period anchoring.
          sig {
            returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings))
           }
          def settings; end
          sig {
            params(_settings: T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings)).returns(T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings))
           }
          def settings=(_settings); end
          sig {
            params(coupon: T.nilable(String), discount: T.nilable(String), discount_end: T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::DiscountEnd), promotion_code: T.nilable(String), settings: T.nilable(SubscriptionScheduleUpdateParams::Phase::Item::Discount::Settings)).void
           }
          def initialize(
            coupon: nil,
            discount: nil,
