          ...
          class Recipient < ::Stripe::RequestParams
            class Capabilities < ::Stripe::RequestParams
              class BankAccounts < ::Stripe::RequestParams
                ...
                sig {
                  returns(T.nilable(V2::Core::AccountCreateParams::Configuration::Recipient::Capabilities::BankAccounts::Instant))
                 }
                def instant; end
                sig {
                  params(_instant: T.nilable(V2::Core::AccountCreateParams::Configuration::Recipient::Capabilities::BankAccounts::Instant)).returns(T.nilable(V2::Core::AccountCreateParams::Configuration::Recipient::Capabilities::BankAccounts::Instant))
                 }
                ...
                def wire=(_wire); end
                sig {
                  params(instant: T.nilable(V2::Core::AccountCreateParams::Configuration::Recipient::Capabilities::BankAccounts::Instant), local: T.nilable(V2::Core::AccountCreateParams::Configuration::Recipient::Capabilities::BankAccounts::Local), wire: T.nilable(V2::Core::AccountCreateParams::Configuration::Recipient::Capabilities::BankAccounts::Wire)).void
                 }
