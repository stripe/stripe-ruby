        ...
        class Identity < ::Stripe::RequestParams
          class Attestations < ::Stripe::RequestParams
            ...
            class TermsOfService < ::Stripe::RequestParams
              ...
              sig {
                params(account: T.nilable(V2::Core::AccountTokenCreateParams::Identity::Attestations::TermsOfService::Account), storer: T.nilable(V2::Core::AccountTokenCreateParams::Identity::Attestations::TermsOfService::Storer)).void
               }
