    ...
    module Tax
      class ManualRuleCreateParams < ::Stripe::RequestParams
        ...
        class ScheduledTaxRate < ::Stripe::RequestParams
          ...
          sig { returns(T::Array[V2::Tax::ManualRuleCreateParams::ScheduledTaxRate::Rate]) }
          def rates; end
          sig {
            params(_rates: T::Array[V2::Tax::ManualRuleCreateParams::ScheduledTaxRate::Rate]).returns(T::Array[V2::Tax::ManualRuleCreateParams::ScheduledTaxRate::Rate])
           }
          ...
          sig {
            params(rates: T::Array[V2::Tax::ManualRuleCreateParams::ScheduledTaxRate::Rate], starts_at: T.nilable(String)).void
           }
          def initialize(rates: nil, starts_at: nil); end
        end
        # Location where the rule applies.
        sig { returns(T.nilable(V2::Tax::ManualRuleCreateParams::Location)) }
        def location; end
        sig {
          params(_location: T.nilable(V2::Tax::ManualRuleCreateParams::Location)).returns(T.nilable(V2::Tax::ManualRuleCreateParams::Location))
         }
        def location=(_location); end
        # Products associated with the rule.
        sig { returns(T.nilable(T::Array[V2::Tax::ManualRuleCreateParams::Product])) }
        def products; end
        sig {
          params(_products: T.nilable(T::Array[V2::Tax::ManualRuleCreateParams::Product])).returns(T.nilable(T::Array[V2::Tax::ManualRuleCreateParams::Product]))
         }
        def products=(_products); end
        # Tax rates to be applied.
        sig { returns(T::Array[V2::Tax::ManualRuleCreateParams::ScheduledTaxRate]) }
        def scheduled_tax_rates; end
        sig {
          params(_scheduled_tax_rates: T::Array[V2::Tax::ManualRuleCreateParams::ScheduledTaxRate]).returns(T::Array[V2::Tax::ManualRuleCreateParams::ScheduledTaxRate])
         }
        def scheduled_tax_rates=(_scheduled_tax_rates); end
        sig {
          params(location: T.nilable(V2::Tax::ManualRuleCreateParams::Location), products: T.nilable(T::Array[V2::Tax::ManualRuleCreateParams::Product]), scheduled_tax_rates: T::Array[V2::Tax::ManualRuleCreateParams::ScheduledTaxRate]).void
         }
