  ...
  class BalanceSettings < SingletonAPIResource
    ...
    class UpdateParams < Stripe::RequestParams
      class Payouts < Stripe::RequestParams
        ...
        sig { returns(::Stripe::BalanceSettings::UpdateParams::Payouts::Schedule) }
        attr_accessor :schedule
        # The text that appears on the bank account statement for payouts. If not set, this defaults to the platform's bank descriptor as set in the Dashboard.
        sig { returns(String) }
        attr_accessor :statement_descriptor
        sig {
          params(schedule: ::Stripe::BalanceSettings::UpdateParams::Payouts::Schedule, statement_descriptor: String).void
         }
      ...
      attr_accessor :expand
      # Settings specific to the account's payouts.
      sig { returns(::Stripe::BalanceSettings::UpdateParams::Payouts) }
      attr_accessor :payouts
      # Settings related to the account's balance settlement timing.
      sig { returns(::Stripe::BalanceSettings::UpdateParams::SettlementTiming) }
      attr_accessor :settlement_timing
      sig {
        params(debit_negative_balances: T::Boolean, expand: T::Array[String], payouts: ::Stripe::BalanceSettings::UpdateParams::Payouts, settlement_timing: ::Stripe::BalanceSettings::UpdateParams::SettlementTiming).void
       }
      def initialize(
