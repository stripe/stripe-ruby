...
module Stripe
  ...
  class Coupon < APIResource
    ...
    class CreateParams < Stripe::RequestParams
      ...
      sig {
        params(amount_off: Integer, applies_to: ::Stripe::Coupon::CreateParams::AppliesTo, currency: String, currency_options: T::Hash[String, ::Stripe::Coupon::CreateParams::CurrencyOptions], duration: String, expand: T::Array[String], id: String, max_redemptions: Integer, metadata: T.nilable(T::Hash[String, String]), name: String, percent_off: Float, redeem_by: Integer).void
       }
      def initialize(
        amount_off: nil,
        applies_to: nil,
