  ...
  class CreditNote < APIResource
    ...
    class CreateParams < Stripe::RequestParams
      ...
      class Refund < Stripe::RequestParams
        ...
        sig { returns(T.nilable(::Stripe::CreditNote::CreateParams::Refund::PaymentRecordRefund)) }
        def payment_record_refund; end
        sig {
          params(_payment_record_refund: T.nilable(::Stripe::CreditNote::CreateParams::Refund::PaymentRecordRefund)).returns(T.nilable(::Stripe::CreditNote::CreateParams::Refund::PaymentRecordRefund))
         }
        ...
        def type=(_type); end
        sig {
          params(amount_refunded: T.nilable(Integer), payment_record_refund: T.nilable(::Stripe::CreditNote::CreateParams::Refund::PaymentRecordRefund), refund: T.nilable(String), type: T.nilable(String)).void
         }
        def initialize(
          amount_refunded: nil,
          payment_record_refund: nil,
          refund: nil,
          type: nil
        ); end
      end
    ...
    class PreviewParams < Stripe::RequestParams
      ...
      class Refund < Stripe::RequestParams
        ...
        def amount_refunded=(_amount_refunded); end
        # The PaymentRecord refund details to link to this credit note. Required when `type` is `payment_record_refund`.
        sig { returns(T.nilable(::Stripe::CreditNote::PreviewParams::Refund::PaymentRecordRefund)) }
        def payment_record_refund; end
        sig {
          params(_payment_record_refund: T.nilable(::Stripe::CreditNote::PreviewParams::Refund::PaymentRecordRefund)).returns(T.nilable(::Stripe::CreditNote::PreviewParams::Refund::PaymentRecordRefund))
         }
        def payment_record_refund=(_payment_record_refund); end
        # ID of an existing refund to link this credit note to. Required when `type` is `refund`.
        sig { returns(T.nilable(String)) }
        ...
        def type=(_type); end
        sig {
          params(amount_refunded: T.nilable(Integer), payment_record_refund: T.nilable(::Stripe::CreditNote::PreviewParams::Refund::PaymentRecordRefund), refund: T.nilable(String), type: T.nilable(String)).void
         }
        def initialize(
          amount_refunded: nil,
          payment_record_refund: nil,
    ...
    class ListPreviewLineItemsParams < Stripe::RequestParams
      ...
      class Refund < Stripe::RequestParams
        ...
        # The PaymentRecord refund details to link to this credit note. Required when `type` is `payment_record_refund`.
        sig {
          returns(T.nilable(::Stripe::CreditNote::ListPreviewLineItemsParams::Refund::PaymentRecordRefund))
         }
        def payment_record_refund; end
        sig {
          params(_payment_record_refund: T.nilable(::Stripe::CreditNote::ListPreviewLineItemsParams::Refund::PaymentRecordRefund)).returns(T.nilable(::Stripe::CreditNote::ListPreviewLineItemsParams::Refund::PaymentRecordRefund))
         }
        def payment_record_refund=(_payment_record_refund); end
        # ID of an existing refund to link this credit note to. Required when `type` is `refund`.
        sig { returns(T.nilable(String)) }
        ...
        def type=(_type); end
        sig {
          params(amount_refunded: T.nilable(Integer), payment_record_refund: T.nilable(::Stripe::CreditNote::ListPreviewLineItemsParams::Refund::PaymentRecordRefund), refund: T.nilable(String), type: T.nilable(String)).void
         }
        def initialize(
          amount_refunded: nil,
          payment_record_refund: nil,
