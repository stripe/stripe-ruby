  ...
  module GiftCards
    ...
    class Transaction < APIResource
      ...
      class CreateParams < Stripe::RequestParams
        ...
        sig { returns(T.nilable(::Stripe::GiftCards::Transaction::CreateParams::CreatedBy)) }
        ...
        attr_accessor :transfer_group
        sig {
          params(amount: Integer, confirm: T.nilable(T::Boolean), created_by: T.nilable(::Stripe::GiftCards::Transaction::CreateParams::CreatedBy), currency: String, description: T.nilable(String), expand: T.nilable(T::Array[String]), gift_card: String, metadata: T.nilable(T::Hash[String, String]), transfer_group: T.nilable(String)).void
         }
        def initialize(
          amount: nil,
          confirm: nil,
