...
module Stripe
  ...
  class Payout < APIResource
    ...
    class CreateParams < Stripe::RequestParams
      ...
      sig {
        params(amount: Integer, currency: String, description: String, destination: String, expand: T::Array[String], metadata: T::Hash[String, String], method: String, payout_method: String, source_type: String, statement_descriptor: String).void
       }
      def initialize(
        amount: nil,
        currency: nil,
