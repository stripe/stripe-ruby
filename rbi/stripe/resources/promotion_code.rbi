...
module Stripe
  ...
  class PromotionCode < APIResource
    ...
    class CreateParams < Stripe::RequestParams
      ...
      sig {
        params(active: T.nilable(T::Boolean), code: T.nilable(String), customer: T.nilable(String), customer_account: T.nilable(String), expand: T.nilable(T::Array[String]), expires_at: T.nilable(Integer), max_redemptions: T.nilable(Integer), metadata: T.nilable(T::Hash[String, String]), promotion: ::Stripe::PromotionCode::CreateParams::Promotion, restrictions: T.nilable(::Stripe::PromotionCode::CreateParams::Restrictions)).void
       }
      def initialize(
        active: nil,
        code: nil,
