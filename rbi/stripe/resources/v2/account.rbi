  ...
  module V2
    ...
    class Account < APIResource
      class Configuration < Stripe::StripeObject
        ...
        sig { returns(T.nilable(RecipientData)) }
        attr_reader :recipient_data
        ...
        sig { returns(T.nilable(SupportableFeatures)) }
      ...
      class LegalEntityData < Stripe::StripeObject
        ...
        sig { returns(T.nilable(Representative)) }
      ...
      sig { returns(T.nilable(LegalEntityData)) }
      ...
      sig { returns(T.nilable(T::Array[Requirement])) }
