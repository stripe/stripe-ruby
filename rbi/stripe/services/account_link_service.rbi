...
module Stripe
  class AccountLinkService < StripeService
    class CreateParams < Stripe::RequestParams
      ...
      sig {
        params(_collection_options: T.nilable(::Stripe::AccountLinkService::CreateParams::CollectionOptions)).returns(T.nilable(::Stripe::AccountLinkService::CreateParams::CollectionOptions))
       }
