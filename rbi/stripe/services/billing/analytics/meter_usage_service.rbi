    ...
    module Analytics
      class MeterUsageService < StripeService
        class RetrieveParams < Stripe::RequestParams
          ...
          def meters; end
          sig {
            params(_meters: T.nilable(T::Array[::Stripe::Billing::Analytics::MeterUsageService::RetrieveParams::Meter])).returns(T.nilable(T::Array[::Stripe::Billing::Analytics::MeterUsageService::RetrieveParams::Meter]))
           }
