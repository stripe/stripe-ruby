  ...
  class CreditNotePreviewLinesService < StripeService
    class ListParams < Stripe::RequestParams
      ...
      class Refund < Stripe::RequestParams
        ...
        sig {
          returns(T.nilable(::Stripe::CreditNotePreviewLinesService::ListParams::Refund::PaymentRecordRefund))
         }
        def payment_record_refund; end
        sig {
          params(_payment_record_refund: T.nilable(::Stripe::CreditNotePreviewLinesService::ListParams::Refund::PaymentRecordRefund)).returns(T.nilable(::Stripe::CreditNotePreviewLinesService::ListParams::Refund::PaymentRecordRefund))
         }
        ...
        def type=(_type); end
        sig {
          params(amount_refunded: T.nilable(Integer), payment_record_refund: T.nilable(::Stripe::CreditNotePreviewLinesService::ListParams::Refund::PaymentRecordRefund), refund: T.nilable(String), type: T.nilable(String)).void
         }
        def initialize(
          amount_refunded: nil,
