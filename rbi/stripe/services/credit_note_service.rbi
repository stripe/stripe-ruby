  ...
  class CreditNoteService < StripeService
    ...
    class CreateParams < Stripe::RequestParams
      ...
      class Refund < Stripe::RequestParams
        ...
        sig {
          returns(T.nilable(::Stripe::CreditNoteService::CreateParams::Refund::PaymentRecordRefund))
         }
        def payment_record_refund; end
        sig {
          params(_payment_record_refund: T.nilable(::Stripe::CreditNoteService::CreateParams::Refund::PaymentRecordRefund)).returns(T.nilable(::Stripe::CreditNoteService::CreateParams::Refund::PaymentRecordRefund))
         }
        ...
        def type=(_type); end
        sig {
          params(amount_refunded: T.nilable(Integer), payment_record_refund: T.nilable(::Stripe::CreditNoteService::CreateParams::Refund::PaymentRecordRefund), refund: T.nilable(String), type: T.nilable(String)).void
         }
        def initialize(
          amount_refunded: nil,
    ...
    class PreviewParams < Stripe::RequestParams
      ...
      class Refund < Stripe::RequestParams
        ...
        # The PaymentRecord refund details to link to this credit note. Required when `type` is `payment_record_refund`.
        sig {
          returns(T.nilable(::Stripe::CreditNoteService::PreviewParams::Refund::PaymentRecordRefund))
         }
        def payment_record_refund; end
        sig {
          params(_payment_record_refund: T.nilable(::Stripe::CreditNoteService::PreviewParams::Refund::PaymentRecordRefund)).returns(T.nilable(::Stripe::CreditNoteService::PreviewParams::Refund::PaymentRecordRefund))
         }
        def payment_record_refund=(_payment_record_refund); end
        # ID of an existing refund to link this credit note to. Required when `type` is `refund`.
        sig { returns(T.nilable(String)) }
        ...
        def type=(_type); end
        sig {
          params(amount_refunded: T.nilable(Integer), payment_record_refund: T.nilable(::Stripe::CreditNoteService::PreviewParams::Refund::PaymentRecordRefund), refund: T.nilable(String), type: T.nilable(String)).void
         }
        def initialize(
          amount_refunded: nil,
          payment_record_refund: nil,
