    ...
    class CreateParams < Stripe::RequestParams
      class Components < Stripe::RequestParams
        ...
        class PaymentElement < Stripe::RequestParams
          ...
          def features; end
          sig {
            params(_features: T.nilable(::Stripe::CustomerSessionService::CreateParams::Components::PaymentElement::Features)).returns(T.nilable(::Stripe::CustomerSessionService::CreateParams::Components::PaymentElement::Features))
           }
        ...
        def buy_button; end
        sig {
          params(_buy_button: T.nilable(::Stripe::CustomerSessionService::CreateParams::Components::BuyButton)).returns(T.nilable(::Stripe::CustomerSessionService::CreateParams::Components::BuyButton))
         }
        ...
        sig {
          params(_payment_element: T.nilable(::Stripe::CustomerSessionService::CreateParams::Components::PaymentElement)).returns(T.nilable(::Stripe::CustomerSessionService::CreateParams::Components::PaymentElement))
         }
        ...
        sig {
          params(_pricing_table: T.nilable(::Stripe::CustomerSessionService::CreateParams::Components::PricingTable)).returns(T.nilable(::Stripe::CustomerSessionService::CreateParams::Components::PricingTable))
         }
      ...
      def components; end
      sig {
        params(_components: ::Stripe::CustomerSessionService::CreateParams::Components).returns(::Stripe::CustomerSessionService::CreateParams::Components)
       }
