  ...
  class ExternalAccountService < StripeService
    ...
    class UpdateParams < Stripe::RequestParams
      class Documents < Stripe::RequestParams
        ...
        sig {
          params(_bank_account_ownership_verification: T.nilable(::Stripe::ExternalAccountService::UpdateParams::Documents::BankAccountOwnershipVerification)).returns(T.nilable(::Stripe::ExternalAccountService::UpdateParams::Documents::BankAccountOwnershipVerification))
         }
      ...
      def documents; end
      sig {
        params(_documents: T.nilable(::Stripe::ExternalAccountService::UpdateParams::Documents)).returns(T.nilable(::Stripe::ExternalAccountService::UpdateParams::Documents))
       }
    ...
    class CreateParams < Stripe::RequestParams
      ...
      sig {
        params(_external_account: T.any(String, ::Stripe::ExternalAccountService::CreateParams::Card, ::Stripe::ExternalAccountService::CreateParams::BankAccount, ::Stripe::ExternalAccountService::CreateParams::CardToken)).returns(T.any(String, ::Stripe::ExternalAccountService::CreateParams::Card, ::Stripe::ExternalAccountService::CreateParams::BankAccount, ::Stripe::ExternalAccountService::CreateParams::CardToken))
       }
