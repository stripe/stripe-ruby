...
module Stripe
  class FileService < StripeService
    class ListParams < Stripe::RequestParams
      ...
      def created; end
      sig {
        params(_created: T.nilable(T.any(::Stripe::FileService::ListParams::Created, Integer))).returns(T.nilable(T.any(::Stripe::FileService::ListParams::Created, Integer)))
       }
    ...
    class CreateParams < Stripe::RequestParams
      ...
      sig {
        params(_file_link_data: T.nilable(::Stripe::FileService::CreateParams::FileLinkData)).returns(T.nilable(::Stripe::FileService::CreateParams::FileLinkData))
       }
