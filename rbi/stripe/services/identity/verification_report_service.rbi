  ...
  module Identity
    class VerificationReportService < StripeService
      class ListParams < Stripe::RequestParams
        ...
        def created; end
        sig {
          params(_created: T.nilable(T.any(::Stripe::Identity::VerificationReportService::ListParams::Created, Integer))).returns(T.nilable(T.any(::Stripe::Identity::VerificationReportService::ListParams::Created, Integer)))
         }
