  ...
  module Issuing
    class AuthorizationService < StripeService
      class ListParams < Stripe::RequestParams
        ...
        def created; end
        sig {
          params(_created: T.nilable(T.any(::Stripe::Issuing::AuthorizationService::ListParams::Created, Integer))).returns(T.nilable(T.any(::Stripe::Issuing::AuthorizationService::ListParams::Created, Integer)))
         }
