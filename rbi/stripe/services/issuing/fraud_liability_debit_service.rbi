  ...
  module Issuing
    class FraudLiabilityDebitService < StripeService
      class ListParams < Stripe::RequestParams
        ...
        def created; end
        sig {
          params(_created: T.nilable(T.any(::Stripe::Issuing::FraudLiabilityDebitService::ListParams::Created, Integer))).returns(T.nilable(T.any(::Stripe::Issuing::FraudLiabilityDebitService::ListParams::Created, Integer)))
         }
