  ...
  class PaymentMethodConfigurationService < StripeService
    ...
    class CreateParams < Stripe::RequestParams
      ...
      class Billie < Stripe::RequestParams
        ...
        # Whether or not the payment method should be displayed.
        sig {
          returns(::Stripe::PaymentMethodConfigurationService::CreateParams::Billie::DisplayPreference)
         }
        attr_accessor :display_preference
        sig {
          params(display_preference: ::Stripe::PaymentMethodConfigurationService::CreateParams::Billie::DisplayPreference).void
         }
        def initialize(display_preference: nil); end
      end
      ...
      class NzBankAccount < Stripe::RequestParams
        ...
        # Whether or not the payment method should be displayed.
        sig {
          returns(::Stripe::PaymentMethodConfigurationService::CreateParams::NzBankAccount::DisplayPreference)
         }
        attr_accessor :display_preference
        sig {
          params(display_preference: ::Stripe::PaymentMethodConfigurationService::CreateParams::NzBankAccount::DisplayPreference).void
         }
        def initialize(display_preference: nil); end
      end
      ...
      class Satispay < Stripe::RequestParams
        ...
        # Whether or not the payment method should be displayed.
        sig {
          returns(::Stripe::PaymentMethodConfigurationService::CreateParams::Satispay::DisplayPreference)
         }
        attr_accessor :display_preference
        sig {
          params(display_preference: ::Stripe::PaymentMethodConfigurationService::CreateParams::Satispay::DisplayPreference).void
         }
        def initialize(display_preference: nil); end
      end
      ...
      sig { returns(::Stripe::PaymentMethodConfigurationService::CreateParams::Billie) }
      ...
      sig { returns(::Stripe::PaymentMethodConfigurationService::CreateParams::NzBankAccount) }
      ...
      sig { returns(::Stripe::PaymentMethodConfigurationService::CreateParams::Satispay) }
    ...
    class UpdateParams < Stripe::RequestParams
      ...
      class Billie < Stripe::RequestParams
        ...
        # Whether or not the payment method should be displayed.
        sig {
          returns(::Stripe::PaymentMethodConfigurationService::UpdateParams::Billie::DisplayPreference)
         }
        attr_accessor :display_preference
        sig {
          params(display_preference: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Billie::DisplayPreference).void
         }
        def initialize(display_preference: nil); end
      end
      class Blik < Stripe::RequestParams
      ...
      class NzBankAccount < Stripe::RequestParams
        ...
        # Whether or not the payment method should be displayed.
        sig {
          returns(::Stripe::PaymentMethodConfigurationService::UpdateParams::NzBankAccount::DisplayPreference)
         }
        attr_accessor :display_preference
        sig {
          params(display_preference: ::Stripe::PaymentMethodConfigurationService::UpdateParams::NzBankAccount::DisplayPreference).void
         }
        def initialize(display_preference: nil); end
      end
      class Oxxo < Stripe::RequestParams
      ...
      class Satispay < Stripe::RequestParams
        ...
        # Whether or not the payment method should be displayed.
        sig {
          returns(::Stripe::PaymentMethodConfigurationService::UpdateParams::Satispay::DisplayPreference)
         }
        attr_accessor :display_preference
        sig {
          params(display_preference: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Satispay::DisplayPreference).void
         }
        def initialize(display_preference: nil); end
      end
      class SepaDebit < Stripe::RequestParams
      ...
      attr_accessor :bancontact
      # Billie is a [single-use](https://docs.stripe.com/payments/payment-methods#usage) payment method that offers businesses Pay by Invoice where they offer payment terms ranging from 7-120 days. Customers are redirected from your website or app, authorize the payment with Billie, then return to your website or app. You get [immediate notification](/payments/payment-methods#payment-notification) of whether the payment succeeded or failed.
      sig { returns(::Stripe::PaymentMethodConfigurationService::UpdateParams::Billie) }
      attr_accessor :billie
      # BLIK is a [single use](https://stripe.com/docs/payments/payment-methods#usage) payment method that requires customers to authenticate their payments. When customers want to pay online using BLIK, they request a six-digit code from their banking application and enter it into the payment collection form. Check this [page](https://stripe.com/docs/payments/blik) for more details.
      ...
      attr_accessor :name
      # Stripe users in New Zealand can accept Bulk Electronic Clearing System (BECS) direct debit payments from customers with a New Zeland bank account. Check this [page](https://stripe.com/docs/payments/nz-bank-account) for more details.
      sig { returns(::Stripe::PaymentMethodConfigurationService::UpdateParams::NzBankAccount) }
      attr_accessor :nz_bank_account
      # OXXO is a Mexican chain of convenience stores with thousands of locations across Latin America and represents nearly 20% of online transactions in Mexico. OXXO allows customers to pay bills and online purchases in-store with cash. Check this [page](https://stripe.com/docs/payments/oxxo) for more details.
      ...
      attr_accessor :revolut_pay
      # Satispay is a [single-use](https://docs.stripe.com/payments/payment-methods#usage) payment method where customers are required to [authenticate](/payments/payment-methods#customer-actions) their payment. Customers pay by being redirected from your website or app, authorizing the payment with Satispay, then returning to your website or app. You get [immediate notification](/payments/payment-methods#payment-notification) of whether the payment succeeded or failed.
      sig { returns(::Stripe::PaymentMethodConfigurationService::UpdateParams::Satispay) }
      attr_accessor :satispay
      # The [Single Euro Payments Area (SEPA)](https://en.wikipedia.org/wiki/Single_Euro_Payments_Area) is an initiative of the European Union to simplify payments within and across member countries. SEPA established and enforced banking standards to allow for the direct debiting of every EUR-denominated bank account within the SEPA region, check this [page](https://stripe.com/docs/payments/sepa-debit) for more details.
      ...
      attr_accessor :zip
      sig {
        params(acss_debit: ::Stripe::PaymentMethodConfigurationService::UpdateParams::AcssDebit, active: T::Boolean, affirm: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Affirm, afterpay_clearpay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::AfterpayClearpay, alipay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Alipay, alma: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Alma, amazon_pay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::AmazonPay, apple_pay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::ApplePay, apple_pay_later: ::Stripe::PaymentMethodConfigurationService::UpdateParams::ApplePayLater, au_becs_debit: ::Stripe::PaymentMethodConfigurationService::UpdateParams::AuBecsDebit, bacs_debit: ::Stripe::PaymentMethodConfigurationService::UpdateParams::BacsDebit, bancontact: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Bancontact, billie: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Billie, blik: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Blik, boleto: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Boleto, card: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Card, cartes_bancaires: ::Stripe::PaymentMethodConfigurationService::UpdateParams::CartesBancaires, cashapp: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Cashapp, customer_balance: ::Stripe::PaymentMethodConfigurationService::UpdateParams::CustomerBalance, eps: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Eps, expand: T::Array[String], fpx: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Fpx, giropay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Giropay, google_pay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::GooglePay, gopay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Gopay, grabpay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Grabpay, id_bank_transfer: ::Stripe::PaymentMethodConfigurationService::UpdateParams::IdBankTransfer, ideal: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Ideal, jcb: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Jcb, klarna: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Klarna, konbini: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Konbini, link: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Link, mobilepay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Mobilepay, multibanco: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Multibanco, name: String, nz_bank_account: ::Stripe::PaymentMethodConfigurationService::UpdateParams::NzBankAccount, oxxo: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Oxxo, p24: ::Stripe::PaymentMethodConfigurationService::UpdateParams::P24, pay_by_bank: ::Stripe::PaymentMethodConfigurationService::UpdateParams::PayByBank, paynow: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Paynow, paypal: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Paypal, payto: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Payto, promptpay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Promptpay, qris: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Qris, revolut_pay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::RevolutPay, satispay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Satispay, sepa_debit: ::Stripe::PaymentMethodConfigurationService::UpdateParams::SepaDebit, shopeepay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Shopeepay, sofort: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Sofort, swish: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Swish, twint: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Twint, us_bank_account: ::Stripe::PaymentMethodConfigurationService::UpdateParams::UsBankAccount, wechat_pay: ::Stripe::PaymentMethodConfigurationService::UpdateParams::WechatPay, zip: ::Stripe::PaymentMethodConfigurationService::UpdateParams::Zip).void
       }
      def initialize(
        acss_debit: nil,
        active: nil,
