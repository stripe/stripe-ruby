...
module Stripe
  class PriceService < StripeService
    class ListParams < Stripe::RequestParams
      ...
      def created; end
      sig {
        params(_created: T.nilable(T.any(::Stripe::PriceService::ListParams::Created, Integer))).returns(T.nilable(T.any(::Stripe::PriceService::ListParams::Created, Integer)))
       }
      ...
      def recurring; end
      sig {
        params(_recurring: T.nilable(::Stripe::PriceService::ListParams::Recurring)).returns(T.nilable(::Stripe::PriceService::ListParams::Recurring))
       }
    ...
    class CreateParams < Stripe::RequestParams
      class CurrencyOptions < Stripe::RequestParams
        ...
        sig {
          params(_custom_unit_amount: T.nilable(::Stripe::PriceService::CreateParams::CurrencyOptions::CustomUnitAmount)).returns(T.nilable(::Stripe::PriceService::CreateParams::CurrencyOptions::CustomUnitAmount))
         }
        ...
        def tiers; end
        sig {
          params(_tiers: T.nilable(T::Array[::Stripe::PriceService::CreateParams::CurrencyOptions::Tier])).returns(T.nilable(T::Array[::Stripe::PriceService::CreateParams::CurrencyOptions::Tier]))
         }
      ...
      sig {
        params(_currency_options: T.nilable(T::Hash[String, ::Stripe::PriceService::CreateParams::CurrencyOptions])).returns(T.nilable(T::Hash[String, ::Stripe::PriceService::CreateParams::CurrencyOptions]))
       }
      ...
      def custom_unit_amount; end
      sig {
        params(_custom_unit_amount: T.nilable(::Stripe::PriceService::CreateParams::CustomUnitAmount)).returns(T.nilable(::Stripe::PriceService::CreateParams::CustomUnitAmount))
       }
      def custom_unit_amount=(_custom_unit_amount); end
      # Specifies which fields in the response should be expanded.
      sig { returns(T.nilable(T::Array[String])) }
      ...
      sig {
        params(_product_data: T.nilable(::Stripe::PriceService::CreateParams::ProductData)).returns(T.nilable(::Stripe::PriceService::CreateParams::ProductData))
       }
      ...
      def recurring; end
      sig {
        params(_recurring: T.nilable(::Stripe::PriceService::CreateParams::Recurring)).returns(T.nilable(::Stripe::PriceService::CreateParams::Recurring))
       }
      def recurring=(_recurring); end
      # Only required if a [default tax behavior](https://stripe.com/docs/tax/products-prices-tax-categories-tax-behavior#setting-a-default-tax-behavior-(recommended)) was not provided in the Stripe Tax settings. Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it cannot be changed.
      sig { returns(T.nilable(String)) }
      ...
      def tiers; end
      sig {
        params(_tiers: T.nilable(T::Array[::Stripe::PriceService::CreateParams::Tier])).returns(T.nilable(T::Array[::Stripe::PriceService::CreateParams::Tier]))
       }
      def tiers=(_tiers); end
      ...
      sig {
        params(_transform_quantity: T.nilable(::Stripe::PriceService::CreateParams::TransformQuantity)).returns(T.nilable(::Stripe::PriceService::CreateParams::TransformQuantity))
       }
    ...
    class UpdateParams < Stripe::RequestParams
      class CurrencyOptions < Stripe::RequestParams
        ...
        def custom_unit_amount; end
        sig {
          params(_custom_unit_amount: T.nilable(::Stripe::PriceService::UpdateParams::CurrencyOptions::CustomUnitAmount)).returns(T.nilable(::Stripe::PriceService::UpdateParams::CurrencyOptions::CustomUnitAmount))
         }
        def custom_unit_amount=(_custom_unit_amount); end
        # Only required if a [default tax behavior](https://stripe.com/docs/tax/products-prices-tax-categories-tax-behavior#setting-a-default-tax-behavior-(recommended)) was not provided in the Stripe Tax settings. Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it cannot be changed.
        sig { returns(T.nilable(String)) }
        ...
        def tiers; end
        sig {
          params(_tiers: T.nilable(T::Array[::Stripe::PriceService::UpdateParams::CurrencyOptions::Tier])).returns(T.nilable(T::Array[::Stripe::PriceService::UpdateParams::CurrencyOptions::Tier]))
         }
        def tiers=(_tiers); end
        # A positive integer in cents (or local equivalent) (or 0 for a free price) representing how much to charge.
        sig { returns(T.nilable(Integer)) }
      ...
      class MigrateTo < Stripe::RequestParams
        ...
        sig { params(_effective_after: T.nilable(Integer)).returns(T.nilable(Integer)) }
        def effective_after=(_effective_after); end
      ...
      def currency_options; end
      sig {
        params(_currency_options: T.nilable(T.any(String, T::Hash[String, ::Stripe::PriceService::UpdateParams::CurrencyOptions]))).returns(T.nilable(T.any(String, T::Hash[String, ::Stripe::PriceService::UpdateParams::CurrencyOptions])))
       }
      def currency_options=(_currency_options); end
      # Specifies which fields in the response should be expanded.
      sig { returns(T.nilable(T::Array[String])) }
      ...
      sig { returns(T.nilable(T.any(String, ::Stripe::PriceService::UpdateParams::MigrateTo))) }
      def migrate_to; end
      sig {
        params(_migrate_to: T.nilable(T.any(String, ::Stripe::PriceService::UpdateParams::MigrateTo))).returns(T.nilable(T.any(String, ::Stripe::PriceService::UpdateParams::MigrateTo)))
       }
      ...
      def transfer_lookup_key=(_transfer_lookup_key); end
      sig {
        params(active: T.nilable(T::Boolean), currency_options: T.nilable(T.any(String, T::Hash[String, ::Stripe::PriceService::UpdateParams::CurrencyOptions])), expand: T.nilable(T::Array[String]), lookup_key: T.nilable(String), metadata: T.nilable(T.any(String, T::Hash[String, String])), migrate_to: T.nilable(T.any(String, ::Stripe::PriceService::UpdateParams::MigrateTo)), nickname: T.nilable(String), tax_behavior: T.nilable(String), transfer_lookup_key: T.nilable(T::Boolean)).void
       }
      def initialize(
        active: nil,
        currency_options: nil,
