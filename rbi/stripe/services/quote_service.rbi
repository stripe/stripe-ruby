    ...
    class CreateParams < Stripe::RequestParams
      ...
      class SubscriptionData < Stripe::RequestParams
        ...
        class BillingMode < Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(::Stripe::QuoteService::CreateParams::SubscriptionData::BillingMode::Flexible))
           }
          def flexible; end
          sig {
            params(_flexible: T.nilable(::Stripe::QuoteService::CreateParams::SubscriptionData::BillingMode::Flexible)).returns(T.nilable(::Stripe::QuoteService::CreateParams::SubscriptionData::BillingMode::Flexible))
           }
          ...
          def type=(_type); end
          sig {
            params(flexible: T.nilable(::Stripe::QuoteService::CreateParams::SubscriptionData::BillingMode::Flexible), type: String).void
           }
