...
module Stripe
  class ReviewService < StripeService
    class ListParams < Stripe::RequestParams
      ...
      def created; end
      sig {
        params(_created: T.nilable(T.any(::Stripe::ReviewService::ListParams::Created, Integer))).returns(T.nilable(T.any(::Stripe::ReviewService::ListParams::Created, Integer)))
       }
