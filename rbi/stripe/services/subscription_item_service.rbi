    ...
    class UpdateParams < Stripe::RequestParams
      ...
      class Discount < Stripe::RequestParams
        class DiscountEnd < Stripe::RequestParams
          ...
          def duration; end
          sig {
            params(_duration: T.nilable(::Stripe::SubscriptionItemService::UpdateParams::Discount::DiscountEnd::Duration)).returns(T.nilable(::Stripe::SubscriptionItemService::UpdateParams::Discount::DiscountEnd::Duration))
           }
        ...
        sig {
          params(_discount_end: T.nilable(::Stripe::SubscriptionItemService::UpdateParams::Discount::DiscountEnd)).returns(T.nilable(::Stripe::SubscriptionItemService::UpdateParams::Discount::DiscountEnd))
         }
      ...
      class PriceData < Stripe::RequestParams
        ...
        def recurring; end
        sig {
          params(_recurring: ::Stripe::SubscriptionItemService::UpdateParams::PriceData::Recurring).returns(::Stripe::SubscriptionItemService::UpdateParams::PriceData::Recurring)
         }
      ...
      sig {
        params(_billing_thresholds: T.nilable(T.any(String, ::Stripe::SubscriptionItemService::UpdateParams::BillingThresholds))).returns(T.nilable(T.any(String, ::Stripe::SubscriptionItemService::UpdateParams::BillingThresholds)))
       }
      ...
      def discounts; end
      sig {
        params(_discounts: T.nilable(T.any(String, T::Array[::Stripe::SubscriptionItemService::UpdateParams::Discount]))).returns(T.nilable(T.any(String, T::Array[::Stripe::SubscriptionItemService::UpdateParams::Discount])))
       }
      ...
      def price_data; end
      sig {
        params(_price_data: T.nilable(::Stripe::SubscriptionItemService::UpdateParams::PriceData)).returns(T.nilable(::Stripe::SubscriptionItemService::UpdateParams::PriceData))
       }
    ...
    class CreateParams < Stripe::RequestParams
      ...
      class Discount < Stripe::RequestParams
        class DiscountEnd < Stripe::RequestParams
          ...
          def duration; end
          sig {
            params(_duration: T.nilable(::Stripe::SubscriptionItemService::CreateParams::Discount::DiscountEnd::Duration)).returns(T.nilable(::Stripe::SubscriptionItemService::CreateParams::Discount::DiscountEnd::Duration))
           }
          def duration=(_duration); end
          # A precise Unix timestamp for the discount to end. Must be in the future.
          sig { returns(T.nilable(Integer)) }
        ...
        def discount_end; end
        sig {
          params(_discount_end: T.nilable(::Stripe::SubscriptionItemService::CreateParams::Discount::DiscountEnd)).returns(T.nilable(::Stripe::SubscriptionItemService::CreateParams::Discount::DiscountEnd))
         }
        def discount_end=(_discount_end); end
        # ID of the promotion code to create a new discount for.
        sig { returns(T.nilable(String)) }
      ...
      class PriceData < Stripe::RequestParams
        ...
        def recurring; end
        sig {
          params(_recurring: ::Stripe::SubscriptionItemService::CreateParams::PriceData::Recurring).returns(::Stripe::SubscriptionItemService::CreateParams::PriceData::Recurring)
         }
        def recurring=(_recurring); end
        # Only required if a [default tax behavior](https://stripe.com/docs/tax/products-prices-tax-categories-tax-behavior#setting-a-default-tax-behavior-(recommended)) was not provided in the Stripe Tax settings. Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it cannot be changed.
        sig { returns(T.nilable(String)) }
      ...
      def billing_thresholds; end
      sig {
        params(_billing_thresholds: T.nilable(T.any(String, ::Stripe::SubscriptionItemService::CreateParams::BillingThresholds))).returns(T.nilable(T.any(String, ::Stripe::SubscriptionItemService::CreateParams::BillingThresholds)))
       }
      def billing_thresholds=(_billing_thresholds); end
      # The coupons to redeem into discounts for the subscription item.
      sig {
      ...
      def discounts; end
      sig {
        params(_discounts: T.nilable(T.any(String, T::Array[::Stripe::SubscriptionItemService::CreateParams::Discount]))).returns(T.nilable(T.any(String, T::Array[::Stripe::SubscriptionItemService::CreateParams::Discount])))
       }
      def discounts=(_discounts); end
      # Specifies which fields in the response should be expanded.
      sig { returns(T.nilable(T::Array[String])) }
      ...
      def price_data; end
      sig {
        params(_price_data: T.nilable(::Stripe::SubscriptionItemService::CreateParams::PriceData)).returns(T.nilable(::Stripe::SubscriptionItemService::CreateParams::PriceData))
       }
      def price_data=(_price_data); end
      # Determines how to handle [prorations](https://stripe.com/docs/billing/subscriptions/prorations) when the billing cycle changes (e.g., when switching plans, resetting `billing_cycle_anchor=now`, or starting a trial), or if an item's `quantity` changes. The default value is `create_prorations`.
      sig { returns(T.nilable(String)) }
      ...
      def trial; end
      sig {
        params(_trial: T.nilable(::Stripe::SubscriptionItemService::CreateParams::Trial)).returns(T.nilable(::Stripe::SubscriptionItemService::CreateParams::Trial))
       }
      def trial=(_trial); end
      sig {
        params(billing_thresholds: T.nilable(T.any(String, ::Stripe::SubscriptionItemService::CreateParams::BillingThresholds)), discounts: T.nilable(T.any(String, T::Array[::Stripe::SubscriptionItemService::CreateParams::Discount])), expand: T.nilable(T::Array[String]), metadata: T.nilable(T::Hash[String, String]), payment_behavior: T.nilable(String), plan: T.nilable(String), price: T.nilable(String), price_data: T.nilable(::Stripe::SubscriptionItemService::CreateParams::PriceData), proration_behavior: T.nilable(String), proration_date: T.nilable(Integer), quantity: T.nilable(Integer), subscription: String, tax_rates: T.nilable(T.any(String, T::Array[String])), trial: T.nilable(::Stripe::SubscriptionItemService::CreateParams::Trial)).void
       }
      def initialize(
        billing_thresholds: nil,
        discounts: nil,
