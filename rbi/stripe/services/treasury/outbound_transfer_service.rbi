    ...
    class OutboundTransferService < StripeService
      ...
      class CreateParams < Stripe::RequestParams
        ...
        class NetworkDetails < Stripe::RequestParams
          ...
          def ach; end
          sig {
            params(_ach: T.nilable(::Stripe::Treasury::OutboundTransferService::CreateParams::NetworkDetails::Ach)).returns(T.nilable(::Stripe::Treasury::OutboundTransferService::CreateParams::NetworkDetails::Ach))
           }
          def ach=(_ach); end
        ...
        sig {
          params(_network_details: T.nilable(::Stripe::Treasury::OutboundTransferService::CreateParams::NetworkDetails)).returns(T.nilable(::Stripe::Treasury::OutboundTransferService::CreateParams::NetworkDetails))
         }
