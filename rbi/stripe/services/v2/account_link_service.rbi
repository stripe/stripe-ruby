    ...
    class AccountLinkService < StripeService
      class CreateParams < Stripe::RequestParams
        class UseCase < Stripe::RequestParams
          ...
          sig {
            returns(T.nilable(::Stripe::V2::AccountLinkService::CreateParams::UseCase::AccountOnboarding))
           }
          attr_accessor :account_onboarding
          # Indicates that the AccountLink provided should update a previously onboarded account.
          sig {
            returns(T.nilable(::Stripe::V2::AccountLinkService::CreateParams::UseCase::AccountUpdate))
           }
          attr_accessor :account_update
          sig {
            params(type: String, account_onboarding: T.nilable(::Stripe::V2::AccountLinkService::CreateParams::UseCase::AccountOnboarding), account_update: T.nilable(::Stripe::V2::AccountLinkService::CreateParams::UseCase::AccountUpdate)).void
           }
        ...
        sig { returns(::Stripe::V2::AccountLinkService::CreateParams::UseCase) }
        attr_accessor :use_case
        sig {
          params(account: String, use_case: ::Stripe::V2::AccountLinkService::CreateParams::UseCase).void
         }
      ...
      sig {
        params(params: T.any(::Stripe::V2::AccountLinkService::CreateParams, T::Hash[T.untyped, T.untyped]), opts: T.untyped).returns(Stripe::V2::AccountLink)
       }
