    ...
    module Billing
      class CadenceService < StripeService
        ...
        class CreateParams < Stripe::RequestParams
          ...
          sig {
            params(billing_cycle: ::Stripe::V2::Billing::CadenceService::CreateParams::BillingCycle, lookup_key: T.nilable(String), metadata: T.nilable(T::Hash[String, String]), payer: ::Stripe::V2::Billing::CadenceService::CreateParams::Payer, settings: T.nilable(::Stripe::V2::Billing::CadenceService::CreateParams::Settings)).void
           }
          def initialize(
            billing_cycle: nil,
            lookup_key: nil,
        ...
        class UpdateParams < Stripe::RequestParams
          ...
          def settings=(_settings); end
          sig {
            params(lookup_key: T.nilable(String), metadata: T.nilable(T::Hash[String, T.nilable(String)]), payer: T.nilable(::Stripe::V2::Billing::CadenceService::UpdateParams::Payer), settings: T.nilable(::Stripe::V2::Billing::CadenceService::UpdateParams::Settings)).void
           }
