    ...
    module Billing
      class RateCardService < StripeService
        ...
        class ListParams < Stripe::RequestParams
          ...
          attr_accessor :limit
          sig { params(active: T.nilable(T::Boolean), limit: T.nilable(Integer)).void }
          def initialize(active: nil, limit: nil); end
        end
        class CreateParams < Stripe::RequestParams
          ...
          sig {
            params(currency: String, display_name: String, metadata: T.nilable(T::Hash[String, String]), service_interval: String, service_interval_count: Integer, tax_behavior: String).void
           }
          def initialize(
            currency: nil,
            display_name: nil,
        ...
        class UpdateParams < Stripe::RequestParams
          ...
          attr_accessor :metadata
          sig {
            params(active: T.nilable(T::Boolean), display_name: T.nilable(String), live_version: T.nilable(String), metadata: T.nilable(T::Hash[String, T.nilable(String)])).void
           }
          def initialize(active: nil, display_name: nil, live_version: nil, metadata: nil); end
        end
