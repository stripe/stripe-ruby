      ...
      class OutboundSetupIntentService < StripeService
        ...
        class CreateParams < Stripe::RequestParams
          class PayoutMethodData < Stripe::RequestParams
            class BankAccount < Stripe::RequestParams
              ...
              sig {
                params(account_number: String, bank_account_type: String, branch_number: String, country: String, routing_number: String, swift_code: String).void
               }
              def initialize(
                account_number: nil,
            ...
            sig {
              returns(::Stripe::V2::MoneyManagement::OutboundSetupIntentService::CreateParams::PayoutMethodData::BankAccount)
             }
            attr_accessor :bank_account
            # The type specific details of the card payout method.
            sig {
              returns(::Stripe::V2::MoneyManagement::OutboundSetupIntentService::CreateParams::PayoutMethodData::Card)
             }
            attr_accessor :card
            sig {
              params(type: String, bank_account: ::Stripe::V2::MoneyManagement::OutboundSetupIntentService::CreateParams::PayoutMethodData::BankAccount, card: ::Stripe::V2::MoneyManagement::OutboundSetupIntentService::CreateParams::PayoutMethodData::Card).void
             }
          ...
          sig {
            returns(::Stripe::V2::MoneyManagement::OutboundSetupIntentService::CreateParams::PayoutMethodData)
           }
          ...
          sig {
            params(payout_method: String, payout_method_data: ::Stripe::V2::MoneyManagement::OutboundSetupIntentService::CreateParams::PayoutMethodData, usage_intent: String).void
           }
        ...
        class UpdateParams < Stripe::RequestParams
          class PayoutMethodData < Stripe::RequestParams
            ...
            # The type specific details of the bank account payout method.
            sig {
              returns(::Stripe::V2::MoneyManagement::OutboundSetupIntentService::UpdateParams::PayoutMethodData::BankAccount)
             }
            attr_accessor :bank_account
            # The type specific details of the card payout method.
            sig {
              returns(::Stripe::V2::MoneyManagement::OutboundSetupIntentService::UpdateParams::PayoutMethodData::Card)
             }
            attr_accessor :card
            sig {
              params(type: String, bank_account: ::Stripe::V2::MoneyManagement::OutboundSetupIntentService::UpdateParams::PayoutMethodData::BankAccount, card: ::Stripe::V2::MoneyManagement::OutboundSetupIntentService::UpdateParams::PayoutMethodData::Card).void
             }
            def initialize(type: nil, bank_account: nil, card: nil); end
          end
          ...
          # If a payout_method provided, used to update data on the credential linked to this setup intent.
          sig {
            returns(::Stripe::V2::MoneyManagement::OutboundSetupIntentService::UpdateParams::PayoutMethodData)
           }
          attr_accessor :payout_method_data
          sig {
            params(payout_method: String, payout_method_data: ::Stripe::V2::MoneyManagement::OutboundSetupIntentService::UpdateParams::PayoutMethodData).void
           }
