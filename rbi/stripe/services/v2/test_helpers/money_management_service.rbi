  ...
  module V2
    module TestHelpers
      class MoneyManagementService < StripeService
        ...
        sig {
          params(params: T.any(::Stripe::V2::TestHelpers::MoneyManagementService::RecipientVerificationsParams, T::Hash[T.untyped, T.untyped]), opts: T.untyped).returns(Stripe::V2::MoneyManagement::RecipientVerification)
         }
