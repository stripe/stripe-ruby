...
module Stripe
  ...
  class StripeEventNotificationHandler
    ...
    sig do
      params(blk: T.proc.params(event_notification: ::Stripe::Events::V2SignalsAccountEvaluationCompleteEventNotification, client: ::Stripe::StripeClient).void).void
    end
    def on_v2_signals_account_evaluation_complete(&blk);
    end
    ...
    sig do
      params(blk: T.proc.params(event_notification: ::Stripe::Events::V2SignalsAccountSignalFraudulentWebsiteReadyEventNotification, client: ::Stripe::StripeClient).void).void
    end
    def on_v2_signals_account_signal_fraudulent_website_ready(&blk);
    end
