...
module Stripe
  class CodegennedExampleTest < Test::Unit::TestCase
    ...
    should "Test quotes preview invoices lines get" do
      invoice_line_items = Stripe::Quote.list_preview_invoice_lines("qt_xyz", "in_xyz")
    ...
    should "Test quotes preview invoices lines get (service)" do
      ...
      invoice_line_items = client.v1.quotes.list_preview_invoice_lines("qt_xyz", "in_xyz")
    ...
    should "Test tax forms pdf get" do
      block_handler = {}
      file = Stripe::Tax::Form.pdf("form_xxxxxxxxxxxxx", &block_handler)
    ...
    should "Test tax forms pdf get (service)" do
      ...
      t_untyped = client.v1.tax.forms.pdf("form_xxxxxxxxxxxxx", &block_handler)
    ...
    should "Test v2 money management outbound payment quote post (service)" do
      stub_request(
        ...
        body: '{"object":"v2.money_management.outbound_payment_quote","amount":{"currency":"USD","value":96},"created":"1970-01-12T21:42:34.472Z","estimated_fees":[{"amount":{"currency":"USD","value":96},"type":"cross_border_payout_fee"}],"from":{"debited":{"currency":"USD","value":55},"financial_account":"financial_account"},"fx_quote":{"lock_duration":"five_minutes","lock_status":"active","rates":{"key":{"exchange_rate":"exchange_rate"}},"to_currency":"usd"},"id":"obj_123","livemode":true,"to":{"credited":{"currency":"USD","value":68},"payout_method":"payout_method","recipient":"recipient"}}',
        status: 200
      )
      client = Stripe::StripeClient.new("sk_test_123")
    ...
    should "Test v2 money management payout method get (service)" do
      stub_request(
        ...
        body: '{"data":[{"object":"v2.money_management.payout_method","available_payout_speeds":["standard"],"created":"1970-01-12T21:42:34.472Z","id":"obj_123","livemode":true,"restricted":true,"type":"bank_account","usage_status":{"payments":"eligible","transfers":"disabled"}}],"next_page_url":null,"previous_page_url":null}',
        status: 200
      )
      client = Stripe::StripeClient.new("sk_test_123")
    ...
    should "Test v2 money management payout method get 2 (service)" do
      stub_request(
        ...
        body: '{"object":"v2.money_management.payout_method","available_payout_speeds":["standard"],"created":"1970-01-12T21:42:34.472Z","id":"obj_123","livemode":true,"restricted":true,"type":"bank_account","usage_status":{"payments":"eligible","transfers":"disabled"}}',
        status: 200
      )
      client = Stripe::StripeClient.new("sk_test_123")
    ...
    should "Test v2 money management received debit get (service)" do
      stub_request(
        ...
        body: '{"data":[{"object":"v2.money_management.received_debit","amount":{"currency":"USD","value":96},"created":"1970-01-12T21:42:34.472Z","financial_account":"financial_account","id":"obj_123","livemode":true,"status":"canceled","type":"bank_transfer"}],"next_page_url":null,"previous_page_url":null}',
        status: 200
      )
      client = Stripe::StripeClient.new("sk_test_123")
    ...
    should "Test v2 money management received debit get 2 (service)" do
      stub_request(
        ...
        body: '{"object":"v2.money_management.received_debit","amount":{"currency":"USD","value":96},"created":"1970-01-12T21:42:34.472Z","financial_account":"financial_account","id":"obj_123","livemode":true,"status":"canceled","type":"bank_transfer"}',
        status: 200
      )
      client = Stripe::StripeClient.new("sk_test_123")
    ...
    should "Test v2 money management transaction get (service)" do
      stub_request(:get, "#{Stripe::DEFAULT_API_BASE}/v2/money_management/transactions").to_return(
        body: '{"data":[{"object":"v2.money_management.transaction","amount":{"currency":"USD","value":96},"balance_impact":{"available":{"currency":"USD","value":35},"inbound_pending":{"currency":"USD","value":11},"outbound_pending":{"currency":"USD","value":60}},"category":"stripe_fee","created":"1970-01-12T21:42:34.472Z","financial_account":"financial_account","id":"obj_123","livemode":true,"status":"pending","status_transitions":{}}],"next_page_url":null,"previous_page_url":null}',
        status: 200
      )
      client = Stripe::StripeClient.new("sk_test_123")
    ...
    should "Test v2 money management transaction get 2 (service)" do
      stub_request(
        ...
        body: '{"object":"v2.money_management.transaction","amount":{"currency":"USD","value":96},"balance_impact":{"available":{"currency":"USD","value":35},"inbound_pending":{"currency":"USD","value":11},"outbound_pending":{"currency":"USD","value":60}},"category":"stripe_fee","created":"1970-01-12T21:42:34.472Z","financial_account":"financial_account","id":"obj_123","livemode":true,"status":"pending","status_transitions":{}}',
        status: 200
      )
      client = Stripe::StripeClient.new("sk_test_123")
    ...
    should "Test v2 money management transaction entry get 2 (service)" do
      stub_request(
        ...
        body: '{"object":"v2.money_management.transaction_entry","balance_impact":{"available":{"currency":"USD","value":35},"inbound_pending":{"currency":"USD","value":11},"outbound_pending":{"currency":"USD","value":60}},"created":"1970-01-12T21:42:34.472Z","effective_at":"1970-01-03T20:38:28.043Z","id":"obj_123","livemode":true,"transaction":"transaction","transaction_details":{"category":"stripe_fee","financial_account":"financial_account"}}',
        status: 200
      )
      client = Stripe::StripeClient.new("sk_test_123")
    ...
    should "Test v2 signals account evaluation post (service)" do
      stub_request(:post, "#{Stripe::DEFAULT_API_BASE}/v2/signals/account_evaluations").to_return(
        body: '{"object":"v2.signals.account_evaluation","account_details":{},"created":"1970-01-12T21:42:34.472Z","id":"obj_123","livemode":true,"pending_signals":["user_multi_accounting"],"requested_signals":["user_account_sharing"]}',
        status: 200
      )
      client = Stripe::StripeClient.new("sk_test_123")
    ...
    should "Test v2 signals account signal get (service)" do
      stub_request(
        :get,
        "#{Stripe::DEFAULT_API_BASE}/v2/signals/account_signals?type[0]=user_account_sharing"
      ).to_return(
        body: '{"data":[{"object":"v2.signals.account_signal","created":"1970-01-12T21:42:34.472Z","id":"obj_123","livemode":true,"type":"user_account_sharing"}],"next_page_url":null,"previous_page_url":null}',
        status: 200
      )
      client = Stripe::StripeClient.new("sk_test_123")

      account_signals = client.v2.signals.account_signals.list({ type: ["user_account_sharing"] })
      assert_requested :get, "#{Stripe::DEFAULT_API_BASE}/v2/signals/account_signals?type[0]=user_account_sharing"
    end
    should "Test v2 signals account signal get 2 (service)" do
      stub_request(:get, "#{Stripe::DEFAULT_API_BASE}/v2/signals/account_signals/id_123").to_return(
        body: '{"object":"v2.signals.account_signal","created":"1970-01-12T21:42:34.472Z","id":"obj_123","livemode":true,"type":"user_account_sharing"}',
        status: 200
      )
      client = Stripe::StripeClient.new("sk_test_123")
