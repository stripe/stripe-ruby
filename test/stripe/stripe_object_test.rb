...
module EwStripe
  class StripeObjectTest < Test::Unit::TestCase
    should "implement #==" do
      obj1 = EwStripe::StripeObject.construct_from(id: 1, foo: "bar")
      obj2 = EwStripe::StripeObject.construct_from(id: 1, foo: "bar")
      obj3 = EwStripe::StripeObject.construct_from(id: 1, foo: "rab")
    ...
    should "implement #deleted?" do
      obj = EwStripe::StripeObject.construct_from({})
      refute obj.deleted?

      obj = EwStripe::StripeObject.construct_from(deleted: false)
      refute obj.deleted?

      obj = EwStripe::StripeObject.construct_from(deleted: true)
      assert obj.deleted?
    end

    should "implement #respond_to" do
      obj = EwStripe::StripeObject.construct_from(id: 1, foo: "bar")
    ...
    should "marshal be insensitive to strings vs. symbols when constructin" do
      obj = EwStripe::StripeObject.construct_from(:id => 1, "name" => "Stripe")
    ...
    context "#deep_copy" do
      should "produce a deep copy" do
        ...
        # possible
        copy_values = EwStripe::StripeObject.send(:deep_copy, values)
      ...
      should "not copy a client" do
        ...
        obj = EwStripe::StripeObject.construct_from(values, opts)
        copy_obj = EwStripe::StripeObject.send(:deep_copy, obj)
      ...
      should "return an instance of the same class" do
        class TestObject < EwStripe::StripeObject; end
    ...
    context "#eql?" do
      should "produce true for two equivalent EwStripe objects" do
        obj1 = EwStripe::StripeObject.construct_from(id: 1, name: "Stripe")
        obj2 = EwStripe::StripeObject.construct_from(id: 1, name: "Stripe")
        assert obj1.eql?(obj2)
      end

      should "produce false for non-equivalent EwStripe objects" do
        obj1 = EwStripe::StripeObject.construct_from(id: 1, name: "Stripe")
        obj2 = EwStripe::StripeObject.construct_from(id: 2, name: "Stripe")
    ...
    context "#hash" do
      should "produce the same hash for two equivalent EwStripe objects" do
        obj1 = EwStripe::StripeObject.construct_from(id: 1, name: "Stripe")
        obj2 = EwStripe::StripeObject.construct_from(id: 1, name: "Stripe")
        assert_equal obj1.hash, obj2.hash
      end

      should "produce different hashes for non-equivalent EwStripe objects" do
        obj1 = EwStripe::StripeObject.construct_from(id: 1, name: "Stripe")
        obj2 = EwStripe::StripeObject.construct_from(id: 2, name: "Stripe")
    ...
    context "#to_hash" do
      ...
      should "recursively call to_hash on its values" do
        ...
        nested = EwStripe::StripeObject.construct_from(nested_hash)

        obj = EwStripe::StripeObject.construct_from(id: 1,
    ...
    should "assign question mark accessors for booleans" do
      obj = EwStripe::StripeObject.construct_from(id: 1, bool: true, not_bool: "bar")
    ...
    should "#update_attributes with a hash" do
      ...
      assert_equal EwStripe::StripeObject, obj.metadata.class
    end
    ...
    should "#serialize_params on a basic object" do
      obj = EwStripe::StripeObject.construct_from(foo: nil)
      obj.update_attributes({ foo: "bar" })
      assert_equal({ foo: "bar" }, obj.serialize_params)
    end

    should "#serialize_params on a more complex object" do
      obj = EwStripe::StripeObject.construct_from(foo: EwStripe::StripeObject.construct_from(bar: nil,
                                                                                         baz: nil))
      obj.foo.bar = "newbar"
    ...
    should "#serialize_params on an array that shortens" do
      obj = EwStripe::StripeObject.construct_from(foo: %w[0-index 1-index 2-index])
      obj.foo = ["new-value"]
      assert_equal({ foo: ["new-value"] },
                   obj.serialize_params)
    end
    ...
    should "#serialize_params on an array of hashes" do
      obj = EwStripe::StripeObject.construct_from(foo: nil)
      obj.foo = [
        EwStripe::StripeObject.construct_from(bar: nil),
      ]
      obj.foo[0].bar = "baz"
    ...
    should "#serialize_params with a StripeObject" do
      ...
      # StripeObject
      obj.metadata =
        EwStripe::StripeObject.construct_from(foo: "bar")
    ...
    should "#serialize_params with StripeObject that's been replaced" do
      obj = EwStripe::StripeObject.construct_from(source: EwStripe::StripeObject.construct_from(bar: "foo"))

      # Here we replace the object wholesale.
      obj.source =
        EwStripe::StripeObject.construct_from(baz: "foo")
    ...
    should "#serialize_params with StripeObject that's been replaced which is `metadata`" do
      class WithAdditiveObjectParam < EwStripe::StripeObject
        additive_object_param :metadata
      end

      obj = WithAdditiveObjectParam.construct_from(metadata: EwStripe::StripeObject.construct_from(bar: "foo"))
    ...
    should "#serialize_params and not include API resources that have not been set" do
      customer = Customer.construct_from(id: "cus_123")
      obj = EwStripe::StripeObject.construct_from(customer: customer)
    ...
    should "#serialize_params serializes API resources flagged with save_with_parent" do
      ...
      obj = EwStripe::StripeObject.construct_from(customer: c)
    ...
    should "#serialize_params takes a force option" do
      obj = EwStripe::StripeObject.construct_from(id: "id",
                                                metadata: EwStripe::StripeObject.construct_from(foo: "bar"))
    ...
    should "#to_s will call to_s for all embedded stripe objects" do
      obj = EwStripe::StripeObject.construct_from(id: "id",
                                                ...
                                                refunds: EwStripe::ListObject.construct_from(data: [
                                                  # embedded object in list
                                                  EwStripe::StripeObject.construct_from(id: "id",
    ...
    should "error on setting a property to an empty string" do
      obj = EwStripe::StripeObject.construct_from(foo: "bar")
      e = assert_raises ArgumentError do
        obj.foo = ""
      end
    ...
    context "#method" do
      should "act as a getter if no arguments are provided" do
        obj = EwStripe::StripeObject.construct_from(id: 1, method: "foo")
    ...
    should "ignore properties that are reserved names" do
      obj = EwStripe::StripeObject.construct_from(metadata: { class: "something" })
